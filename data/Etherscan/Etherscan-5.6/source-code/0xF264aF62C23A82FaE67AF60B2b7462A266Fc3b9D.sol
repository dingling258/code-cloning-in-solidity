...
contract Zklock is Context, IERC20, Ownable {
    ...
    address payable public _taxWallet = payable(0x000000000000000000000000000000000000dEaD);
    ...
    string private constant _name = unicode"Zklock";  // Name
    string private constant _symbol = unicode"$ZKLK"; // Symbol
