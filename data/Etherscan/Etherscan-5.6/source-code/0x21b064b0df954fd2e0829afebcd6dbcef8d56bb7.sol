...
TradeAI is designed to be an innovative trading platform operating on the Bittensor network, providing a seamless combination of artificial intelligence with decentralized finance (DeFi). The platform aims to automate and enhance online trading by leveraging Bittensor's decentralized intelligence for improved prediction and execution in the cryptocurrency markets.

Launch Details:
Time: 16:00 UTC today
▪️ Chain: Ethereum (will bridge to Bittensor afterwards)
▪️ Liquidity: 10ETH
▪️ Listing MC: ~$80K, FDV: $340K
▪️ Trading tax: 4%

Official Website: https://tradeai.bot/
Official Documentation: https://docs.tradeai.bot/
Official Twitter: https://twitter.com/TradeAI_Tao
Official Telegram: https://t.me/TradeAIonTao

Note:
All official announcements are only posted official telegram and on our X. Don't fall for scams!
...
contract wTAI is ERC20, Ownable {
    ...
    constructor() ERC20(unicode"Wrapped Trade AI", unicode"wTAI") {
