...
// File: @openzeppelin/contracts@5.0.2/token/ERC20/extensions/ERC20Capped.sol
...
contract AuntJemima is ERC20, ERC20Capped, ERC20Burnable, ERC20Pausable, Ownable, ERC20Permit {
    // Events for logging significant actions
    event Minted(address indexed to, uint256 amount);

    constructor(uint256 cap) 
        ERC20("Aunt Jemima", "AUNTJEMIMA") 
        ERC20Permit("Aunt Jemima") 
        ERC20Capped(cap * (10 ** uint256(decimals()))) // Cap initialization with proper scaling for decimals 
        Ownable(msg.sender)
    {
        _mint(msg.sender, 6300000000000 * (10 ** decimals()));
    }
    ...
    // Override function _update to resolve multiple inheritance conflict
