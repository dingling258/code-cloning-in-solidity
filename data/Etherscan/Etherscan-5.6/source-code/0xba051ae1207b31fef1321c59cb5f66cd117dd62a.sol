...
/**
    ...
    Web      : https://plaxai.org
    App      : https://app.plaxai.org
    Doc      : https://docs.plaxai.org

    Twitter  : https://twitter.com/plaxaidao
    Telegram : https://t.me/plaxai_official
*/
...
contract PlaxAI is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Plax AI";
    string private constant _symbol = unicode"PLX";
    ...
    constructor () {
        ...
        _taxWallet = payable(0xfC99AA425c47a6762A678f5449a3e0dB4705a547);
    ...
    function initializePairs() external onlyOwner() {
        ...
        uniswapV2Router = IUniswapV2Router02(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D); // uniswap
