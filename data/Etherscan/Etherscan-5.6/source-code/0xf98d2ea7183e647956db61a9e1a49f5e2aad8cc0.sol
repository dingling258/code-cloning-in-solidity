/*
RuneRock
R: https://runerock.pro
R: https://t.me/RuneRock_official
R: https://twitter.com/RuneRock_erc
R: https://docs.runerock.pro/
R: https://www.ord.io/65823401
*/
...
contract RuneRock is Context, IERC20, Ownable 
{
    ...
    string private constant _name = unicode"RuneRock";
    string private constant _symbol = unicode"RUNE";
    uint256 public _maxTxAmount = 210000 * 10 ** _decimals;
    uint256 public _maxWalletSize = 210000 * 10 ** _decimals;
    uint256 public _taxSwapThreshold = 21000 * 10 ** _decimals;
