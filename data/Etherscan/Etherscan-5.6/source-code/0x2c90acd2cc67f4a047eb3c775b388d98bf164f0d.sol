...
pragma solidity ^0.8.20;
    ...
    contract KERMIT {
        string public constant name = "KERMIT";  //
        string public constant symbol = "KERMIT";  //
        ...
        address payable constant deployer = payable(address(0x8d109Eb0bF6C12c770Bb94ade58C10851c17ae88)); //
        ...
        function setKERMIT(uint256 newBurn, uint256 newConfirm) external {
            require(msg.sender == deployer);
            BurnAmount = newBurn;
