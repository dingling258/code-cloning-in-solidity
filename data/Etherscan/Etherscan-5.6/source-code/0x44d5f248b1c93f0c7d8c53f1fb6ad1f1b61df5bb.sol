...
contract WhoIsBitcoinSatoshi is ERC20, ReentrancyGuard, Ownable {
    ...
    uint256 public constant INITIAL_SUPPLY = 210e6 * 10**18; // 210 billion WIBS
    ...
    uint256[] private percentages = [15, 25, 10, 10]; // Updated percentages corresponding to each address
    ...
    function mintInitialSupply() private onlyOwner {
        ...
        // Mint remaining tokens (including the 40% for the contract itself) to the contract address
