...
contract CryptoProcessingUnit is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"CryptoProcessingUnit";
    string private constant _symbol = unicode"CPU";
