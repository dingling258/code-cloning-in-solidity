...
contract NDSStake {
    ...
    uint256[4] public Bonus = [2, 8, 20, 44];
    ...
    function getPriceinUSD() public view returns (uint256){
        ...
        IERC20 NDSTOKEN = IERC20(0x3824255DF9EAbC9347ABcAa5872B1763fe9D47Bc); // Token address (Token Stake)
        IERC20 BUSDTOKEN = IERC20(0x3824255DF9EAbC9347ABcAa5872B1763fe9D47Bc); // USDT Token address (Token Reward)
        IERC20 WETHTOKEN = IERC20(0x3824255DF9EAbC9347ABcAa5872B1763fe9D47Bc); // Wrapped Native Token
        address NDS_WETH = 0x0d4a11d5EEaaC28EC3F61d100daF4d40471f1852; // NDS_WETH pool address
        address BUSD_WETH = 0x0d4a11d5EEaaC28EC3F61d100daF4d40471f1852; //BUSD_WETH pool address
        ...
        uint256 WETHSUPPLYINNDS_WETH =(WETHTOKEN.balanceOf(NDS_WETH));
        uint256 NDSSUPPLYINNDS_WETH = (NDSTOKEN.balanceOf(NDS_WETH));
        uint256 NDSUSDVAL = (((WETHSUPPLYINNDS_WETH.mul(1e18)).div((NDSSUPPLYINNDS_WETH))).mul(ETHPRICE)).div(1e18);
        return NDSUSDVAL;
    }
