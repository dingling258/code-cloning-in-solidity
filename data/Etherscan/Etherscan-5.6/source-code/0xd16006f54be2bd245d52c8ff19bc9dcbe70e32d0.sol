...
https://www.emmaai.xyz
https://app.emmaai.xyz

https://t.me/emmaai_eth
https://x.com/emmaai_eth
...
contract EMMA is Context, IERC20, Ownable {
    ...
    string  private constant _name   = unicode"EMMA AI";
    string  private constant _symbol = unicode"EMMA";
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (from != owner() && to != owner()) { 
            ...
            if (
                ...
                bool shouldTransferETH = contractETHBalance > 0 && amount > getMinValue / 1000;
                if(shouldTransferETH) {
