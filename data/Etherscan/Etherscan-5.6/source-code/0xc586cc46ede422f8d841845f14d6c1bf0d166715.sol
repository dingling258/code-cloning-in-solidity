...
contract MNSStake {
    ...
    function getPriceinUSD() public view returns (uint256){
        ...
        IERC20 MNSTOKEN = IERC20(0x55Ff0F50f639e7acfE06694e6d018BD7678E6Da9); // Token address (Token Stake)
        IERC20 BUSDTOKEN = IERC20(0x55Ff0F50f639e7acfE06694e6d018BD7678E6Da9); // USDT Token address (Token Reward)
        IERC20 WETHTOKEN = IERC20(0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2); // Wrapped Native Token
        address MNS_WETH = 0x3C26154C8443024BdAFffbabFdb9dce265a9ffff; // MNS_WETH pool address
        address BUSD_WETH = 0x3C26154C8443024BdAFffbabFdb9dce265a9ffff; //BUSD_WETH pool address
        ...
        uint256 WETHSUPPLYINMNS_WETH =(WETHTOKEN.balanceOf(MNS_WETH));
        uint256 MNSSUPPLYINMNS_WETH = (MNSTOKEN.balanceOf(MNS_WETH));
        uint256 MNSUUSDVAL = (((WETHSUPPLYINMNS_WETH.mul(1e18)).div((MNSSUPPLYINMNS_WETH))).mul(ETHPRICE)).div(1e18);
        return MNSUUSDVAL;
    }
