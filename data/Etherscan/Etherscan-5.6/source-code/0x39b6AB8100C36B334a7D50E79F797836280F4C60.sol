...
*/
        ...
        //  https://www.honkytoken.com/

        //  https://t.me/honkyerc

        //  https://twitter.com/HonkyERC20
...
contract HONKY is Context, IERC20, Ownable 
{
    ...
    string private constant _name = unicode"Honky";
    string private constant _symbol = unicode"HONKY";
    uint256 public _maxTxAmount = 2082600000 * 10 ** _decimals;
    uint256 public _maxWalletSize = 2082600000 * 10 ** _decimals;
    uint256 public _taxSwapThreshold = 6942000 * 10 ** _decimals;
