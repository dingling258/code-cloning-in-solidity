...
Telegram
   https://t.me/ExpositionAI

X
   https://x.com/ExpositionAI

Web/Docs
   https://expositionai.io
   https://docs.expositionai.io/
...
contract ExpositionAI is ERC20, Ownable {
    ...
    constructor() ERC20("Exposition AI", "EXPO") {
        devWallet = address(0x6E888C56dFF550ae5D869453d637F926Edf3F37b);
        marketingFundsWallet = address(0x6E888C56dFF550ae5D869453d637F926Edf3F37b);
        ...
        maximumTknsPerTxn = (totalSupply * 2) / 100; // 1.25% from total supply max transaction amount
        maximumTknsPerWallet = (totalSupply * 2) / 100;  // 1.25% from total supply max wallet amount
