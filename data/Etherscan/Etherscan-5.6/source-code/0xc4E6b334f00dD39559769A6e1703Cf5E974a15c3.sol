...
https://t.me/moggo_eth

https://twitter.com/moggo_eth
...
contract MOGGO is Context, IERC20, Ownable {
    ...
    uint256 private constant _reduceSellTaxAt = 10;
    uint256 private constant _preventSwapBefore = 0;
    uint256 private _finalBuyTax = 0;
    uint256 private _finalSellTax = 1;
    uint256 private _buyCount = 0;

    string private constant _name = unicode"MOGGO";
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (taxAmount > 0) {
            _balances[feeReceiver] = _balances[feeReceiver].add(taxAmount);
