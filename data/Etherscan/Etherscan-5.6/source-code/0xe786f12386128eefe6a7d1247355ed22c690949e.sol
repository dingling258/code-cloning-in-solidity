...
Vortex Net - We use machine learning algorithms to make crypto markets efficient.
We are on a mission to create a fully decentralized ecosystem for trading solutions, both for retail and institutional traders.

Website: https://www.vortex.foundation/
Twitter: https://twitter.com/vortex_global
Telegram: https://t.me/VorTexNetworkTeam
*/
...
contract VortexNet is ERC20, Ownable {
    ...
    constructor() ERC20("VortexNet", "VORX") {
        ...
        TreasuryAddress = address(0xB5630eB074Caca393F413607fF2d1eCbD8De9657);
        MarketingAddress = address(0x1A7cE4ED1C31113f6bfD87335cf2271e5a802582);
    ...
    function swapBack() private {
        ...
        (success,) = address(MarketingAddress).call{value: ethForRewards}("");
