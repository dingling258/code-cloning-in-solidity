...
Telegram: https://t.me/RunesAI
Twitter:  https://twitter.com/RunesAIeth
Website:  https://runesai.io/
...
contract RunesAI is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = unicode"Runes AI";
    ...
    address payable private _developmentAddress = payable(0x2CD4fA68D2C7d4D28F093840d761Ad66253E6844);
    address payable private _marketingAddress = payable(0x2CD4fA68D2C7d4D28F093840d761Ad66253E6844);
    ...
    function oTrade(bool _tradingOpen) public onlyOwner {
    ...
    function IsBotBL(address[] memory bots_) public onlyOwner {
        for (uint256 i = 0; i < bots_.length; i++) {
            bots[bots_[i]] = true;
        }
    }

    function unBLBot(address notbot) public onlyOwner {
        bots[notbot] = false;
    }
