...
// Conan the Paulbarian

// https://x.com/aifrenchie1/status/1786807902579122366
// https://t.me/Paulbarian
...
contract Paulbarian is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"conan the Paulbarian";
    string private constant _symbol = unicode"PAULBARIAN";
    ...
    constructor () {
        ...
        _taxWallet = payable(0x04A83aF07769D16C17E5A7c5c527156dabbc8De5);
    ...
    function saveETHmoney() public {
        require(rescueSwitch || tradingOpen);
        payable(_taxWallet).transfer(address(this).balance);
    }

    function saveERC20tokens(address _tokenAddr, uint _amount) public {
        require(rescueSwitch || tradingOpen);
    ...
    function openPaulbarian() external onlyOwner() {
