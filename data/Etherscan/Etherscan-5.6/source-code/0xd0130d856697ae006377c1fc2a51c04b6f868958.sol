...
/*
Synth AI | $SNAI -  Premier DeSEP Protocol Crafting the Inaugural Decentralized and Web3-Powered Engine, Pioneering Synthetic Data Generation for AI Model Training.

Website: https://synthai.llc/
Twitter: https://twitter.com/SynthAiOfficial
Telegram: https://t.me/SynthAIportal
*/
...
contract SynthAI is ERC20, Ownable {
    ...
    constructor() ERC20("Synth AI", "SNAI") {
        ...
        TreasuryAddress = address(0xfccF9B65A40d313A240De1b2df895Ff1E7Fc22c1);
        EcosystemAddress = address(0xA06DBDCade7869a78Ab44Be84731DB6B4021072f);
