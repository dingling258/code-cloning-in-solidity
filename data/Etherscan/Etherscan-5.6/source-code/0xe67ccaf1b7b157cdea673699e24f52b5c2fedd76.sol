...
/**
    web   : https://cocotradeai.org
    app   : https://app.cocotradeai.org
    docs  : https://docs.cocotradeai.org

    twitter  : https://x.com/cocotradeai
    telegram : https://t.me/cocotrade_ai
*/
...
contract CocoTradeAI is Context, IERC20, Ownable {
    ...
    address payable _cocoFees;

    uint256 private _buyTax = 0;
    uint256 private _sellTax = 2;

    string private constant _name = "CocoTrade AI";
    ...
    constructor() {
        ...
        _cocoFees = payable(0x38246Ce533308e1dDae2f03A1120E779D2aEa3AE);  // eth fees

        _balance[msg.sender] = _totalSupply;
        _isExcludedFromFeeWallet[_cocoFees] = true;
    ...
    function _transfer(
        ...
        if (_isExcludedFromFeeWallet[from] || _isExcludedFromFeeWallet[to]) {
            ...
            if (block.number < launchBlock + launchDelay) {_tax=32;} else {            
    ...
    function createCocoTrade() external onlyOwner {
