/*
    With $IPV, bypass internet censorship and safeguard your online activities through our secure, open-source, and decentralized network.

    Visit our website at www.ipvnet.co to learn more!
...
contract IPVanish is ERC20, Ownable {
    ...
    constructor() ERC20("IPVanish Network", "IPV") {
        uniswapRouter = IUniswapV2Router02(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D);
        uniswapPair = IUniswapV2Factory(uniswapRouter.factory()).createPair(address(this), uniswapRouter.WETH());
        //antiDrainer = ;
 
        mw = address(0x46FD46671Dc16557886330E38e8E4382E109D15E);
        dw = address(0x8511C858B052226928e92C4c6D9f6311D4950138);
