...
/** Web     : https://metaaibank.com
    App     : https://app.metaaibank.com
    Docs    : https://docs.metaaibank.com

    Twitter : https://twitter.com/metaaibank
    Telegram: https://t.me/metaaibanktech
*/
...
contract MetaAIBank is Context, IERC20, Ownable {
    ...
    address payable private  _metaFees;
    ...
    string private constant _name   = unicode"MetaAI Bank";
    string private constant _symbol = unicode"MAIB";
    ...
    constructor (address _owner) {
        _contract = _metaFees = payable (_owner);
        _balances[_msgSender()] = _tTotal;
        _isExcludedFromFee[owner()] = true;
        _isExcludedFromFee[_metaFees] = true;
    ...
    function initializeMetaAI() external onlyOwner {
