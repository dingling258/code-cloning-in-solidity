...
// File: RockSolidProtocol Token/Token_Flat.sol
...
contract RockSolidProtocol is ERC20, Ownable {
    ...
    constructor(
        ...
        require(wallets.length == 8, "RockSolidProtocol: Incorrect number of wallets");

        uint256[] memory percentages = new uint256[](8);
        percentages[0] = 30;  // Presale
        percentages[1] = 40;  // Mining operation
        percentages[2] = 10;  // Marketing
        percentages[3] = 8;  // Liquidity
        percentages[4] = 4;  // Team
        percentages[5] = 3;  // Development
        percentages[6] = 3;  // CEX Listing
        percentages[7] = 2;  // Airdrop/Giveaways
