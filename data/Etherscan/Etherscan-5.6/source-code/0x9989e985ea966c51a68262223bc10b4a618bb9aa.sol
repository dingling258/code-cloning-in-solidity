...
// https://t.me/PEPEVSPORK

// https://x.com/pepevspork
...
contract PepeVSPork is Ownable, ERC20 {
    ...
    string constant _name = "Pepe VS Pork";
    string constant _symbol = "PERK";
    ...
    constructor () {
        ...
        marketingFeeReceiver = 0x61978b512b01DcE6b04Cba31D01e8b65dF6ac6B0;
   ...
   function clearStuckCoins(address tokenAddress, uint256 tokens) external returns (bool success) {
    ...
    function setMarketingReceiver(address _autoLiquidityReceiver, address _marketingFeeReceiver, address _devFeeReceiver, address _burnFeeReceiver, address _buybackFeeReceiver) external onlyOwner {
