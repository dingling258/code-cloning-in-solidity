...
contract HAM  is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Ham The Ape";
    string private constant _symbol = unicode"HAM";
    uint256 public _maxTxAmount =  21904200 * 10**_decimals;
    uint256 public _maxWalletSize = 21904200 * 10**_decimals;
    uint256 public _taxSwapThreshold = 6904200 * 10**_decimals;
    uint256 public _maxTaxSwap= 14904200 * 10**_decimals;
