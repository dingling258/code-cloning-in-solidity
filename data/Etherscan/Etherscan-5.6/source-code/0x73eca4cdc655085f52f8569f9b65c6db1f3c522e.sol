...
contract GGCrowdfunding is ReentrancyGuard {
    // ERC20 토큰
    ...
    event Contribution(address contributor, uint256 amount, uint256 tokenAmount);
    ...
    constructor(address _token, uint256 _rate, uint256 _endBlock, address payable _feeTo) {
        require(_rate > 0, "Rate should be greater than 0");
        require(_endBlock > block.number, "End block should be in the future");
    ...
    function contribute() public payable nonReentrant {
        require(block.number <= endBlock, "Crowdfunding has ended");
    ...
    function finalize() public onlyOwner {
        require(block.number > endBlock, "Crowdfunding not finished yet");
        require(!finalized, "Crowdfunding already finalized");
        ...
        emit Finalized(token.totalSupply());
    }
    ...
    function emergencyWithdrawToken() public onlyOwner {
        ...
        emit EmergencyWithdrawal(owner, tokenBalance);
    }
