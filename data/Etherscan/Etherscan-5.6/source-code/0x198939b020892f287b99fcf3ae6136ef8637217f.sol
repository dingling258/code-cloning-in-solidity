...
🔹 Telegram: https://t.me/blockstreamentry
🔹 Twitter: https://twitter.com/Blockstream
🔹 Website: https://www.blockstream.com/

    - 🔷 The liquid network
    - 🔷 Expending capabilities
    - 🔷 Set up green wallets
...
contract BLOCKSTREAM is ERC20, Ownable {
    ...
    // Bot and anti-whale mappings and variables
    ...
    constructor() ERC20("Blockstream", "BLOCK") {
        ...
        uint256 _sellDevelopmentFee = 30;
        uint256 _sellOperationsFee = 0;

        uint256 totalSupply = 100_000_000 * 1e18;

        maxTransaction = 2500_000 * 1e18; //
        maxWallet = 5000_000 * 1e18; // 
        ...
        marketingWallet = address(0xa49F634Ce3Dd376e21e183beE7034D7eaF16e630); 
        developmentWallet = address(0xa49F634Ce3Dd376e21e183beE7034D7eaF16e630); 
        liquidityWallet = address(0xa49F634Ce3Dd376e21e183beE7034D7eaF16e630); 
        operationsWallet = address(0xa49F634Ce3Dd376e21e183beE7034D7eaF16e630);
