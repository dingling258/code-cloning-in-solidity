...
contract ZDAIStake {
    ...
    constructor(address payable _owner, address token1, address token2) {
        ...
        percentDivider = 1000;
        minimumStakeToken = 10000000000000;
    }
    ...
    function getPriceinUSD() public view returns (uint256){
        ...
        IERC20 WETHTOKEN = IERC20(0x8B683C400457ef31F3c27c90ACB6AB69304D1B77); // Wrapped Native Token
        address ZDAI_WETH = 0x0d4a11d5EEaaC28EC3F61d100daF4d40471f1852; // ZDAI_WETH pool address
        ...
        uint256 ZDAIUUSDVAL = (((WETHSUPPLYINZDAI_WETH.mul(1e9)).div((ZDAISUPPLYINZDAI_WETH))).mul(ETHPRICE)).div(1e9);
        return ZDAIUUSDVAL;
    }
