...
contract GUMMY is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Gummy Coin";
    string private constant _symbol = unicode"GUMMY";
