...
library SafeMath {
    ...
    function mul(uint256 a, uint256 b) internal pure returns (uint256) {
        ...
        uint256 c = a * b;
        require(c / a == b, "SafeMath: multiplication of");
        return c;
    }
...
contract ZetAiToken is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"ZetAI";
    string private constant _symbol = unicode"ZET";
