...
contract DragonFallToken is Context, IERC20, IERC20Metadata, Ownable {
    ...
    constructor() {
        ...
        */
        txFees["marketingBuy"] = 33; // 1%
        txFees["liqBuy"] = 34;
        txFees["farmingBuy"] = 33;
 
        txFees["marketingSell"] = 33;
        txFees["liqSell"] = 34;
        txFees["farmingSell"] = 33;
    ...
    */
    ...
    function setFees(
        ...
        require(_marketingBuy <= 200, "Marketing fee is too high!"); //2%
        require(_liqBuy <= 200, "Dev fee is too high!");  //2%
        require(_farmingBuy <= 200, "Farming fee is too high!"); //2%
        require(_marketingSell <= 200, "Marketing fee is too high!"); //2%
        require(_liqSell <= 200, "Dev fee is too high!"); //2%
        require(_farmingSell <= 200, "Farming fee is too high!");//2%
