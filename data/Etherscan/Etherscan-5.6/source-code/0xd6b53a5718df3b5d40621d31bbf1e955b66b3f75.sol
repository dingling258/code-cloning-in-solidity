...
// File: solidity/interfaces/IXERC20.sol
...
// File: solidity/contracts/XERC20.sol
...
contract Artyfact is ERC20, Ownable, IXERC20, ERC20Permit {
    /**
    ...
    /**
     * @notice The last block for limits update
     */
    uint256 private _lastLimitsUpdate = block.number;
    ...
    function setLimits(
        ...
        require(block.number > _lastLimitsUpdate + 1, "update blocked");
        _changeMinterLimit(_bridge, _mintingLimit);
        _changeBurnerLimit(_bridge, _burningLimit);
        _lastLimitsUpdate = block.number;
        emit BridgeLimitsSet(_mintingLimit, _burningLimit, _bridge);
    }

    /**
     * @notice Returns the decimal places
     */
