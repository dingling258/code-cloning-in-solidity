...
Killer Bean Forever: Where every trade comes with a shot of espresso and a side of explosive action

Site: https://www.killerbeanjack.xyz/
Chat: https://t.me/killerbeanjacketh
...
contract JACK is ERC20, Ownable {
    ...
    constructor() ERC20("KILLER BEAN", "JACK") {
    ...
    function launchJack() external onlyOwner {
        tradingActive = true;
        swapEnabled = true;
