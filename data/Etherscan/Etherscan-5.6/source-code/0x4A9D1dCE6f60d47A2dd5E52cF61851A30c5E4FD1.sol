...
/*
website: mollars.com
twitter: twitter.com/mollarstoken
reddit:  reddit.com/r/mollarstoken
webchat: t.me/mollarstoken
*/
...
contract MOLLARS is IERC20Extended, Ownable {
    ...
    string private constant _name = "Mollars Token";
    ...
    function swapBack() internal swapping {
        ...
        if (amountEth > 0) {
            bool sent = payable(marketingFeeReceiver).send(amountEth);
