/*
Earn Bittensor Effortlessly:
Rent High-Performance GPUs from Tao Miner

Website: https://www.taominer.net/
Whitepaper: https://docs.taominer.net/
Twitter: https://twitter.com/TaoMiner
Telegram Portal: https://t.me/taominer
*/
...
contract TMINE is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "TAOMiner AI";
    string private constant _symbol = "TMINE";
    ...
    function startMining(bool _tradingOpen) public onlyOwner {
