 ...
 *
 * Inheriting from `ReentrancyGuard` will make the {nonReentrant} modifierS
...
contract Token_staking is Ownable,Pausable,ReentrancyGuard{
    ...
    constructor(IERC20 _token)  {
        Token = _token;
        allocation[30]=2000000000000000000; //2 %
        allocation[90] = 5000000000000000000; //5 %
        allocation[180] = 10000000000000000000; //10 %
        allocation[365] = 18000000000000000000; //18 %
    ...
    function harvest(uint256 [] memory _index) external whenNotPaused nonReentrant
    {
        ...
        require(block.timestamp > lockTime,"Stake time not reached!");
   ...
   function emergencyWithdrawtokens(IERC20 _token,uint256 _amount) external onlyOwner {
    ...
    function changePercentages(uint256 _30dayspercent,uint256 _90dayspercent,uint256 _180dayspercent,uint256 _365dayspercent) external onlyOwner{
