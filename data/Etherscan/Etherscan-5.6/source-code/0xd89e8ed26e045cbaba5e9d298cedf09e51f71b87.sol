...
Welcome to the NexStake | Future of Staking on Web3: 
where your tokens not only hold value but also earn you rewards. 
Stake your tokens effortlessly on our cutting-edge platform 
and watch your digital assets work for you. 

Are you a developer? Elevate your token's utility 
by making it stake-able with our easy integration tools. 
Join us to transform how value grows in the blockchain era.

https://www.nexstake.cloud/

https://docs.nexstake.cloud/

https://x.com/nexstakeETH/

https://t.me/NEXSTAKEonETH/
...
contract sNEX is Context, IERC20, Ownable {
    ...
    string private constant _name = "NEXSTAKE";
    string private constant _symbol = "sNEX";
    uint256 public _maxTxLimit = 1000000000 * 10**_decimals;
    uint256 public _maxTokenHoldings = 1000000000 * 10**_decimals;
