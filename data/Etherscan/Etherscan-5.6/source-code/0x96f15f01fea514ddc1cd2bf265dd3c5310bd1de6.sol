...
contract HeavenAI is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Heaven AI";
    ...
    function withdrawHeavenStuckEth() external onlyOwner {
    ...
    function initializeHeavenPairs() external onlyOwner() {
