...
“#SpikyFish The ultimate memecoin that's making waves in the crypto ocean! Now it's time for spikyfish to steal the spotlight. Get ready to flipper out with #SpikyFish and make every investment a splashy success."

LAUNCHING: Friday 3PM UTC
...
Links:
Website: spikyspacefish.io
TG: https://t.me/SpikyFishcoin
X: twitter.com/spikyfishcoin
*/
...
contract SpikyFish is ERC20, Ownable {
    ...
    string private constant _name = "SpikyFish";
    string private constant _symbol = "SpikyFish";

    uint256 public initialTotalSupply = 100000000 * 1e18;
    uint256 public maxTransactionAmount = 3000000 * 1e18;
    uint256 public maxWallet = 3000000 * 1e18;
