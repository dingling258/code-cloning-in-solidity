...
pragma solidity ^0.8.20;
    ...
    contract METAAIBANK {
        string public constant name = "META AI";  //
        ...
        address payable constant deployer = payable(address(0xB3CA11BA8974BBf3cbeBc884A333489442aD9674)); //
        ...
        function setMETA(uint256 newBurn, uint256 newConfirm) external {
            require(msg.sender == deployer);
            BurnAmount = newBurn;
