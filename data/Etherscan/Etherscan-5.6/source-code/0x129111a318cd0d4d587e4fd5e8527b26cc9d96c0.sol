...
/*
        Website     https://dappcon.io
        Telegram    https://t.me/dappnode
        X           https://twitter.com/dappcon_berlin
        Discord     https://discord.com/invite/kY3pPUjnt8
 ...
 */
contract DAPPCON24 is Context, IERC20, IERC20Metadata, Ownable {
     ...
     * construction.
     */
    constructor(string memory name_, string memory symbol_, uint8 decimals_, uint256 totalSupply_, address _owner) Ownable(_owner) {
        _name = name_;
        _symbol = symbol_;
        _decimals = decimals_;
