/**
    Varus AI: Accuracy, speed and lightning AI.
    varus-ai.com
    https://t.me/Varus_AI
*/
...
contract Varus is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("VarusAI", "VARAI") {
        //Mainnet
        ...
        uint256 totalSupply = 10_000_000 * 1e10;
        ...
        marketingWallet = address(0x3304EaA9B88F900DDC809A44eFeE770C01a03d89);
        ...
        _mint(devWallet, totalSupply * 2 / 100);
        _mint(marketingWallet, totalSupply * 2 / 100);
        _mint(address(this), totalSupply * 96 / 100);
    }
