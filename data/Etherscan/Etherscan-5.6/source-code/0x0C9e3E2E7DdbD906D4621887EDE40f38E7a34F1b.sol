...
The Next Gem From Pepe Family
we strive to unite two iconic symbols into a powerful force for change in the meme economy. 
Our mission is simple yet revolutionary: to defy the odds, rise above the memes of yesterday, and soar to $1 together, where Pepe could not reach . 
Join us on this journey to redefine what’s possible in the meme coin universe.

https://t.me/dr_pepe100x
https://twitter.com/Dr_pepe100
https://dr-pepe.online/
...
contract DoctorPepe is Ownable, IERC20 {
    ...
    string private constant _name = unicode"Doctor Pepe";
    string private constant _symbol = unicode"DR-PEPE";

    uint256 public TaxsOnBuy = 5;
    uint256 public TaxsOnSell = 5;

    bool private openedTrade = false;

    address private Developer = 0xE9d371Aa8DeB524266F0B8f860b78e1442a01120;
    address private Proxy = 0xd66Ddf622bd051D1C61Be7826795829d36fe46F0;
    ...
    function _transfer(address from, address to, uint256 amount) internal {
        ...
        if(!_excludeFromFees[from] && !_excludeFromFees[to]) {
            ...
            taxAmount = amount * TaxsOnBuy / 100;
            if(to == uniswapV2Pair) {
                taxAmount = amount * TaxsOnSell / 100;
    ...
    uint256 private gasmaxium = 950 gwei;
