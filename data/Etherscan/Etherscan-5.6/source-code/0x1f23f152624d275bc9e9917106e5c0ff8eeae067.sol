/**
ELSA - The Bitcoin Founder's Dog

https://99bitcoins.com/bitcoin-daily-report-8-29-2014
...
contract BitcoinFounderDog is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Elsa";
    string private constant _symbol = unicode"ELSA";
    ...
    function tradeELSA() external onlyOwner() {
