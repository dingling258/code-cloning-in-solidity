...
contract CryptoProcessingUnit is ERC20, Ownable {
    ...
    constructor() ERC20("Crypto Processing Unit", "CPU") {
        ...
        maxTransactionAmount = 1_200_000_000 * 1e18;
        maxWallet = 1_200_000_000 * 1e18;
        ...
        marketingWallet = address(0x0A26f4eD45a09591DAB327414e473DB206687cC9);
        developmentWallet = address(0xc0327ce6d1A3DAae3396fDCBF9dcb1B92Fbb1FE9);
