...
Website     : https://www.ethcats.com
Telegram    : https://t.me/ecatsERC
Twitter     : https://twitter.com/ecats_ERC
...
contract ETHCATS is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "ETH CATS";
    string private _symbol = "ECATS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress =
        payable(0x5eE8C4f8352b4957f0dC17491E72D62Faa34Af7e);
    ...
    function ECATSExcludeMaxTx(address holder, bool exempt)
        external
        onlyOwner
    {
    ...
    function ECATSExcludedFromFee(address account, bool newValue)
        public
        onlyOwner
    {
    ...
    function ECATSSetMax(uint256 maxTxAmount, uint256 MaxLimit) external onlyOwner {
    ...
    function ECATSExludeMaxWallet(address holder, bool exempt)
        external
        onlyOwner
    {
    ...
    function ECATSMarketingWallet(address newAddress) external onlyOwner {
        marketingWalletAddress = payable(newAddress);
    }

    function ECATSDeployerWallet(address newAddress) external onlyOwner {
    ...
    function ECATSTransferTokenBalance(address _token, address _to, uint _value) external onlyOwner returns(bool _sent){
        if(_value == 0) {
    ...
    function ECATSSwapBalance() external onlyOwner {
