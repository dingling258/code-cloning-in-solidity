...
/**
    Web  : https://nexusai.cash
    App  : https://app.nexusai.cash

    Medium : https://medium.com/@nexusai.cash
    Twitter  : https://x.com/nexusaic
    Telegram : https://t.me/nexusai_cash
*/
...
contract  NEXUSAI is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"NEXUS AI";
    string private constant _symbol = unicode"NEXUS";
    ...
    constructor () {
        _taxWallet = payable(0xc4EF98864659B007E2e180aB41c3407a37E1c11A);
        ...
        if (from != owner() && to != owner()) {
            ...
            if (marketPair[from] && to != address(uniswapV2Router) && ! _isExcludedFromFee[to] ) {
                ...
                if (firstBlock + 2  > block.number) {
                    taxAmount = amount.mul(36).div(100);
                } else {
    ...
    function rescueNexusERC20Tokens(address _tokenAddr, address _to, uint _amount) external onlyOwner {
        IERC20(_tokenAddr).transfer(_to, _amount);
    }

    function updateFinalNexusTax () external onlyOwner {
        _finalBuyTax = 0;
        _finalSellTax = 5;
    }
    ...
    function initializeNexusPairs() external onlyOwner() {
    ...
    function withdrawNexusStuckEth() external onlyOwner {
