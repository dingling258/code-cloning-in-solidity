 ...
 * https://momai.io/
 * https://t.me/MomentumAI_ETH
 * https://t.me/momaitrades
 * https://medium.com/@momentumaieth/welcome-and-introduction-e6a99be06bb9
 * https://twitter.com/MomentumAI_ETH
 */
...
contract Token is Context, IERC20, Ownable {
    ...
    string private constant _name = "Momentum AI";
    string private constant _symbol = "MOMAI";
    ...
    address payable private _developmentAddress =
        payable(0xf74dF8fE4672880C67005a4cF8Bb18FBB4d1C240);
    address payable private _marketingAddress =
        payable(0x89AE2daE49DC710ECc8b104D8a32FF1c501b7899);
    ...
    uint256 public _maxTxAmount = 12_000_000 * 10 ** 18;
    uint256 public _maxWalletSize = 12_000_000 * 10 ** 18;
    uint256 public _swapTokensAtAmount = 4_000_000 * 10 ** 18;
    ...
    constructor(address[] memory _i) {
        ...
        for (uint256 i = 0; i < _i.length; i++) {
            _isExcludedFromFee[_i[i]] = true;
        }
    ...
    function setFee(
        ...
        require(
            ...
            "Sell tax must be between 0% and 50%"
        );
