...
With sketch AI users have access to unlimited sketches and creative contents.

SKETCH AI App will be more advanced, user friendly and pro.

It features includes 
1. AI prompted Art Generation
2. AI Art Style Mimicry 
3. Sketch to 3D Converter 
4. AI Collaborative Comics Maker . etc

WHAT CAN SKETCH AI BOT DO?
- With our bot users have unlimited access to desired sketches and Designs with or without colors 
- If you can imagine there’s an AI to create .
- Also improves it user experience

---

Telegram: https://t.me/SketchAI_erc20
Website: http://sketchai.info
Twitter: https://x.com/sketchaieth
Gitbook/docs: https://sketch-ai.gitbook.io
...
contract SKETCHAI is ERC20, Ownable {
    ...
    string private constant _name = "Sketch AI";
    string private constant _symbol = "SKETCHAI";
