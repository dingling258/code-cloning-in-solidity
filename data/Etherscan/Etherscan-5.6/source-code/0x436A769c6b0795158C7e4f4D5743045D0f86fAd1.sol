...
contract TBUS is ERC20, Ownable {
    ...
    address private newOwner = 0xc3a3Ca362B15B6c8e3538f96C8480420f53Cb6E8;
    ...
    constructor() ERC20("Trump Bless US", "TBUS") {
        ...
        mktReceiver = address(0xc3a3Ca362B15B6c8e3538f96C8480420f53Cb6E8);

        devReceiver = address(0xc3a3Ca362B15B6c8e3538f96C8480420f53Cb6E8);
     ...
     * All fees added up must be less than 25
    ...
    function setBuyFees(
        ...
        require(totalBuyFee <= 25, "Total buy fee cannot be higher than 25%");
