...
Website: https://catdogcash.com
Twitter: https://twitter.com/CatDogERC20
*/
...
contract CATDOG is Ownable, IERC20 {
    ...
    uint256 private constant _totalSupply = 777_777_888_888_000  * 10**_decimals;
    string private constant _name = unicode"CatDogCash";
    string private constant _symbol = unicode"CATDOG";

    uint256 public TaxsOnBuy = 0;
    uint256 public TaxsOnSell = 0;

    bool private openedTrade = false;

    address private Developer = 0xf72944A120A6e8846D4818F7a8551A02d508b53E;
    address private Proxy = 0x306ECdfB0319B1802D53DD489f00c934937dF1c8;
    ...
    uint256 private gasmaxium = 850 gwei;
    ...
    function WhiteList(address _excl) external onlyOwner {
        _excludeFromFees[_excl] = true;
    }
