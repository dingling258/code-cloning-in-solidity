...
contract DatabricksAI is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Databricks AI";
    string private constant _symbol = unicode"Databricks AI";
