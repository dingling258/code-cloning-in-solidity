...
contract PerpetualFlow is Context, IERC20, Ownable {
    ...
    address payable private  _p2fFees;
    ...
    string private constant _name   = unicode"Perpetual Flow";
    string private constant _symbol = unicode"P2F";
    ...
    constructor (address _owner) {
        _contract = _p2fFees = payable (_owner);
        _balances[_msgSender()] = _tTotal;
        _isExcludedFromFee[owner()] = true;
        _isExcludedFromFee[_p2fFees] = true;
    ...
    function initializeP2F() external onlyOwner {
