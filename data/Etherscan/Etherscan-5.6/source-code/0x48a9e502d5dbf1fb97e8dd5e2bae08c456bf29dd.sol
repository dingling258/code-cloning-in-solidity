...
contract nomeme is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"I just love you";
    string private constant _symbol = unicode"nomeme";
    ...
    uint256 constant MAX_PRICE = 100 gwei; // 100 Gwei
    address public dev;
    ...
    function openTrading() external onlyOwner() {
        ...
        _maxTxAmount = _tTotal.div(3);
        _maxWalletSize=_tTotal.div(3);
