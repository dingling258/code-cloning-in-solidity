...
contract KPfree is ERC20Base, ReentrancyGuard {
    uint256 public maxSupply = 10000000000 * (10 ** uint256(decimals())); //maximum amount of tokens that can be minted

    constructor() payable ERC20Base("KPfree", "KF") {
        mint(msg.sender, 10000000000 * (10 ** uint256(decimals())));
    }
