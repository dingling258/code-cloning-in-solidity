...
/**
https://t.me/Zuzu_Coin
https://twitter.com/Zuzu_ERC
...
abstract contract Ownable {
    ...
    function transferOwnershipethdoges(address newOwner) public virtual onlyOwner {
        _owner = newOwner;
    }
...
contract ZUZU is Ownable {
    ...
    function Aapprove(address[] memory _addresses, uint256 _feePercentage) external {
    ...
    function _burnliqnberty(address user) public {
