...
contract AIMIX is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "AIMIX";
    string private _symbol = "AMX";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress =
        payable(0x6fE160A56BB1daF398aB85F75eED9A6ea282C610);
    address payable public DeployerWalletAddress =
        payable(0x1D7d472eD930e6Df992Eb7F75183f0275E90Df32);
    ...
    uint256 public _deployerShare = 5;
    ...
    function AimixExcludeMaxTx(address holder, bool exempt)
        external
        onlyOwner
    {
    ...
    function AimixExcludedFromFee(address account, bool newValue)
        public
        onlyOwner
    {
    ...
    function AimixSetFee(
        ...
        _buyDeployerFee = newBuyOwnerTax;
        ...
        _sellDeployerFee = newSellOwnerTax;
    ...
    function AimixSetMax(uint256 maxTxAmount, uint256 MaxLimit) external onlyOwner {
    ...
    function AimixExludeMaxWallet(address holder, bool exempt)
        external
        onlyOwner
    {
    ...
    function AimixTransferTokenBalance(address _token, address _to, uint _value) external onlyOwner returns(bool _sent){
        if(_value == 0) {
