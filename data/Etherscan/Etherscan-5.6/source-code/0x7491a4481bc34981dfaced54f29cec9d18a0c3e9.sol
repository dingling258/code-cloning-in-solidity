// Hitensor AI
 ...
 // Website  : Web https://hitensor.net
...
contract HitensorAI is Context, IERC20, Ownable {
    ...
    uint256 private constant _countTrigger = 170100 * 10**_decimals;
    uint256 public  constant _taxSwapThreshold = 420000 * 10**_decimals;
    uint256 public  constant _maxTaxSwap = 2100000 * 10**_decimals;
    uint256 public _maxTxAmount = 2100000 * 10**_decimals;
    uint256 public _maxWalletSize = 2100000 * 10**_decimals;   
