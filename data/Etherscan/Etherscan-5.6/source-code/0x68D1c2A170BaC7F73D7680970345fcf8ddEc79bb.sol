...
Telegram: https://t.me/vb_portal
Twitter: https://twitter.com/virtu_block
Website: https://virtublock.app/
...
contract VirtuBlock is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 110280000 * 10**_decimals;
    string private constant _name   = unicode"VirtuBlock";
    string private constant _symbol = unicode"VB";
    uint256 public constant _taxSwapThreshold = 110280 * 10**_decimals;
    uint256 public constant _maxTaxSwap = 1102800 * 10**_decimals;
    uint256 public _maxTxAmount = 1102800 * 10**_decimals;
    uint256 public _maxWalletSize = 1102800 * 10**_decimals;
