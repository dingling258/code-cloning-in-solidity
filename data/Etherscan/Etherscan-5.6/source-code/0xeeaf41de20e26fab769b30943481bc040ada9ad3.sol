...
The most Digital Meme Token Ever.

Telegram:   https://t.me/DigitsErc
Twitter:    https://twitter.com/DigitsErc
Website:    https://digitserc.weebly.com/
...
contract DigitsErc is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"DIGITS - 0123456789";
    string private constant _symbol = unicode"DIGITS";
    ...
    constructor () {
        ...
        _taxWallet = payable(0x914f651369ae9E7203524c3acF323940a4AC21E4);
