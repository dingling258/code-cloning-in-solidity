...
*abated from off the face of the ground; but
...
*from off the earth. And he stayed yet other seven
...
\     /
 \   /
  \ /
   v
*now the thud of the crashing rocks ceaselessly
*struck their ears, and the sea-washed shores
*resounded, and then Euphemus grasped the dove in
*his hand and started to mount the prow; and they, at
*the bidding of Tiphys, son of Hagnias, rowed with
*good will to drive Argo between the rocks, trusting
*to their strength. And as they rounded a bend they
*saw the rocks opening for the last time of all. Their
*spirit melted within them; and Euphemus sent forth
*the dove to dart forward in flight; and they all
*together raised their heads to look; but she flew
*between them, and the rocks again rushed together
*and crashed as they met face to face. And the foam
*leapt up in a mass like a cloud; awful was the
*thunder of the sea; and all round them the mighty
*welkin roared.
*6300000100 Egg Galaxy   
*7101001000 Ellipsea Argoplegades   
*
*
*/
...
// File: @openzeppelin/contracts@5.0.2/utils/cryptography/MessageHashUtils.sol
...
// File: @openzeppelin/contracts@5.0.2/utils/cryptography/EIP712.sol
...
// File: @openzeppelin/contracts@5.0.2/utils/cryptography/ECDSA.sol
...
contract EGG is ERC20, ERC20Permit {
    constructor() ERC20("EGG", "EGG") ERC20Permit("EGG") {
        _mint(msg.sender, 7101001000 * 10 ** decimals());
    }
}