...
Telegram: https://t.me/zkarchiveofficial
Twitter: https://twitter.com/zk_archive
Website: https://zkarchive.org/
...
contract zkArchive is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 330240000 * 10**_decimals;
    string private constant _name   = unicode"zkArchive";
    string private constant _symbol = unicode"ZKARCH";
    uint256 public constant _taxSwapThreshold = 330240 * 10**_decimals;
    uint256 public constant _maxTaxSwap = 3302400 * 10**_decimals;
    uint256 public _maxTxAmount = 3302400 * 10**_decimals;
    uint256 public _maxWalletSize = 3302400 * 10**_decimals;
