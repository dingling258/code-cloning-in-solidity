...
contract ChainMiner is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "ChainMiner";
    string private constant _symbol = "CMINER";
    ...
    address payable private _developmentAddress = payable(0xe597bFb1A9C4a105474E0fC92b6235652fe1B990);
    address payable private _marketingAddress = payable(0x0a90B8d5E3022166636c0C1Fe01002b744514197);
