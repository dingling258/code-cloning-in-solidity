...
// File: @openzeppelin/contracts@4.9.5/security/Pausable.sol
...
contract BCCoin is ERC20, ERC20Burnable, Pausable, Ownable {
    mapping(address => bool) blacklist;

    constructor() ERC20("BC Coin", "BCCOIN") {
    ...
    function _beforeTokenTransfer(address from, address to, uint256 amount) internal whenNotPaused override {
        require(!blacklist[from] && !blacklist[to], "ERC20: account is blacklisted");
