...
Data creation continues to explode and so does the demand for storing it. As an industry leader with manufacturing sites across the globe, 
we strive to meet that demand. We honor our people’s craftsmanship, take great pride in successfully collaborating with our partners, 
and care deeply about our customers and their data. Our solutions help protect memories, business intelligence, communication records, and so much more.
/*
/*
...
contract SeaGateAI  is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"SeaGate AI";
    string private constant _symbol = unicode"SeaGate AI";
    ...
    constructor () {
            ...
            _taxWallet = payable(_msgSender());
             ...
             _balances[address(this)] += _tTotal*50/100; 
