...
https://globaltimes.cn/page/202404/13
https://x.com/viduaierc
https://t.me/viduaierc
...
contract VIDU is Context, IERC20, Ownable {
    ...
    string private constant _name = "Vidu AI";
    string private constant _symbol = "VIDU";
    ...
    function RemoveTxnLimit() external onlyOwner{
        ...
        function setWhoBot(address account, bool state) external onlyOwner{
        bots[account] = state;
    }
    ...
    function settingBlockBuffer(uint8 _amount) external onlyOwner {
        blockBuffer = _amount;
    }
}