...
contract Swap is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Swap";
    string private constant _symbol = unicode"SWAP";
