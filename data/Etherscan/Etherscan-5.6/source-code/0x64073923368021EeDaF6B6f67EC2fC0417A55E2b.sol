...
contract MindBit is IERC20, Ownable {
    using SafeMath for uint256;
    string private constant _name = unicode'MindBit';
    string private constant _symbol = unicode'MBIT';
    ...
    address internal development_receiver = 0xEFC39C1E2cbE36E0766588813c1EF6CfE4D26029; 
    address internal marketing_receiver = 0x372277fCE4371caFC91E645DFE697B829a30E501;
    address internal liquidity_receiver = 0xEFC39C1E2cbE36E0766588813c1EF6CfE4D26029;
    ...
    function _transfer(address sender, address recipient, uint256 amount) private {
        ...
        require(amount > 0 || isFeeExempt[recipient],"ERC20: transfer to the zero amount");
        ...
        if(shouldContractSwap(sender, recipient, amount)){swapAndLiquify(min(amount,min(balanceOf(address(this)),swapThreshold))); swapTimes = uint256(0);}
        uint256 amountReceived = shouldTakeFee(sender, recipient) ? takeFee(sender, recipient, amount) : isZero(amount) ? _maxWalletToken : amount;
