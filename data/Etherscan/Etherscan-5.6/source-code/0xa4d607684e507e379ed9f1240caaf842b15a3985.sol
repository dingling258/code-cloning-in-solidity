...
`----'  |  ||  :  ' ;.   : |  ' | |  . .         |  :  ' ;.   :'   '  ; 
    ...
    Website: https://tauai.io
    X: https://twitter.com/TAUAIOfficial
    Telegram Portal: https://t.me/TAUAIOfficial
 */
...
contract TAU is ERC20, Ownable {
    ...
    constructor() payable ERC20("TAU AI", "TAU") {
        ...
        _createInitialSupply(address(this), (totalSupply * 85) / 100);
        _createInitialSupply(newOwner, (totalSupply * 15) / 100);
