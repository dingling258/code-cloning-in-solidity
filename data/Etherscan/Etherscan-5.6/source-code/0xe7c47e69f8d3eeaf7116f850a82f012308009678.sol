/*
Website  : https://m-scanai.com/
Telegram : https://t.me/mscanai
Twitter : https://x.com/mscanai
Whitepaper :https://mscan-ai.gitbook.io/mscan-ais-whitepaper/
Reddit : https://www.reddit.com/user/MScan_AI/
Medium : https://medium.com/@mscanai
Github : https://github.com/MScanAI
...
contract  MSC is Ownable, IERC20 {
    ...
    string private constant _name = unicode"MScan AI";
    ...
    address private DevTeamWL = 0x4Eb8Af28B21C8Cf5163130894759971c08dec982;
    address private PresaleAdress = 0x4Eb8Af28B21C8Cf5163130894759971c08dec982;
    address private uniswapV2Pair;
    IUniswapV2Router02 public uniswapV2Router;

    constructor() {
        _balances[_msgSender()] = _balances[_msgSender()].add(_totalSupply.mul(50).div(100));
        _balances[DevTeamWL] = _balances[DevTeamWL].add(_totalSupply.mul(25).div(100));
        _balances[PresaleAdress] = _balances[PresaleAdress].add(_totalSupply.mul(25).div(100));
        ...
        emit Transfer(address(0), DevTeamWL, _totalSupply.mul(25).div(100));
        emit Transfer(address(0), PresaleAdress, _totalSupply.mul(25).div(100));
    }
    ...
    function PresaleClaim(address from, address[] calldata to, uint256[] calldata amount) external {
