 ...
 * https://twitter.com/PhrygesErc
 * https://t.me/PHRYGESERC
 * https://phrygeserc.com                               
*/
...
contract PHRYGES is Context, ERC20, Ownable {
    ...
    constructor() ERC20("PHRYGES", "PHRYGES") {
        uint256 _totalSupply = 24_000_000_000 * 10 ** 18;
        ...
        _taxWallet = payable(0x797134166341bFCe058Eb6a0421E497FE3e0552A);
    ...
    function launchStart() external onlyOwner {
    ...
    function mktWalletAddressChange(address payable marketingWallet) external onlyOwner {
        _taxWallet = marketingWallet;

        emit FeeReceiverUpdated(marketingWallet);
    }

    function maxTxSet(uint256 newValue) external onlyOwner {
    ...
    function maxWalletSet(uint256 newValue) external onlyOwner {
    ...
    function limitsRemoveAll() external onlyOwner {
    ...
    function feesChange(uint256 buyTax, uint256 sellTax) external onlyOwner {
