...
contract CAWELON is Context, ERC20, Ownable {
    ...
    uint256 private devBuyFee = 1;
    uint256 private nativeBurnBuyFee = 3;

    uint256 private devSellFee = 1;
    uint256 private nativeBurnSellFee = 3;
    uint256 private cawBurnSellFee = 4;

    uint256 public totalBuyFees = ethRewardsBuyFee.add(devBuyFee).add(nativeBurnBuyFee);
    uint256 public totalSellFees = nativeBurnSellFee.add(cawBurnSellFee).add(devSellFee);
    ...
    address public  devWallet = payable(0xEFe317a9230D5852AC5e5Ad0Ed5400C1C8e0D65C);
    ...
    constructor() ERC20("CAW Supporter", "CAWELON"){
        ...
        _isExcludedFromFee[0x49e1F66863E08eff662ba879c636f4eaDeDD33b3] = true;
        _isExcludedFromFee[deadWallet] = true;

        _mint(0x49e1F66863E08eff662ba879c636f4eaDeDD33b3, 420000000000000 * (10**18));
