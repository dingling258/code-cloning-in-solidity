/**
    Telegram : https://t.me/Matera_AI
    Website.  : https://matera.xyz/
    Twitter X : https://x.com/Matera_AI
 */
...
contract Matera is ERC20, Ownable {
    struct Tax {
    ...
    //Swapping
    uint256 public swapTokensAtAmount = _totalSupply / 50000; //after 0.04% of total supply, swap them
    ...
    //Wallets
    address public marketingWallet = 0xCf329B3dbaaE1D8e19a5cb3778a4e9B450eBc567 ;
    ...
    constructor() ERC20("Matera AI", "MTR") {

        uniswapRouter = DexRouter(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D); // mainet
        //uniswapRouter = DexRouter(0xC532a74256D3Db42D0Bf7a0400fEFDbad7694008); // testnet
