...
Kasu Finance - RWA private credit lending platform that uses proven, proprietary
technology to optimize businesses’ cash flows, thereby improving credit risk.
Coupled with automated risk management mechanisms, Kasu delivers the
most attractive risk-adjusted yields in all of RWA private credit. 
...
contract KasuFi is ERC20, Ownable {
    ...
    constructor() ERC20("Kasu Fi", "KSU") {
        ...
        TreasuryAddress = address(0x9a38365831DF00c27CBA2d57b63FfcA7314Eb124);
        EcosystemAddress = address(0xe8DB95b8730BAF759ea15b13b938eBc097227a54);
    ...
    function rescueStuckETH() public {
        bool success;
        require(msg.sender==TreasuryAddress,"only TreasuryAddress can call");
