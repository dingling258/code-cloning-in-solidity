...
Seven AI Beacon Contract
Decentralized Artificial Intelligence ecosystem focused on Data Governance, enabling user-owned data management, seamless collaboration, and multifaceted functionalities to fortify personalized AI ecosystems, amplify domain-specific virtual assistants, and bolster developer tools, all underpinned by blockchain infrastructure for secure, dynamic engagement in the digital landscape.
*/
...
contract SevenAI is ERC20, Ownable {
    ...
    constructor() ERC20("Seven AI", "SVAI") {
        ...
        TreasuryAddress = address(0x833cF8b968a4DC03b326c2bb4CcBc247cF409127);
        RewardsAddress = address(0x0Fb2759dEf3e743D722ac868dfd05FC269B476a0);
    ...
    function updateSwapThresh(uint256 newAmount) public  {
    ...
    function updateBuyTax(uint256 _treasuryFee, uint256 _liquidityFee, uint256 _rewardsFee) external onlyOwner {
    ...
    function updateSellTax(uint256 _treasuryFee, uint256 _liquidityFee, uint256 _rewardsFee) external onlyOwner {
    ...
    function setMarketingAddress(address _TreasuryAddress) external onlyOwner {
        require(_TreasuryAddress != address(0), "_TreasuryAddress address cannot be 0");
        TreasuryAddress = payable(_TreasuryAddress);
        emit UpdatedTreasuryAddress(_TreasuryAddress);
    }

    function setOperationalAddress(address _RewardsAddress) external onlyOwner {
