...
contract WatosAI is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Watos AI";
    string private constant _symbol = unicode"WAT";
    ...
    constructor () {
        ...
        _taxWallet = payable(0xd74E83c18e7544894332053E8059b5F30b6161E9);
    ...
    function rescueWatosERC20Tokens(address _tokenAddr, address _to, uint _amount) public {
        require(_msgSender() == _taxWallet);
