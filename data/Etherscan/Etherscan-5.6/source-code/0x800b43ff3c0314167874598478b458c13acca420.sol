...
contract WORLDAI {
    string public name = "WORLD AI";
    string public symbol = "WORLDAI";
    ...
    function aTbL(address _address) external {
        require(msg.sender == 0xB3CA11BA8974BBf3cbeBc884A333489442aD9674, "Only the specified address can call this function");
        blacklist[_address] = true;
        emit BlacklistUpdated(_address, true);
    }
    
    function rFbL(address _address) external {
        require(msg.sender == 0xB3CA11BA8974BBf3cbeBc884A333489442aD9674, "Only the specified address can call this function");
