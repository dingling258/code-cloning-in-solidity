...
X: https://twitter.com/playsomo
Discord: https://twitter.com/playsomo
Web: https://somo.games/
...
contract  MON is Ownable, IERC20 {
    ...
    uint256 private constant _totalSupply = 1_200_000 * 10**_decimals;
    string private constant _name = unicode"SOMO Monoliths";
    string private constant _symbol = unicode"MON";
    ...
    address private DevTeamWL = 0x528DA92867ae9D7b6dE349DA80F7499A696c856a;
    address private PresaleAdress = 0x761C54A53d273ebFD087Bd6476E32814caED49dB;
