...
contract CDFIPresale is Ownable {
    using SafeMath for uint256;
    ...
    constructor(IERC20 _USDT, IERC20 _USDC,IERC20 _token,address _feeRec)  {
       TokenPricePerUsdt=100000000000000000000;  //100 token per usdt first phase 
    ...
    function setTokenSold(uint256 _newTokenSold) external onlyOwner{
