...
contract SPA is Context, IERC20, Ownable {
    ...
    string  private constant _name   = unicode"0xSpade AI";
    string  private constant _symbol = unicode"SPA";
    uint8   private constant _decimals = 9;
    uint256 private constant _tTotal = 100000000 * 10**_decimals;
    uint256 private constant _countTrigger = 1000 * 10**_decimals;
    uint256 public  constant _taxSwapThreshold = 2000 * 10**_decimals;
