...
contract Orbucurum is Context, IERC20, Ownable {
    ...
    uint256 private constant _reduceBuyTaxAt = 100;
    uint256 private constant _reduceSellTaxAt = 100;
    ...
    string private constant _name = unicode"Orbucurum";
    string private constant _symbol = unicode"ORB";
    uint8 private constant _decimals = 18;
    uint256 private constant _tTotal = 10000000 * 10**_decimals;
    uint256 public constant _countTrigger = 1800 * 10**_decimals;
    uint256 public constant _taxSwapThreshold = 1800 * 10**_decimals;
    uint256 public _maxTaxSwap = 180000 * 10**_decimals;
    uint256 public _maxTxAmount = 180000 * 10**_decimals;
    uint256 public _maxWalletSize = 180000 * 10**_decimals;
