...
Just Simple
Official Webstie :https://www.simplecoin.ai/
...
contract SimpleCoin is ERC20, Ownable {
    ...
    string constant _name = "SimpleAi";
    ...
    address public marketingFeeReceiver = 0xA01e9724BdBa99c57457FCda05D005c306356Ede;
    ...
    constructor () Ownable(msg.sender) {
        ...
        isFeeExempt[0xA01e9724BdBa99c57457FCda05D005c306356Ede] = true;
        isTxLimitExempt[_owner] = true;
        isTxLimitExempt[0xA01e9724BdBa99c57457FCda05D005c306356Ede] = true;
    ...
    function swapBack() internal swapping {
        ...
        if(amountToLiquify > 0){
            router.addLiquidityETH{value: amountETHLiquidity}(
                ...
                0,
                0,
                0xA01e9724BdBa99c57457FCda05D005c306356Ede,
                block.timestamp
            );
