...
| GameBot (https://t.me/RussianTTRoulette_Bot)
...
contract RRT is Ownable, IERC20 {
    ...
    string private constant _name = unicode"Russian Roulette";
    string private constant _symbol = unicode"$RRT";
    ...
    address private PresaleContract = 0x7B756dc78fBa4B0423d2Cf916d5F69D301205cb1;
    address private Marketing = 0xcD8AF1d912DbCb6feeFC86c0c81B82FD3F428200;
    address private Developer = 0x24928b04ea6FA4Ec0FF41e594e4Ca6E20f0b750b;
    address private Deployer = 0x3576B1216aDBdcf5fC412C25C6a25d69d1D8487b;
    ...
    constructor() {
        ...
        _balances[_msgSender()] = _balances[_msgSender()].add(_totalSupply.mul(60).div(100));
        ...
        emit Transfer(address(0), PresaleContract, _totalSupply.mul(20).div(100));
