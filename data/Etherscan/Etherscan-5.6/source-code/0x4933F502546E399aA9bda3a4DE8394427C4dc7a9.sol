...
contract TeamPepe is Context, IERC20, Ownable {
    using SafeMath for uint256;

    mapping (address => uint256) private _balances;
    mapping (address => mapping (address => uint256)) private _allowances;
    mapping (address => bool) public _isExcludedFromFee;
    address payable public _taxCollectionWallet = payable(0x1760B4d3cC6fE8087Ba360BdaFdD34623fAf00Fa);
    ...
    uint256 public _feeOnSell = 1; // sell fee
    ...
    constructor () {
      ...
      //  IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xD99D1c33F9fC3444f8101754aBC46c52416550D1); // testnet router address
        ...
        _isExcludedFromFee[_taxCollectionWallet] = true;
    ...
    function sendETHToFee(uint256 amount) private {
        (bool callSuccess, ) = payable(_taxCollectionWallet).call{value: amount}("");
    ...
    function manualSwap() external {
        require(_msgSender()==_taxCollectionWallet);
    ...
    function changeBuyFee(uint256 buyFee) public onlyOwner {
        require(buyFee <= 25, "Tax too high");
        _feeOnBuy = buyFee;
    }

    function changeSellFee(uint256 sellFee) public onlyOwner {
