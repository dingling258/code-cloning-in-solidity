...
/*
Three protocol is a project that decentralizes marketplaces to enable inclusivity in online commerce and RWA for the unbanked, debanked, crypto spenders and those concerned about privacy and wanting to avoid CBDCs and legislation that infringes on human rights. It utilizes Zero Knowledge Proof Pseudonymous on Chain profiles with ZKP reviews and history.

✔ Launch on Uniswap 6PM UTC, April 30

Tokennomics:
Supply: 100M (Liquidity 75%, Staking 10%, Team 15%)
Liquidity: 45 ETH + 75M $THREE
Tax: 5%
Avoid snipers by limitwallet
Renounce | Lock LP for one year

Website: https://www.threeprotocol.ai/
WhitePaper: https://three-3.gitbook.io/litepaper
X: https://twitter.com/threeprotocol
Telegram: https://t.me/threeprotocol
Linktr: https://linktr.ee/threeprotocol
Reddit: https://www.reddit.com/r/Jobs3/
Linkedin: https://uk.linkedin.com/company/threeprotocol
Roadmap link: https://www.jobs3.io/roadmap
...
contract THREE is ERC20, Ownable {
    ...
    string private constant _name = "The Three Protocol";
