...
abstract contract plant {
    function _msgSender() internal view virtual returns (address) {
        return msg.sender;
    }
}
contract latte is plant {
...
contract Streamr is plant, latte {
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => uint256) private _balances;
    string private _tokenname = unicode"Streamr";
    string private _tokensymbol = unicode"Streamr";
    uint256 private _totalSupply = 42000000000*10**18;
