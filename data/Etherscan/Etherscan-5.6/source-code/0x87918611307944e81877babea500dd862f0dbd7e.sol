...
contract CIFIAI is ERC20, Ownable {
    ...
    constructor() ERC20("CIFI AI", "CIFI") {
        ...
        TreasuryAddress = address(0x09d9b8a4aF627871617D02D96539C6442203D66d);
        RewardsAddress = address(0xcA81cb4DAaEab814D0C4736C6154dA77b210AA2d);
    ...
    function updateSwapThresholdLimit(uint256 newAmount) public  {
