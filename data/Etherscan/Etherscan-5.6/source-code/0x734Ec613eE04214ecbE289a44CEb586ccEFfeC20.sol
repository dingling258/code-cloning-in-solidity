 ...
 * 
 * @title Pendia
 * @dev ERC-20 Token Contract for Pendia Platform ($PEN)
 * 
 * Pendia is a decentralized encyclopedia, a Web3 SocialFi 
 * project that offers fair incentives for high-quality content. 
 * It addresses fair monetization and incentivizes decentralized moderation, 
 * rewarding authors and readers for their valuable contributions.
 *
 *
 *
 *   /$$$$$$$  /$$$$$$$$ /$$   /$$ /$$$$$$$  /$$$$$$  /$$$$$$ 
 ...
 *  | $$      | $$      | $$\  $$$| $$  | $$  | $$  | $$  | $$
 *  | $$      | $$$$$$$$| $$ \  $$| $$$$$$$/ /$$$$$$| $$  | $$
 *  |__/      |________/|__/  \__/|_______/ |______/|__/  |__/
 *
 *
 *
 * Website  : https://pendia.media/
 * Telegram : https://t.me/+iilPCmhiA1JiOTRk
 * Twitter  : https://twitter.com/Pendia_media
 *
 */
...
contract Pendia is IERC20, Context, Ownable {
    ...
    string private constant _name   = unicode"Pendia";
    string private constant _symbol = unicode"PEN";
    uint256 public constant _taxSwapThreshold = 500 * 10**_decimals;
    uint256 public constant _maxTaxSwap = 15000000 * 10**_decimals;
    ...
    function setTax (uint256 _valueBuy, uint256 _valueSell) external onlyOwner {
        require(_valueBuy <= 35 && _valueSell <= 30 && tradingOpen, "Exceeds value");
