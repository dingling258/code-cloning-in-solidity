 ...
 *
 * Stakelytics: Stake your Crypto, Amplify Returns
 *
 * https://www.stakelytics.com/
 * https://t.me/stakelytics
 * https://x.com/stakelytics
 */
...
contract STKLS is ERC20, Ownable {
    ...
    constructor() ERC20("Stakelytics", "STKLS") {
        ...
        maxTx = (_totalSupply * 70) / 1000;
        maxWallet = (_totalSupply * 70) / 1000;
        ...
        marketingWallet = address(0x447ed9c2Ab09015f0C360B831698faAAF39b2429);
