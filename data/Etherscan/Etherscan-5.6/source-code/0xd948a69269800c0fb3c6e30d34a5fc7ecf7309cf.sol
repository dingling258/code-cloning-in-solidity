...
contract XCryptoBotsAI is ERC20, Ownable {
    ...
    constructor() ERC20(unicode"𝕏CryptoBotsAI", unicode"𝕏CAI") {        
        ...
        buyTotalFees = buyMarketingFee + buyRevShareFee + buyDevelopmentFee;

        sellMarketingFee = _sellMarketingFee;
        sellRevShareFee = _sellRevShareFee;
        sellDevelopmentFee = _sellDevelopmentFee;
        sellTotalFees = sellMarketingFee + sellRevShareFee + sellDevelopmentFee;

        marketingWallet = address(0xE74a1bC0D5464020e8F7654879027b9a37E2DDc9);
        developmentWallet = address(0x147E0474CA40EfC9560FB7D736c015A8788B23F6);
		revShareWallet = address(0x9cbC34f7797c2fb500605Bbc44d9426520e20777);
    ...
    function swapBack(uint256 amount) private {
        ...
        uint256 totalTokensToSwap = tokensForRevShare + tokensForMarketing + tokensForDev;
        bool success;
