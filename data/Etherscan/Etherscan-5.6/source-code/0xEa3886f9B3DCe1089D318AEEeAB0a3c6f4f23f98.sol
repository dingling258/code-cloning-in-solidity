...
contract DEBIT is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Debit Hub";
    string private constant _symbol = unicode"DEBIT";
    ...
    constructor () {
        _taxWallet = payable(0x0859E9E7E4674A8a9EdeDB7579BC2B8827560aBf);
