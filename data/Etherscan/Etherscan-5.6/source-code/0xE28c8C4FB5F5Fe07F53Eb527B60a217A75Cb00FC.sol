...
// File: contracts/AIBBC.sol

pragma solidity ^0.5.0;


contract AIBBC is ERC20Pausable, Ownable {
  string public constant name = "AIBBC";
  string public constant symbol = "AIBBC";
  ...
  event AIBBCAirDrop(address _receiver, uint256 _amount);
  ...
  function dropToken(address[] memory receivers, uint256[] memory values) public {
    ...
    for (uint256 i = 0; i < receivers.length; i++) {
      ...
      emit AIBBCAirDrop(receiver, amount);
    }
  }
