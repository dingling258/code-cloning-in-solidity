...
contract ColonelSanders is Context, IERC20, Ownable
{
    ...
    string private constant _name = unicode"Colonel Sanders";
    string private constant _symbol = unicode"KFC";
    uint256 public _maxTxAmount = 77777 * 10 ** _decimals;
    uint256 public _maxWalletSize = 77777 * 10 ** _decimals;
    uint256 public _taxSwapThreshold = 777 * 10 ** _decimals;
