...
contract Staking is Pausable, Ownable {
    ...
    uint256 public constant MAX_UNSTAKE_FEE = 20;

    uint256 public earlyUnstakeFee = 20;
    ...
    constructor() {
        stakingTokensDecimalRate = pow(10, 18);
        rewardsToken = IERC20(0x8b14d476783C5aA33300323dECABcfF9Bd8764d5);
        stakingToken = IERC20(0x8b14d476783C5aA33300323dECABcfF9Bd8764d5);
    ...
    function setStakeAdmin(address newAdmin) public onlyOwner {
        stakeAdmin = newAdmin;
    }
