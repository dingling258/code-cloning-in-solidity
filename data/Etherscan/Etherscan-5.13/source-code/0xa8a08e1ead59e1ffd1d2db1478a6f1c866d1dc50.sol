...
/**
DTPCD Token(Donald Trump presidential campaign donations) - MAGA
Trump supports the crypto industry, and we are supporting Trump's presidential campaign.
...
contract SUPPORTTRUMP is Context, IERC20, Ownable {
    ...
    uint256 private _taxWalletPercentage = 100;
    uint256 firstBlock;
    ...
    string private constant _name = unicode"DTPCD Token";
    string private constant _symbol = unicode"TRUMP";
    string public constant _slogan = unicode"DTPCD Token(Donald Trump presidential campaign donations) - MAGA. Trump supports the crypto industry, and we are supporting Trump's presidential campaign.";
