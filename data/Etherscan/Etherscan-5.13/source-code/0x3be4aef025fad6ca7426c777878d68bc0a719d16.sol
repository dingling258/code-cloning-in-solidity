...
// https://t.me/CloudMindAI

// https://cloudmindai.io
...
contract StakingV5 is Ownable, Pausable {
    ...
    function changeStakedTokenAddress(address _token) external onlyOwner {
        require(_token != address(stakingToken), "Address is the same");
        require(
            totalStaked == 0,
    ...
    function stake(uint256 _amount) external whenNotPaused {
        ...
        totalStaked += _amount + reward; // Update the total staked amount
