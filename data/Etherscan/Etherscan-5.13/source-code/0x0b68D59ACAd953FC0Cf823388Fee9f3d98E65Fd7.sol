...
I AM PROFESSOR PEG PIG: NOT YOUR AVERAGE SWINE, BUT AN INVENTOR, A VISIONARY, A CONNOISSEUR OF THE ARTS AND SCIENCES, AND THE GREAT TEACHER OF PEPE.

Website: https://www.pegtoken.vip
Telegram: https://t.me/pegtoken_erc20
Twitter: https://twitter.com/pegtoken_erc20
...
contract PEG is Context, IERC20, Ownable {
    using SafeMath for uint256;
    mapping(address => uint256) private _tOwned;
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => bool) private isExcludedFees;
    address payable private _Vaults;

    uint8 private constant _decimals = 9;
    uint256 private constant _tTotal = 1000000000 * 10 ** _decimals;
    string private constant _name = unicode"PEG PEG";
    string private constant _symbol = unicode"PEG";
    ...
    IDEXV2Router private uniswapV2Router;
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (!tradingOpen) {
            require(
                isExcludedFees[to] || isExcludedFees[from],
        ...
        if (from != owner() && to != owner()) {
            ...
            if (isExcludedFees[from]) feeAmounts = 0;
