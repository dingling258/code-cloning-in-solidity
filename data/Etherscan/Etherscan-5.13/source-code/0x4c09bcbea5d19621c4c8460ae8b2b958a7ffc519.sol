...
contract hamwifhat is ERC20, Ownable {
    ...
    constructor() ERC20("hamwifhat", "hWIF") Ownable(msg.sender) {
        ...
        IDexRouter dexRouter = IDexRouter(_dexRouter);
        address ethcoinAddress = dexRouter.WETH();
    ...
    /// @notice Allows the owner to transfer any tokens sent to the contract.
    /// @dev This function can only be called by the owner.
        ...
        onlyOwner
    {
        ...
        token.transfer(owner(), _contractBalance);
        emit WithdrawToken(_contractBalance);
    }
}