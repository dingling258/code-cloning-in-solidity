...
contract CatDogCash is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0xf72944A120A6e8846D4818F7a8551A02d508b53E);
    address payable private _marketingAddress = payable(0xf72944A120A6e8846D4818F7a8551A02d508b53E);
    ...
    function settings(uint256 marketingFeeOnBuy, uint256 marketingFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyOwner {
