...
/*
XYRA AI - Pioneering crypto evolution with innovative AI Solutions

Elevate your crypto trading with XYRA-AI Bot Ecosystem, your all-in-one solution for informed decisions, enhanced security, optimized trades, and comprehensive insights.

Features like:

⚡️ Influencers involvement regarding projects.
⚡️ Top trending projects on X and their sentiment analysis 
⚡️ Follow and list Twitter profiles and their sentiment analysis.
⚡️ Follow trades of your favourite Influencers on X 

Socials:

✅Telegram: https://t.me/xyraaiportal
🌐Website: https://xyraai.com
✖️Twitter: https://twitter.com/Xyra_AI
*/
...
contract XyraAI is ERC20, Ownable {
    ...
    string private constant _name = "Xyra AI";
    string private constant _symbol = "XYAI";
   ...
   function removeLimits() external onlyOwner {
    ...
    function SetFees(uint256 _buyFee, uint256 _sellFee) external onlyOwner {
        require(_buyFee <= 20 && _sellFee <= 35, "Fees cannot exceed 30%");
        BuyFee = _buyFee;
        SellFee = _sellFee;
    }
