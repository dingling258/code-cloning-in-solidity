...
contract FREED is ERC20, Ownable {
    ...
    constructor () ERC20("FreedomCoin", "FREED") 
    {   
        address router;
        address pinkLock;
        ...
        transferOwnership(0x0331535b9f37EB41F437EA0cfE345ABB9d102A1A);
        ...
        _totalFeesOnBuy    = liquidityFeeOnBuy  + ethFeeOnBuy;
        _totalFeesOnSell   = liquidityFeeOnSell + ethFeeOnSell;

        charityWallet = 0x047c0D746D42fF4cEe7d2CB1FBf5c0D090267931;
        marketingWallet = 0x0331535b9f37EB41F437EA0cfE345ABB9d102A1A;
        ...
        _mintOnce(owner(), 7e6 * (10 ** decimals()));
    ...
    function _transfer(address from,address to,uint256 amount) internal  override {
        ...
        if (canSwap &&
            ...
            uint256 ethShare = ethFeeOnBuy + ethFeeOnSell;
            ...
            if (ethShare > 0) {
                uint256 ethTokens = contractTokenBalance * ethShare / totalFee;
                swapAndSendEth(ethTokens);
            }          
    ...
    function swapAndSendEth(uint256 tokenAmount) private {
        ...
        uint256 newBalance = address(this).balance - initialBalance;
        uint256 donations = newBalance * 10 / 19;

        payable(charityWallet).sendValue(donations);
