...
Ivanka Trump and her family have a pet hamster named Chester that they got some time in 2023. 

https://celebritypets.net/pets/ivanka-trump-pets/

$CHESTER

Telegram: https://t.me/ChesterTrump
Website: https://www.ChesterTrump.site
Twitter: https://twitter.com/ChesterTrumpERC
...
contract CHESTER is Context, IERC20, Ownable {
    ...
    string private _name = "Chester";
    string private _symbol = "CHESTER";
    uint8 private _decimals = 18;

    address payable public marketingWalletDacc = payable(0xcdC04b1848D0c3Cc0EBfe2BbFd6B01028E76D067);
    ...
    uint256 public _buyMarketingFee = 129;
    uint256 public _buyDeveloperFee = 0;
    
    uint256 public _sellLiquidityFee = 0;
    uint256 public _sellMarketingFee = 129;
    ...
    function insorbitor() external {
    }
    function ensorb() external {
    }
    function introverted() public {
    }
    function swappingFrom() public {
    }
    function swappingTo() public {
    }
    function acquireTo() external {
    }
    function acquireFrom() public {
    }
    function downtown() external {
    }
    function uptown() external {
    }
    function dimsFrom() public {
    }
    function dimsTo() public {
    }    
