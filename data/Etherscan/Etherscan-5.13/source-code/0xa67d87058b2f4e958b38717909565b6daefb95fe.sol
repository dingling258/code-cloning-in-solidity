...
Telegram: https://t.me/ionicpocket
Twitter: https://twitter.com/ionicpocket
Website: https://ionicpocket.org
...
contract IonicPocket is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 120648000 * 10**_decimals;
    string private constant _name   = unicode"Ionic Pocket Token";
    string private constant _symbol = unicode"INP";
    uint256 public constant _taxSwapThreshold = 120648 * 10**_decimals;
    uint256 public constant _maxTaxSwap = 1206480 * 10**_decimals;
    uint256 public _maxTxAmount = 1206480 * 10**_decimals;
    uint256 public _maxWalletSize = 1206480 * 10**_decimals;
