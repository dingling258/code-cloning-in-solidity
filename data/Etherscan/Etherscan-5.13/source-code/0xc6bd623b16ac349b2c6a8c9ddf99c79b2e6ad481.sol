/* 
Pepe's Hexagonal Journey
PEXAG WEB: https://pexagon.vip
PEXAG TG:  https://t.me/Pexagon_PORTAL
PEXAG X:   https://twitter.com/Pexagon_PORTAL
*/
...
contract PEXAGON is Context, IERC20, Ownable
{
    ...
    string private constant _name = unicode"Pexagon";
    string private constant _symbol = unicode"PEXAG";
    uint256 public _maxTxAmount = 4206900000000 * 10 ** _decimals;
    uint256 public _maxWalletSize = 4206900000000 * 10 ** _decimals;
    uint256 public _taxSwapThreshold = 46275900000 * 10 ** _decimals;
