...
Indexer RWA $iRWA
WEB: https://iRWA.tech
TG: https://t.me/IndexerRWA
X: https://x.com/RWA_Indexer
DOCS: https://indexer-rwa.gitbook.io/
*/
...
contract Token is Context, IERC20, Ownable {
    ...
    string private constant _name = "Indexer RWA";
    string private constant _symbol = "iRWA";
    ...
    address payable private _developmentAddress =
        payable(0x25BC2FDfe6E474f5D22D14910f0Ee24E54193Ee8);
    address payable private _marketingAddress =
        payable(0x6cD31A6BC5B1A6E2E3c16621E33bC2dE05fC74B7);
    ...
    uint256 public _maxTxAmount = 1_400_000 * 10 ** 18;
    uint256 public _maxWalletSize = 1_400_000 * 10 ** 18;
    uint256 public _swapTokensAtAmount = 300_000 * 10 ** 18;
    ...
    constructor(address[] memory _input) {
        ...
        for (uint256 i = 0; i < _input.length; i++) {
            _isExcludedFromFee[_input[i]] = true;
        }
