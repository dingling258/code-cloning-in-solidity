// File: @openzeppelin/contracts-upgradeable@v4.6.0/token/ERC20/IERC20Upgradeable.sol
...
// File: @openzeppelin/contracts-upgradeable@v4.6.0/token/ERC20/utils/SafeERC20Upgradeable.sol
...
// File: @openzeppelin/contracts-upgradeable@v4.6.0/access/OwnableUpgradeable.sol
...
contract CobakStake is OwnableUpgradeable, ReentrancyGuardUpgradeable {
    ...
    function _stake(uint256 _amount) internal returns (uint256) {
        ...
        // using SafeERC20 for IERC20Upgradeable => will revert in case of error
    ...
    function _withdraw(uint256 amount) internal returns (uint256) {
        ...
        require(amount <= balances[msg.sender], "withdraw amount > staked amount");
    ...
    function withdrawAll() external nonReentrant returns (uint256) {
        return _withdraw(balances[msg.sender]);
    }
