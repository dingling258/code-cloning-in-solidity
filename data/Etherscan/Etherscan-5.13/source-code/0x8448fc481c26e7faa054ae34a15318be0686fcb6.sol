...
constructor(string memory name_,string memory symbol_,uint256 maxBatchSize_,uint256 collectionSize_) {
  ...
  function transferFrom(address from,address to,uint256 tokenId) public override {
    _transferPassport(from, to, tokenId);
  }
  ...
  function _transferPassport(address from,address to,uint256 tokenId) private {
...
// U.Asset Contract.
pragma solidity 0.7.0;
contract UPassport is ERC721U, Ownable {
    using Counters for Counters.Counter;
    using Strings for uint256;
    uint256 public MAX_SUPPLY = 1000000000; // Max Assets of smart contract.
...
constructor() ERC721U("Unknwon_Passport", "U.Passport", 1000000000, 1) {}
