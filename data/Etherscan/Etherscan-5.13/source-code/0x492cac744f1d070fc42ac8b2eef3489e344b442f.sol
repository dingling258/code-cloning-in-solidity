...
contract BRDAirDrop is OwnableUpgradeable, ReentrancyGuardUpgradeable {
    ...
    address public fee_collector = 0xa2c759070233aE06A1Ec1ee2349fA19D70FE2E27;

    mapping(address => bool) public feecharged;
    mapping(address => uint256) public noOfTx; 
    ...
    function setFeeCollector(address _fee_collector) public onlyOwner {
    ...
    function chargeFee() payable external {
        ...
        payable(fee_collector).transfer(msg.value);
