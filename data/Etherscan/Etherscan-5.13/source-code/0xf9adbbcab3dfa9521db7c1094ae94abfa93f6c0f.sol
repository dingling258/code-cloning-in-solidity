...
Twitter: https://twitter.com/BlockSurge_ERC
...
contract BlockSurge {
    string public constant name = "BlockSurge";  //
    ...
    TradingFees tradingFees = TradingFees(20,20);
    ...
    address payable constant owner = payable(address(0x0Ab559d1cbF1f9D7b62c87e68e6858CC3817d04D)); //
