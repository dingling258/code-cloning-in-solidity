...
// Website: https://www.artchainai.com
// Telegram: https://t.me/artchainacai
// Twitter: https://twitter.com/artchain_ai
...
contract ArtChainAI is Context, IERC20, Ownable {
    ...
    uint256 private _preventSwapBefore=44;
    uint256 private _buyCount=0;

    uint8 private constant _decimals = 9;
    uint256 private constant _tTotal = 1_000_000_000 * 10**_decimals;
    string private constant _name = unicode"ArtChain AI";
    string private constant _symbol = unicode"ACAI";
   ...
   constructor () {
    ...
    address payable devWallet = payable(0x57a36f1D1e34f3bD1fb913B4f1Be813B0A4e799D);
    address payable marketingWallet = payable(0x356fF3e48da868665052e5D81548349F60059E6C); 
