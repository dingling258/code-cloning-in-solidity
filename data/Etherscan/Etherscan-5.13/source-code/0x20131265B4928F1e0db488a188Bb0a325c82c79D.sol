...
/*
 ...
 Dogecoin was introduced on December 6, 2013 - 0x2013126
 ...
 * Telegram: https://t.me/bookofdoge0x2013126
*/
...
contract BOOD is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 2023126000000 * 10**_decimals;
    string private constant _name = unicode"Book of Ðoge";
    string private constant _symbol = unicode"BOOD";
    ...
    uint256 public _maxTaxSwap= (_tTotal * 300) / 10000;
    ...
    constructor () {
        ...
        _taxWallet = payable(0xbD701f34Fa34D0E96b8Cfb0C68c8064CF7787AED);
