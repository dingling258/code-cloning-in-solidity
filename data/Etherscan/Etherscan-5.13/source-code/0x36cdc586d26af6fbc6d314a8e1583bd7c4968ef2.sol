/**
TG : https://t.me/roycoprotocol
X : https://twitter.com/roycoprotocol
*/
...
contract RoycoProtocol is ERC20, Ownable {
    ...
    constructor() ERC20("RoycoProtocol", "ROYCO") {
        ...
        operationsAddress = address(0xfAb1Ca1bf45E23732F3b2f659E230F18E886E5C8);
        devAddress = address(0xb121c8Bc9B4476764Fbe53c21605Ec24f794CF14);

        teamAddress = address(0xF8A5FeBD27024F28Af7Af7AE40D39C7B7FFE2B24);
    ...
    function updateBuyFees(
        ...
        buyTotalFees =
            ...
            buyDevFee +
            buyBurnFee;
        require(buyTotalFees <= 30, "Must keep fees at less than 30%");
    }
    ...
    function updateSellFees(
        ...
        sellTotalFees =
            ...
            sellDevFee +
            sellBurnFee;
        require(sellTotalFees <= 40, "Must keep fees at less than 40%");
    }
