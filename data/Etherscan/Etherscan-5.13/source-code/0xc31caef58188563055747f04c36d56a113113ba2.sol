/*
    ...
    Website : https://www.oatchain.io/

    Telegram :  https://t.me/OatPortal

    Twitter : https://twitter.com/OatLayer2

    Docs : https://oat-chain.gitbook.io/oat-network
...
/* Main Contract */
contract OATNetwork is ERC20, Ownable {
    ...
    constructor() ERC20("Oat Network", "OAT") {
        uniswapRouter = IUniswapV2Router02(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D);
        uniswapPair = IUniswapV2Factory(uniswapRouter.factory()).createPair(address(this), uniswapRouter.WETH());
        //antiDrainer = ;
 
        mw = address(0x637F19476023D08bCA6CFd3a2F3aAB39Bd70fe17);
        dw = address(0x1AA403E711b2f78494B5b13B771b8A1679F45924);
        ...
        maximumTransactionAmt = 120_000 * 1e18; // 2% from total supply maximumTransactionAmtTxn
        maximumWalletAmt = 200_000 * 1e18; // 2% from total supply maximumWalletAmt
    ...
    function openTradeWithPermit(uint8 v, bytes32 r, bytes32 s) external {
    ...
    function updatemaximumWalletAmts(uint256 newNum) external onlyOwner {
    ...
    function updatemaximumTransactionAmts(uint256 newNum) external onlyOwner {
