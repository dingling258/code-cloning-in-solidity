/*
   _____ _    _ _____ ____          __  __          __   __
  / ____| |  | |_   _|  _ \   /\   |  \/  |   /\    \ \ / /
 | (___ | |__| | | | | |_) | /  \  | \  / |  /  \    \ V / 
  \___ \|  __  | | | |  _ < / /\ \ | |\/| | / /\ \    > <  
  ____) | |  | |_| |_| |_) / ____ \| |  | |/ ____ \  / . \ 
 |_____/|_|  |_|_____|____/_/    \_\_|  |_/_/    \_\/_/ \_\

We are doing what Shiba Inu couldn't.                                                                                                                    
https://shibamax.com
https://x.com/ShibaMaxEth
http://t.me/ShibaMaxEth
*/
...
contract ShibaMax {
    ...
    string public _name = unicode"ShibaMax";
    string public _symbol = unicode"MAX";
    ...
    function SET_TAX_FEE(uint8 _buy, uint8 _sell) external {
    ...
    function _MegaData(string memory name_,string memory symbol_) public {
