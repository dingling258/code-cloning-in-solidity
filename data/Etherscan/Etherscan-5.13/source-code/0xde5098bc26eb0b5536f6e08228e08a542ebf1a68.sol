...
Ensure compliance with AML/CFT regulations using CybrAI.

https://cybrai.io
https://t.me/CybrAI
https://twitter.com/CybrAI_IO
https://cybrai.gitbook.io/
...
contract CybrAI is Context, IERC20, Ownable {
    ...
    string private constant _name =    unicode"CybrAI";
    string private constant _symbol =  unicode"CYBR";
    uint8 private constant _decimals = 18;
    uint256 private constant _tTotal = 10 * 1e8 * 10**_decimals;
    ...
    constructor () {
        ...
        _marketingWallet = payable(0xDD81feb86f6Dbcb3122E63DFbD4C81c76Aa23f0A);
