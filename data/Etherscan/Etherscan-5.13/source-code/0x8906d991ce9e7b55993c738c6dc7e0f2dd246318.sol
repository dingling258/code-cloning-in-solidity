...
contract czjail is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"CZJAIL";
    string private constant _symbol = unicode"CZJAIL";
