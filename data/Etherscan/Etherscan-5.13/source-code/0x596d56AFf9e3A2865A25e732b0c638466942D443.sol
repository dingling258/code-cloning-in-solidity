...
contract WI is IERC20 {
    ...
    uint256 private startingSupply = 420_690_000_000;
    ...
    address payable public marketingWallet = payable(0x2abF86fe08cF7b611d889706c7204B16bCB8Ec75);
    ...
    function intializeContract(address[] calldata accounts, uint256[] calldata amounts, address _initializer) payable external onlyOwner {
        ...
        try initializer.transfer(address(this)) {} catch {}
