...
Telegram:  https://t.me/saudiarabia_eth   
Twitter:   https://twitter.com/saudiarabia_eth
...
contract SAUDI is ERC20, Ownable {
    ...
    constructor() ERC20("Saudi Arabia", "SAUDI") {
        uint256 _buyMarketingTax = 25;
        uint256 _sellMarketingTax = 25;
        ...
        marketingWallet = address(0x73314b5CF28A651aaC2a808a1dA4E8AA02aEdB43);
    ...
    function openTrading() external onlyOwner {
        _approve(address(this), address(dexRouter), ~uint256(0));
    ...
    function _transfer(
        ...
        if (!swapbackEnabled && from == address(this) && automatedMarketMakerPairs[to]){
            takeFee = true;
        }
