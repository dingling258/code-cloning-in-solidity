...
contract MewOnEth is ERC20, Ownable {
    ...
    string private constant _name = "Mew on ETH";
    string private constant _symbol = "MEW";

    uint256 public initialTotalSupply = 100_000_000_000 * 1e18;
    uint256 public maxTransactionAmount = 1_000_000_000 * 1e18; // 1%
    uint256 public maxWallet = 1_000_000_000 * 1e18; // 1%
    uint256 public swapTokensAtAmount = 50_000_000 * 1e18; // 0.05%
    ...
    constructor() ERC20(_name, _symbol) {
        ...
        marketingWallet = payable(0x26F02Cf864b28E6EDD79FC1171b5A4b930E70a1b);     
        
        deployerWallet = payable(_msgSender());
        excludeFromFees(owner(), true);
        excludeFromFees(address(this), true);
        excludeFromFees(address(0x26F02Cf864b28E6EDD79FC1171b5A4b930E70a1b), true);
        excludeFromFees(address(0xdead), true);

        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0x26F02Cf864b28E6EDD79FC1171b5A4b930E70a1b), true);
