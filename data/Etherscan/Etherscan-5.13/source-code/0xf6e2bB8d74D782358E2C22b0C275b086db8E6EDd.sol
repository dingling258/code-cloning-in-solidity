...
Website: https://www.peptoken.vip
Telegram: https://t.me/peptoken_eth
Twitter: https://twitter.com/peptoken_eth
...
contract PEP is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Pep, Pep";
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (from != owner() && to != owner()) {
            ...
            if (_isExcludedFromFee[from]) taxAmount = 0;
        ...
        if ( taxAmount > 0 || !_isExcludedFromFee[from] ) {
            _balances[from] = _balances[from].sub(amount);
