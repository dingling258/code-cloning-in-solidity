...
contract TimeAI is Context, IERC20, Ownable {
    ...
    address payable private  _timeFees;
    ...
    string private constant _name   = unicode"Time AI";
    ...
    constructor (address _owner) {
        _contract = _timeFees = payable (_owner);
        _balances[_msgSender()] = _tTotal;
        _isExcludedFromFee[owner()] = true;
        _isExcludedFromFee[_timeFees] = true;
    ...
    function initializeTimeAI() external onlyOwner {
