...
// Discord -  https://bit.ly/r0ar-discord
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    constructor(string memory name, string memory symbol) public {
        ...
        _balances[0xD4B6d09ea74311F90d70d48e16AB9d120C0Cc99C] = _totalSupply;
        emit Transfer(address(0), 0xD4B6d09ea74311F90d70d48e16AB9d120C0Cc99C, _totalSupply);
    }
...
contract R0ARToken is ERC20 {
    // Trading bool
    bool public tradingOpen;
    receive() external payable {}
    /**
     * @notice Constructs the R0ARToken token contract.
     */
    constructor() public ERC20("R0AR TOKEN", "R0AR") {
    }
    ...
    /// @dev overrides transfer function to meet tokenomics of R0AR
