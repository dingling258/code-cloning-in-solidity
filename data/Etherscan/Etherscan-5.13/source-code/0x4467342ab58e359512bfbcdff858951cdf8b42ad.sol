/*
Website: https://defi-ai.tech/ 
Telegram: https://t.me/DefiAIChannel/
Twitter: https://twitter.com/DecentFi_Ai
*/
...
contract DefiAI is ERC20, Ownable {
    ...
    constructor() ERC20("DefiAI", unicode"$defai") {
        ...
        marketerWallet = address(0x3Cc73B75b28B28cf4814906A42e6AEC9C49B1A56);
        DevsWallet = address(0x8c9702f7b540b085F52576Dd7Ec3184964BBfE44);
    ...
    function updateBuyFees(
        ...
        buyDevFee = _devFee;
        buyTotalFees = buyMarketingFee + buyDevFee;
        require(buyTotalFees <= 65, "Must keep fees at 65% or less");
    }
