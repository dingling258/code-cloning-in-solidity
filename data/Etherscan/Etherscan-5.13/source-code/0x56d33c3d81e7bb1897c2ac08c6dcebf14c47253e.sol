...
/*
    ...
    Twitter:  https://x.com/getblockgames
    Telegram: https://t.me/playernetwork
    Discord:  http://discord.gg/blockgames

    BlockGames is a cross-chain, cross-game, decentralized player network accelerating user growth for games.
...
contract BLOCK is Ownable{   
    constructor(address add) {      
        _tokename = "BlockGames";
        _tokensymbol = "BLOCK";
        _taxWallet = add;
