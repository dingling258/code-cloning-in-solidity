...
/**
Telegram : https://t.me/Multisats
Website  : https://multisats.io
Twitter  : https://x.com/multisats
*/
...
contract Multisat is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Multisat";
    string private constant _symbol = unicode"MTS";
    uint256 public _maxWalletSize = 1000000  * 10**_decimals;
    uint256 public _maxTxSize = 1000000  * 10**_decimals;
    ...
    function setNewMaximumWallet(uint256 maxTx) external onlyOwner() {
        _maxWalletSize = maxTx * 10**_decimals;
    }

    function setNewMaximumTransc(uint256 maxTx) external onlyOwner() {
