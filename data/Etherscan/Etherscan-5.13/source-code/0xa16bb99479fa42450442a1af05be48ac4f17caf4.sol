...
abstract contract Project {
    address public marketingWallet = 0x29859391467819Ba111a9F61365D9D47DAE9dD9E;
    address public devWallet = 0x29859391467819Ba111a9F61365D9D47DAE9dD9E;

    string constant _name = "Coast AI";
    string constant _symbol = "COAST";
    uint8 constant _decimals = 18;

    uint256 _totalSupply = 1 * 10**9 * 10**_decimals;

    uint256 public _maxTxAmount = (_totalSupply * 250) / 1000; // (_totalSupply * 10) / 1000 [this equals 1%]
    uint256 public _maxWalletToken = (_totalSupply * 500) / 1000; //
 ...
 * MainContract
 */
contract Coast is Project, IERC20, Ownable {
