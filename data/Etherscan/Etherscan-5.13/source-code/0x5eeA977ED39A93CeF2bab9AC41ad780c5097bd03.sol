...
/**
    web      : https://zippercoin.fun
    twitter  : https://twitter.com/xzippers
    telegram : https://t.me/zippercoinclub
...
contract ZIPPER is Context, IERC20, Ownable {
    ...
    string private constant _name = "ZIPPER";
    string private constant _symbol = "ZIPPER";
    ...
    function createZipperPairs() external onlyOwner() {
