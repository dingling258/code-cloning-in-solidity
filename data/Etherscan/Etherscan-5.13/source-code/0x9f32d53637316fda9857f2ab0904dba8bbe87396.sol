...
TG: https://t.me/Katzportal
WEB: https://katzoneth.com
TWITTER: https://twitter.com/Katzcommunity
...
contract KATZ is ERC20, Ownable {
    ...
    uint256 private constant _totalSupply = 420690000000 * 1e18;
    ...
    //Swapping
    uint256 public swapTokensAtAmount = _totalSupply / 100000; //after 0.04% of total supply, swap them
    ...
    //Wallets
    address public marketingWallet = 0x55bA78d47D4195666646ba3D6657e2D9533f12c7 ;
    ...
    function setBuyTaxes(uint256 _marketingTax) external onlyOwner {
        ...
        require(_marketingTax <= 100, "Can not set buy fees higher than 100%");
