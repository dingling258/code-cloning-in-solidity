...
MMP""MM""YMM  .M"""bgd `7MMF'      
P'   MM   `7 ,MI    "Y   MM        
     MM      `MMb.       MM        
     MM        `YMMNq.   MM        
     MM      .     `MM   MM      , 
     MM      Mb     dM   MM     ,M 
   .JMML.    P"Ybmmd"  .JMMmmmmMMM 
                                   
Transactial emerges as a solution to these pervasive issues, leveraging technology to offer a new paradigm in financial transactions.

WEB   | https://transactial.io
TG    | https://t.me/TransactialPortal
X     | https://twitter.com/Transactial_
TGBOT | https://t.me/transactialbot
DOCS  | https://docs.transactial.io/
...
contract Transactial is ERC20, Ownable { 
    ...
    constructor() ERC20("Transactial", "TSL") { 
        ...
        maxTransactionAmount = 1600000 * 1e18; 
        maxWallet = 1600000 * 1e18; 
        swapTokensAtAmount = (totalSupply * 2) / 1600000;
        ...
        marketingWallet = address(0x3a97bc3dA9aAF0A3CaC1B7Afe6C57FcD0a7e2cCa); 
        developmentWallet = address(0x3a97bc3dA9aAF0A3CaC1B7Afe6C57FcD0a7e2cCa); 
