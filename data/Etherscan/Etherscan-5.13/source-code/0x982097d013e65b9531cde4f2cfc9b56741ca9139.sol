...
contract MasterChef is Ownable, ReentrancyGuard {
    ...
    function initializePools(IERC20 _lptoken1) external onlyOwner {
        add(_lptoken1, 86400*30, 800, true);
        add(_lptoken1, 86400*30*3, 2000, true);
        add(_lptoken1, 86400*30*6, 3500, true);
        add(_lptoken1, 86400*30*9, 4000, true);
        add(_lptoken1, 86400*30*12, 5000, true);        
    }
    ...
    function removeStakeholder(address _stakeholder, uint _pid)
        internal
    {
