...
/**
    web      : https://npooh.vip
    twitter  : https://twitter.com/npooherc
    telegram : https://t.me/npoohclub
*/
...
contract NPOOH is Context, IERC20, Ownable {
    ...
    string private constant _name = "No problem! Pooh";
    string private constant _symbol = "NPOOH";
    ...
    function createNPoohPairs() external onlyOwner() {
