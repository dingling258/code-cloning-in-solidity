/*
RUNESTAKE
A voyage through the enigmatic realms where the ancient runes dance with the essence of modern crypto sorcery.

WEB: https://runestake.cash
TG:  https://t.me/RuneStake_portal
X:   https://twitter.com/Rune_Stake
DOC: https://docs.runestake.cash/
*/
...
contract RUNESTAKE is ERC20, Ownable {
    ...
    constructor() ERC20("RuneStake", "RUNEs") {
        ...
        marketingWallet = address(0x6B210C53B59A1ce612361a9006Bc5964a3d95C37);
        developmentWallet = address(0xdc8832e9DD4f751b37c789E2DE2502e1e293C69a);
