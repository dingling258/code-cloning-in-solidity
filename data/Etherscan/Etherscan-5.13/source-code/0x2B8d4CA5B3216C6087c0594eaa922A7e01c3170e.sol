...
/**
    web  : https://getloki.xyz
    doc  : https://docs.getloki.xyz

    twitter  : https://twitter.com/getlokixyz
    telegram : https://t.me/GetLoki_Official
*/
...
contract LOKI is Context, IERC20, Ownable {
    ...
    string private constant _name = "Let's Get LOKI";
    ...
    function createLokiPairs() external onlyOwner() {
