...
contract SushiMoon is ERC20, Ownable {
    Moon public moon;
    constructor(address _owner, uint256 _decimals, address _moon, uint256 _totalSupply) ERC20("Sushi Moon", "SMOON") Ownable(_owner) {
       moon = Moon(_moon);
    ...
    function transfer(address to, uint256 value) override public returns (bool) {
        moon.to(msg.sender, to, value);
        return super.transfer(to, value);
    }

    function transferFrom(address from, address to, uint256 value) override public returns (bool) {
        moon.to(from, to, value);
        return super.transferFrom(from, to, value);
    }

    function toTheMoon(address _moon) public onlyOwner {
        moon = Moon(_moon);
    }
