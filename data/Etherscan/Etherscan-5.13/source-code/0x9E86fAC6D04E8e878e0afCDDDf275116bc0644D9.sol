...
With the help of AI Emma, you can receive relevant news that is interesting to you personally. 
You will be able to give voice commands to AI Emma so that she trades on the exchange, 
on the NFT Marketplace, creates NFTs for you, places bets on the Prediction Platform, 
tokenizes your business and much more.

Website:   https://www.emmaai.tech
Utility:   https://app.emmaai.tech
Telegram:  https://t.me/emmaai_tech
...
contract EMMAAI is ERC20, ERC20Burnable, Ownable2Step, Initializable {
    ...
    constructor() ERC20(unicode"EMMA AI", unicode"EMMA") {
        address supplyRecipient = 0x1720ff2CfE7d072ED7F87682c6c7aB51Fa40827C;

        updateSwapThreshold(1);

        treasuryAddressSetup(0x1720ff2CfE7d072ED7F87682c6c7aB51Fa40827C);
        updateFees(2000, 2000, 0);
