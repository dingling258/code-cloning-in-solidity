...
contract RuneNode is ERC20, Ownable {
    ...
    constructor() ERC20("RuneNode", "RN", 18) {
        ...
        maxTransaction = (totalSupply * 200) / 10_000; 
        maxWallet = (totalSupply * 200) / 10_000; 
        ...
        teamWallet = 0xF420Eb1fC130Ab5A62bb45EEF92BB8071FE3E315;
        marketingWallet = 0xC6F4E0f088030001bDC04C69867f14e31F5B61AA;
