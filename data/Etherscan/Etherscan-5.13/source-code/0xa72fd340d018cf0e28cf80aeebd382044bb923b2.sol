...
contract POPCORN is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "Popcorn Assets AI";
    string private constant _symbol = "POPCORN";
    ...
    function activateTrading(bool _tradingOpen) public onlyOwner {
    ...
    function lowerFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyOwner {
