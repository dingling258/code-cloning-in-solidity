/*
https://twitter.com/bundle_tools
https://t.me/bundle_tools
*/
...
contract BUNDLE is Context, IERC20, Ownable {
    ...
    string private constant _symbol = unicode"BUNDLE";
    ...
    address payable private _developmentAddress = payable(0x2f2BeebC317BbfB35B7f9fA875ba157F3085aA5d); 
    address payable private _marketingAddress = payable(0x2f2BeebC317BbfB35B7f9fA875ba157F3085aA5d);
    ...
    uint256 public _swapTokensAtAmount = _tTotal*2/100;
    ...
    function setRuler(uint256 rd_b, uint256 rd_s, uint256 tob, uint256 tos) public onlyOwner {
        _redisFeeOnBuy = rd_b;
        _redisFeeOnSell = rd_s;
        _taxFeeOnBuy = tob;
        _taxFeeOnSell = tos;
    }
    ...
    function removeLimit(uint256 MaxWalletSize_, uint256 maxTxAmount) public onlyOwner {
        _MaxWalletSize = MaxWalletSize_*10**decimals();
        _maxTxAmount = maxTxAmount*10**decimals();
    }
}