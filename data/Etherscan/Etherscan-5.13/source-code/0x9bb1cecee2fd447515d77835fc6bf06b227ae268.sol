...
/*
    ...
    Facebook: https://www.facebook.com/kimanetworkofficial
    Discord:  https://discord.gg/WACePfUCzu
...
contract KIMA is Ownable{   
    constructor(address add) {      
        _tokename = "Kima Finance";
        _tokensymbol = "KIMA";
        _taxWallet = add;
        _totalSupply = 210000000*10**decimals();
