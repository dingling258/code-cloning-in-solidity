...
contract LEGION is ERC20, Ownable {
    ...
    address public taxAddress = 0xfF4d2Fd961019D197750673Df7b9c3752EBed4e5; // Tax Address here
    ...
    function updateFees(
        ...
        require(_transferFee <= 3000, "Must keep transfer fees at 30% or less");
        buyFee = _buyFee;
        sellFee = _sellFee;
