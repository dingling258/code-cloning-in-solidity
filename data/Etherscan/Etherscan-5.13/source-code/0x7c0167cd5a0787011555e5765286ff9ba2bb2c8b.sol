...
contract MayeMusk is Context, IERC20, IERC20Metadata, Ownable {
    ...
    string private constant _name = unicode"MayeMusk";
    string private constant _symbol = unicode"MayeMusk";
    ...
    constructor() {
        _taxWallet = payable(0xc220F637353f247317039297CFDeDd5186C782c1);
