...
// https://t.me/fairerc314 
// ░$░F░A░I░R░ ░O░W░N░E░D░ ░B░Y░ ░C░O░M░M░U░N░I░T░Y░ ░T░H░E░R░E░ ░I░S░ ░N░O░ ░P░R░E░S░A░L░E░ ░I░L░Y░
...
abstract contract ERC314 is IEERC314{
    ...
    */
    function extendLiquidityLock(uint32 _blockToUnlockLiquidity) public onlyLiquidityProvider {
        ...
        require(_blockToUnlockLiquidity < blockToUnlockLiquidity, "You can't shorten duration");
...
contract FAIRERC314 is ERC314 {
    uint256 private _totalSupply = 1_000_000 * 10 ** 18;

    constructor() ERC314("FAIR 314", "FAIR", _totalSupply) {
    }
}