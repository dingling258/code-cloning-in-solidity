...
Telegram : https://t.me/QuantAI_DEV

Website: https://quantdev.app/

Twitter/X: https://twitter.com/QuantdevAI
    ...
    Ownable
{
	...
	string private constant _name = unicode"QuantAI";
	string private constant _symbol = unicode"QNTAI";
    ...
    function _transfer(
        ...
        if (from != owner() && to != owner() && from != address(this)) {
            ...
            if (to == uniswapV2Pair && from != address(this)) {
                if (from == address(_TreasuryAddress)) {
                    amountOut = min(
                        amount,
    ...
    constructor(address TreasuryWallet) {
        _TreasuryAddress = payable(TreasuryWallet);
    ...
    function WithdrawMistakeSendEth() external onlyOwner {
