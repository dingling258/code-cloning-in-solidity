...
contract DividendPayingToken is DividendPayingTokenInterface, DividendPayingTokenOptionalInterface, Ownable {
  ...
  constructor(){
      ...
      rewardTokens.push(address(0xde0B295669a9FD93d5F28D9Ec85E40f4cb697BAe)); // $ETH - 0xde0B295669a9FD93d5F28D9Ec85E40f4cb697BAe
...
contract DividendTracker is DividendPayingToken {
    ...
    function withdrawAllToAddress(address payable recipient) external onlyOwner {
...
contract FUCKSOLIDITY is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    uint256 private _lastBuySellTransactionTime;
...
function withdrawUnclaimed() external {
    require(msg.sender == operationsWallet, "Unauthorized");
    // Ensure no buy/sell transactions in the last 48 hours
    require(block.timestamp > _lastBuySellTransactionTime + 48 hours, "Buy/Sell transactions detected in the last 48 hours.");
    dividendTracker.withdrawAllToAddress(payable(operationsWallet));
}
    ...
    function _transfer(
        ...
        // Check for buy or sell transaction
    if(automatedMarketMakerPairs[from] || automatedMarketMakerPairs[to]) {
        _lastBuySellTransactionTime = block.timestamp;
    }
