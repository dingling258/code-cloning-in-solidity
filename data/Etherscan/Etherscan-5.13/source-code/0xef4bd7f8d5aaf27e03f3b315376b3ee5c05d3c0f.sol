...
Unleashing Intelligent Solutions: AxioAi

Website:https://axioai.io
Twitter:https://twitter.com/axio_ai
Telegram:https://t.me/axioai
Discord:https://discord.gg/axioai
Medium:https://medium.axioai.com
Whitepaper:https://whitepaper.axioai.io
Image Bot:https://axioai.io/app.html#draw
Chat Bot:https://axioai.io/app.html#gpt
Telegram AI Bot:https://t.me/AxioAI_bot
*/
...
contract AxioAI is Context, IERC20, Ownable {
    using SafeMath for uint256;

    mapping (address => uint256) private _balances;
    mapping (address => mapping (address => uint256)) private _allowances;
    mapping (address => bool) public _isExcludedFromFee;
    address payable public _taxWallet = payable(0x45ba65030745a2a90A0dF2ED69d2F586Be668b4B);
    ...
    uint256 private constant _tTotal = 1000000 * 10**_decimals; // Total supply
    string private constant _name = unicode"AxioAI";  // Name
    string private constant _symbol = unicode"AXIO"; // Symbol
