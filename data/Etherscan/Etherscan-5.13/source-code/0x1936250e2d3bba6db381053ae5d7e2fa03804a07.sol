...
contract ELN62 is Context, ERC20, Ownable {
    ...
    constructor() ERC20("eln 62", "ELN62") {
        uint256 _totalSupply = 62_000_0000 * 10 ** 18;

        _txAmountLimit = (_totalSupply * 30) / 1000;
        _walletAmountLimit = (_totalSupply * 30) / 1000;
