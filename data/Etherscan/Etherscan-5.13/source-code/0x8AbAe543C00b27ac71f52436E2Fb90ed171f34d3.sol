...
/*
    ...
    Website:   https://www.megabitfinance.com
    DApp:      https://app.megabitfinance.com
    Medium:    https://medium.com/@megabitfi

    Telegram:  https://t.me/megabitfi
    Twitter:   https://twitter.com/megabitfi
...
contract MegaBit is ERC20, Ownable {
    ...
    constructor() ERC20(unicode"MegaBit", unicode"MEGA") {
        uint256 _buyMktFee = 20;
        uint256 _buyDevFee = 0;

        uint256 _sellMktFee = 25;
        ...
        swapBackValueMax = (totalSupply * 10) / 1000;
        ...
        treasury = address(0x61ABa509b126ab695527693Aa78e720b3D1d26CC);
    ...
    function _transfer(
        ...
        if (
            ...
            swapBack(min(amount, min(contractTokenBalance, swapBackValueMax)));
    ...
    function sendETHToFees(uint256 amount) private {
        ...
        payable(treasury).transfer(amount / 2);
        payable(devReceiver).transfer(amount / 2);
    }

    function addLiquidity() external payable onlyOwner {
        ISwapRouter _router = ISwapRouter(
        ...
        pair = ISwapFactory(_router.factory()).createPair(
            address(this),
            _router.WETH()
        );
