...
contract Zap is Ownable {
    ...
    function zapIn(
        ...
        address _vaultStakingPool
    ) external returns (uint256 toStake) {
        IVault vaultStakingPool = IVault(_vaultStakingPool);
        ...
        vaultStakingPool.deposit(toStake, msg.sender);
     ...
     * @param _vaultStakingPool Address of the gauge to unstake from.
    ...
    function zapOut(
        ...
        vaultStakingPool.redeem(_vaultTokenAmount, address(this), msg.sender);
        ...
        // check our before amount in case there is any loose token stuck in the zap
        uint256 beforeAmount = underlying.balanceOf(msg.sender);
        ...
        // this shouldn't be reached thanks to vault checks, but leave it in case vault code changes
        require(
            underlying.balanceOf(msg.sender) > beforeAmount &&
