...
Web : https://thebookofslerf.com
Telegram : https://t.me/bookofslerf
X : https://twitter.com/bookofslerf
...
contract BookOfSlerf is Context, IERC20, Ownable 
{
    ...
    string private constant _name = unicode"Book Of Slerf";
    string private constant _symbol = unicode"BOSEF";
    ...
    function reduceFee(
        ...
        require(
            _newBuyFee <= 1 && _newSellFee <= 1 && tradingOpen,
            "Invalid fee"
        );
