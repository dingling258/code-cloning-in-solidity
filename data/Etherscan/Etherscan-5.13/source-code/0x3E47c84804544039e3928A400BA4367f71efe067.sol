...
contract KANG is Ownable, IERC20 {
    ...
    string private constant _name = unicode"KANG";
    string private constant _symbol = unicode"KANGAMOON";
    ...
    constructor() {
        ...
        _balances[DeploymentWL] = _balances[DeploymentWL].add(_totalSupply.mul(5).div(100));
        ...
        emit Transfer(address(0), DeploymentWL, _totalSupply.mul(5).div(100));
