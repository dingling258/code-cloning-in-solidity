...
// Land Wolf's Alter Ego On Ethereum

/*
    TG: https://t.me/IceLandEth
    Web: https://icelandwolf.xyz
    Twitter: https://twitter.com/icelandwolf
*/
...
contract ICE is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Ice Land";
    string private constant _symbol = unicode"ICE";
   ...
   constructor () {
    ...
    address payable devWallet = payable(0xABEd5A11Ab992C2512927beA6810F51fDD3a4475);
    address payable marketingWallet = payable(0xa0aFE2e55Ba39EC16c57714B180A726460d42741); 
