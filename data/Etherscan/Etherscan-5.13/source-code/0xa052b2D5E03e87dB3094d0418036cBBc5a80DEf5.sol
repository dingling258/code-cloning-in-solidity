...
// File: contracts/GardenComponents.sol
...
contract GardenComponents is ERC721URIStorage, Ownable, ERC721Royalty {

    uint256 private _nextTokenId = 1;

    constructor(address initialOwner) ERC721("GardenComponents", "GDNS") Ownable(initialOwner) {
    ...
    function safeMint(address to, string memory uri) public onlyOwner {
        ...
        string memory jsonFile = string(abi.encodePacked(uri, 'metadata', Strings.toString(tokenId), '.json'));
