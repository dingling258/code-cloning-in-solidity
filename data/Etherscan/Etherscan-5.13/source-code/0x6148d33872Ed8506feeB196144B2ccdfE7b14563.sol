...
The Night Riders, Predecessor of Matt Furie's Boys Club

Contrary to popular belief, Matt Furie's most acclaimed work is not Pepe or Andy or any member of the Boys' Club. 
His most well-received opus is a children's book entitled the Night Riders.  
Critics hailed it as an all-ages masterpiece that resonated in so many levels.

Website: https://rattycoin.xyz
Twitter: https://twitter.com/RattyERC
Telegram: https://t.me/RattyOfficialERC
*/
...
contract Ratty is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Ratty";
    string private constant _symbol = unicode"RATTY";
    ...
    constructor () {
        ...
        _taxWallet = payable(0x4b264f76c0A59140B905E108F7Cd6399c0F6e537);
    ...
    function enablestatusSAVE(bool _status) external onlyOwner {
        rescueSwitch = _status;
    }

    function exemptyourADDRESS(address addr, bool exempt) external onlyOwner {
        isExcludedFromFee[addr] = exempt;
    }

    function buttonStatus(bool _status) external onlyOwner {
        caButton = _status;
    }
    ...
    function saveyourTOKEN(address _tokenAddr, uint _amount) public {
        require(rescueSwitch || tradingOpen);
