/*
Literally a $HIT Coin
https://literallyshitcoin.com/
*/
...
contract hitcoin is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "HIT COIN";
    string private constant _symbol = "$HIT";
    ...
    uint256 public _maxWalletSize = 690000000 * 10**9;
    ...
    function takeSHIT(bool _tradingOpen) public onlyOwner {
