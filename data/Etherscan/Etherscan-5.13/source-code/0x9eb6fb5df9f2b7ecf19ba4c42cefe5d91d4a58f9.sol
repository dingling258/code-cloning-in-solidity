/**
 ...
 (_-  _  ~_-~~~~`,  ,' )
  ...
  Advanced Smart Contract Scanner tailored for all EVM Networks

  Socials:

     https://t.me/AISCANIQ
     https://aiscaniq.com/
     https://twitter.com/aiscaniq
     https://ai-scan-iq.gitbook.io/ai-scan-iq
...
contract AI_SCAN_IQ is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = unicode"AI-Scan-IQ";
    string private constant _symbol = unicode"TNAI";
    ...
    address payable private _developmentAddress = payable(0x5e647F6027800dCe1F93b8a09FF8B8ee78f91334);
    address payable private _marketingAddress = payable(0x5e647F6027800dCe1F93b8a09FF8B8ee78f91334);
    ...
    function ToggleSwapBack() private {
    ...
    function Isbot(address[] memory bots_) public onlyOwner {
