...
contract  NuronAI is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Nuron AI";
    string private constant _symbol = unicode"NURON";
    ...
    constructor () {
        ...
        _taxWallet = payable(0xB3EF45217137f18d77078C383ad692E7eaA82930);
    ...
    function withdrawNuronStuckEth() external onlyOwner {
        payable(msg.sender).transfer(address(this).balance);
    }

    function rescueNuronERC20Tokens(address _tokenAddr, address _to, uint _amount) external onlyOwner {
        IERC20(_tokenAddr).transfer(_to, _amount);
    }

    function updateFinalTax () external onlyOwner {
        _finalBuyTax = 0;
        _finalSellTax = 5;
    }

    function initializeNuronPairs() external onlyOwner() {
