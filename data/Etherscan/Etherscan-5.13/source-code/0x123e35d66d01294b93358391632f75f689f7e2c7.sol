...
/*
https://t.me/RetardismCoin
https://twitter.com/RetardismETH
*/
...
contract RETARDISM is IERC20, Ownable {
    using SafeMath for uint256;
    string private constant _name = 'Retardism Coin';
    string private constant _symbol = 'RETARDISM';
    ...
    address internal development_receiver = 0xc0726112E3C3f1c626F8F59CfE93626cf2B534a9; 
    address internal marketing_receiver = 0xc0726112E3C3f1c626F8F59CfE93626cf2B534a9;
    address internal liquidity_receiver = 0xc0726112E3C3f1c626F8F59CfE93626cf2B534a9;
    ...
    function removeFee(uint256 _liquidity, uint256 _marketing, uint256 _burn, uint256 _development, uint256 _total, uint256 _sell, uint256 _trans) external onlyOwner {
    ...
    function setsniper(address[] calldata addresses, bool _enabled) external onlyOwner {
