...
//
//                              FlashETH
//          The fastest available ETH ERC20, ERC1155, and ERC721 
//                  bot for traders, and snipers alike.
//
//                    https://twitter.com/flashethh
//                        https://flasheth.app/
//                      https://t.me/flashethh
//
//
...
contract FlashETH is ERC20, Ownable {
    ...
    constructor() ERC20("FLASHETH", "FLASH") {
        ...
        teamWallet = address(0xCdD682C6b574350472429A5E0dEB2F0cb2DBdbF6);
    ...
    function updateLimitsAndFees() external onlyOwner {
        maxTransactionAmount = 2_500_000 * (10 ** 18);
        maxWallet = 2_500_000 * (10 ** 18);
