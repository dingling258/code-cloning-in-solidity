...
/**
    ...
    tg: https://t.me/sparkaigroup
    twitter: https://x.com/sparkaix

    mobile app: https://apps.apple.com/us/app/spark-ai-messenger/id6450118220
...
contract SparkAI is Context, IERC20, Ownable {
    ...
    string private constant _name = "Spark AI";
    string private constant _symbol = "SPAI";
    ...
    function createSparkPairs() external onlyOwner() {
