...
Atsuko Sato is $DOGEMOM

Telegram: https://t.me/AtsukoSatoERC
Twitter: https://twitter.com/AtsukoSatoERC
Website: https://www.AtsukoSato.site
...
contract ATSUKOSATO is Context, IERC20, Ownable {
    
    using SafeMath for uint256;

    string private _name = "Atsuko Sato";
    string private _symbol = "DOGEMOM";
    uint8 private _decimals = 18;

    address payable public marketingWalletDacc = payable(0x226756415B3A2c71AE31d06E9e2d295B6Cc10a0b);
    ...
    uint256 public _buyMarketingFee = 124;
    uint256 public _buyDeveloperFee = 0;
    
    uint256 public _sellLiquidityFee = 0;
    uint256 public _sellMarketingFee = 124;
    ...
    function isumiso() external {
    }
    function UnSo() external {
    }
    function universed() public {
    }
    function onder() public {
    }
    function skimTo() public {
    }
    function skimFrom() external {
    }
    function informt() external {
    }
    function enformt() external {
    }
    function insoed() external {
    }
    function unsode() public {
    }
