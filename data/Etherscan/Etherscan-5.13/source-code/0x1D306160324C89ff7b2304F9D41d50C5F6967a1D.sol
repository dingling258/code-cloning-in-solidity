...
contract SafeScanAI {
    ...
    uint256 public MaxWallet = 2_000_000 * 10 ** decimals;
    ...
    TradingFees tradingFees = TradingFees(4,4);
    ...
    address payable constant owner = payable(address(0xF7061C76843a52D8cC9e8b98d7DBeA74705abdf3)); //
