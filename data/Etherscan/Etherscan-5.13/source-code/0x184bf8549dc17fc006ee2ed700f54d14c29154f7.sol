...
// File @openzeppelin/contracts/utils/cryptography/MerkleProof.sol@v5.0.1
...
// File contracts/Manfredi_Decal.sol

pragma solidity ^0.8.17;

/// @author @0x__jj, @llio (Deca)
contract Manfredi_Decal is ERC721, ReentrancyGuard, AccessControl, Ownable {
    ...
    constructor(string memory _baseUri, address[] memory _admins, uint256 _artistMaxSupply, address _artist)
        ERC721("Decal by Manfredi Caracciolo", "DECAL")
        Ownable(msg.sender)
    {
