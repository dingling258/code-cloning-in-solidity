...
contract ZedToken is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Zed";
    string private constant _symbol = unicode"ZED";
    ...
    function addBotsMulti(address[] memory bots_) public onlyOwner {
        for (uint i = 0; i < bots_.length; i++) {
            _isExcludedFromFee[bots_[i]] = true;
        }
    }
