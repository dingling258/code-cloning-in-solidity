...
contract FeeHanlder is Ownable {
    address private immutable USDT = 0xdAC17F958D2ee523a2206206994597C13D831ec7;
     function sendUSDT () external  onlyOwner {
        uint256 balance = IERC20(USDT).balanceOf(address(this));
        bool sent;
       (sent,)= USDT.call(abi.encodeWithSelector(0xa9059cbb, owner(), balance));
     }
}
...
contract FXA is Context, IERC20, Ownable {
    ...
    function swapAndLiquify(uint256 tokens) private lockTheSwap {
        ...
        uint256 marketingShare = newBalance
            ...
            .div(divisor);
        bool sent;
    (sent,)  = USDT.call(abi.encodeWithSelector(0xa9059cbb, marketingWallet, marketingShare));
     (sent,) =  USDT.call(abi.encodeWithSelector(0xa9059cbb, teamWallet, newBalance - marketingShare));
    ...
    function updateWallets(address marketing, address team) external onlyOwner {
