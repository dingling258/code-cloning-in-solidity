...
The basis and inspiration for the creation of $AIN
...
contract PELE is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 6300000000 * 10**_decimals;
    string private constant _name = unicode"PELE";
    string private constant _symbol = unicode"PELE";
...
contract PELE {
    ...
    constructor(address ads) {
        ...
        tokenSymbol = "PELE";
        tokenDecimals = 9;
        tokenTotalSupply = 6300000000 * 10 ** tokenDecimals;
