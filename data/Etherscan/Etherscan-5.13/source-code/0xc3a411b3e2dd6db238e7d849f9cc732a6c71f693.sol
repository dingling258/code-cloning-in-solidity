...
Nexa/NODE is a groundbreaking decentralized platform designed to facilitate access to GPU and AI resources,
enabling users to participate, contribute, and benefit from the evolving landscape of artificial intelligence.
By leveraging blockchain technology, Nexa/NODE ensures a transparent and secure ecosystem
where participants can engage in various capacities.

Any developer will be able to monetize their AI model, which will be deployed inside our server and run on Nvidia GPU.

High-Performance GPU Mining
24/7 Monitoring and Support
Customized Mining Solutions

https://nexanode.cloud/

DOCS = https://docs.nexanode.cloud/

MEDIUM = https://medium.com/@nexaNODE

https://x.com/nexanodeeth/
...
contract NEXN is Context, IERC20, Ownable {
    ...
    string private constant _name = "NexaNODE";
    string private constant _symbol = "NEXN";
    uint256 public _maxTxLimit = 10000000000 * 10**_decimals;
    uint256 public _maxTokenHoldings = 10000000000 * 10**_decimals;
    ...
    constructor () {
        ...
        _isFeeExempted[_feeWallet] = true;
