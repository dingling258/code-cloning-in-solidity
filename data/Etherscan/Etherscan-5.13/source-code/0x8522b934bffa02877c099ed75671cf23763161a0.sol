...
// File: @openzeppelin/contracts@5.0.0/utils/cryptography/MerkleProof.sol
...
contract SwissCheeseNFT is ERC721A, ReentrancyGuard, Ownable {
    ...
    /// MAX MINT PER WALLET
    uint256 public MAX_MINT_PER_WALLET = 20;
    /// PAYMENNT WALLET
    ...
    constructor() ERC721A("SwissCheese", "SWCH") Ownable(msg.sender) {
        ...
        paymentWallet = 0xc5Aa2C20E452C8af3927836195d073814475679B;
    }
