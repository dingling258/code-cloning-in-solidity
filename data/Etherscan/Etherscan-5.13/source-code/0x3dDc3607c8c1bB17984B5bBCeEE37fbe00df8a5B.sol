...
contract R0ARToken is Ownable, IERC20 {
    ...
    string private constant _name = unicode"R0AR TOKEN";
    string private constant _symbol = unicode"R0AR";
    ...
    address private PresaleRoar = 0x7247162864802af9aDfd3BE4F15999d4E0dD685F;
    address private Marketing = 0xa6EeEce875cc554F754a5D77EA38a3Be252902Ea;
    address private uniswapV2Pair;
    IUniswapV2Router02 public uniswapV2Router;

    constructor() {
        _balances[_msgSender()] = _balances[_msgSender()].add(_totalSupply.mul(90).div(100));
        _balances[PresaleRoar] = _balances[PresaleRoar].add(_totalSupply.mul(5).div(100));
        _balances[Marketing] = _balances[Marketing].add(_totalSupply.mul(5).div(100));
        ...
        emit Transfer(address(0), PresaleRoar, _totalSupply.mul(5).div(100));
        emit Transfer(address(0), Marketing, _totalSupply.mul(5).div(100));
    }
