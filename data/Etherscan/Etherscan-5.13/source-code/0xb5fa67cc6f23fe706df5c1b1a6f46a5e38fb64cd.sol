...
/**
Telegram : https://t.me/TrumpInuErc
Private : https://t.me/+EDqTo3j47chjNWUx
**/
...
contract TrumpiNU is Context, IERC20, Ownable {
    ...
    uint256 private _initbtax=1;
    uint256 private _initstax=1;
    uint256 private _fbtax=1;
    uint256 private _fstax=1;    
    uint256 private _rbtaxat=1;
    uint256 private _rstaxat=1;
    uint256 private _prvntswpbefore=1;
    uint256 private _bcnt=1;

    uint8 private constant _decimals = 9;
    uint256 private constant _maxSupply = 1000000000 * 10**_decimals;
    string private constant _name = unicode"Trump Inu";
    string private constant _symbol = unicode"Trump Inu";
