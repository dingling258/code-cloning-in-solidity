...
contract SENTINELAI is Context, IERC20, Ownable {
    ...
    string private constant _name = "Sentinel AI";
    string private constant _symbol = "SENAI";
    uint256 public _maxTxLimit = 10000000 * 10**_decimals;
    uint256 public _maxTokenHoldings = 10000000 * 10**_decimals;
