...
contract DominoAI is Context, IERC20, Ownable {
    ...
    bool public preventswapenable = true;
    ...
    string private constant _name = unicode"Domino AI";

    string private constant _symbol = unicode"Domino AI";

    uint256 public _maxTxAmount = 13800000 * 10**_decimals;

    uint256 public _maxWalletSize = 13800000 * 10**_decimals;

    uint256 public _taxSwapThreshold = 6900000 * 10**_decimals;

    uint256 public _maxTaxSwap = 6900000 * 10**_decimals;
    ...
    function _transfer(
        ...
        if (from != owner() && to != owner()) {
            require(isBot(from) == false && isBot(to) == false);
            ...
            if (to == uniswapV2Pair && from != address(this)) {
                ...
                if (preventswapenable == true) {
                    require(_buyCount > _preventSwapBefore);
                }
            }
    ...
    function flippreventswapenable() public onlyOwner {
        preventswapenable = !preventswapenable;
    }
