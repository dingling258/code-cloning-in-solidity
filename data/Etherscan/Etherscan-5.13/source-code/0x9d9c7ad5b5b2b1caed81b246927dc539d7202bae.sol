...
Website: https://pecaeth.fun/
Telegram: https://t.me/pecachuportal
Twitter: https://twitter.com/pecachucoin
...
contract PECACHU is ERC20, Ownable {
    ...
    constructor() ERC20("PECACHU", "PECA") {
    ...
    function launchPECA() external onlyOwner {
        tradingActive = true;
        swapEnabled = true;
    ...
    function updateMaxTxnAmounts(uint256 txNum, uint256 walNum) external onlyOwner {
