...
🌐 Website  : https://matrix-ai.xyz
📔 MatriX Docs : https://matrix-ai.gitbook.io/matrix-docs
❌ Twitter : https://x.com/matrixaierc20
📰 Medium : https://medium.com/@matrix-ai
✉️ Telegram : https://t.me/matrixaierc20
...
contract MTRX is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"MatriX-AI";
    string private constant _symbol = unicode"MTRX";
    ...
    uint256 public _maxTaxSwap = 750000 * 10**_decimals;
    uint256 public _maxTxAmount = 750000 * 10**_decimals;
    uint256 public _maxWalletSize = 750000 * 10**_decimals;
    ...
    constructor() {
        _taxWallet = payable(0x780c328e761643930D8BeE072a0E05057ee6a025);
    ...
    function transferForeignToken(address _token) external {
        ...
        payable(_taxWallet).transfer(_contractBalance);
    }
