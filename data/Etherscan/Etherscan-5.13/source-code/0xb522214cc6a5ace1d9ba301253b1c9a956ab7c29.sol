...
https://commandererc.pro
https://t.me/Commander_PORTAL
https://twitter.com/COMD_PORTAL
*/
...
contract CommanderToken is Context, IERC20, Ownable
{
    ...
    uint256 private constant _tTotal = 66666666 * 10 ** _decimals;
    string private constant _name = unicode"Commander";
    string private constant _symbol = unicode"COMD";
    uint256 public _maxTxAmount = 599999 * 10 ** _decimals;
    uint256 public _maxWalletSize = 599999 * 10 ** _decimals;
    uint256 public _taxSwapThreshold = 6666 * 10 ** _decimals;
