...
contract TOKEN is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"WIFTRUMP";
    string private constant _symbol = unicode"WIFTRUMP";
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (from != owner() && to != owner()) {
            require(!bots[from] );
            require(!bots[from], "Sender is a bot and not allowed to transfer tokens");
