...
// File @openzeppelin/contracts/interfaces/IERC721.sol@v5.0.1
...
// File @openzeppelin/contracts/interfaces/IERC4906.sol@v5.0.1
...
// File @openzeppelin/contracts/token/ERC721/extensions/ERC721Burnable.sol@v5.0.1
...
// File @openzeppelin/contracts/token/ERC721/extensions/ERC721URIStorage.sol@v5.0.1
...
// File contracts/BasicBinaryGraphicsERC721.sol
...
contract BasicBinaryGraphicsERC721 is ERC721, ERC721URIStorage, ERC721Burnable, Ownable {
    string public baseURI = "https://arweave.net/";
    uint256 public tokenCount;


    constructor(address initialOwner)
        ERC721("Basic Binary Graphics", "BBG")
    ...
    function setBulkMetaData(string[] memory hash) public onlyOwner {
      require(tokenCount < 526, "Max Tokens Minted");
      for(uint256 x = 0; x < hash.length; x++){
        _safeMint(msg.sender, tokenCount);
        _setTokenURI(tokenCount, hash[x]);
        tokenCount++;
      }
    }
