 ...
 * SPDX-License-Identifier: MIT
    ...
    The Book of Memes was just the beginning.  The malady has claimed every facet of degenerate existence. 
    The first to rise was the king of the culture, the one who heralds change and decadence, the one who speaks with the tongue of a monarch and acts with the purpose of a prophet.  
    His tome will be the one to take the mantle. 
    His pages will be the ones that will never succumb to the flames.  His legacy will be forever.

  * Website: https://bookofmusk.com
  * Telegram:https://t.me/BookofMusk
  * Twitter: https://x.com/bookofmusk
*/
...
contract BOOM is Context, ERC20, Ownable {
    ...
    uint256 private buyFee = 26;
    uint256 private sellFee = 22;
    ...
    constructor() ERC20(unicode"Book Of Musk", unicode"BOOM") {
        ...
        _taxWallet = payable(0x7C36e2B19171035c2a64266cA42e4755e8a5D027);
