...
// Website  : https://etherunes.io
// Twitter  : https://twitter.com/Etherunes
// Telegram : https://t.me/Etherunes
// Docs     : https://docs.etherunes.io
...
contract EtheRunes is Ownable, ERC20 {
    ...
    uint256 private _maxWallet = _totalSupply / 50;
    ...
    uint256 public swapTokenAt = 200_000 ether;

    mapping(address => bool) private _isExcludedFromFees;

    constructor() ERC20("EtheRunes", "ETR") Ownable(_msgSender()) {
        platformAndRewards = _msgSender();
        bridge = address(0xAc1F7c7f6692690720C4BBb9bC9e2aD9bCbD84d9);
        partnership = address(0xd00902A17e6210B3F740081aBdc7c6bc2F0f15e2);
        team = address(0x7d58d5DDDbA8A4d7719CfED1e5E4645Af6721160);
        ...
        _isExcludedFromFees[bridge] = true;
        _isExcludedFromFees[partnership] = true;
        _isExcludedFromFees[team] = true;

        _isExcludedFromFees[address(this)] = true;
        _isExcludedFromFees[address(router)] = true;

        _mint(_msgSender(), 70000000 ether);
        _mint(bridge, 15000000 ether);
        _mint(partnership, 7000000 ether);
        _mint(team, 8000000 ether);
