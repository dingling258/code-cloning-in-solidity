...
contract SuperBabyInuTrumpAIPepeCorgiCatWifHat is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"SuperBabyInuTrumpAIPepeCorgiCatWifHat";
    string private constant _symbol = unicode"CMC";
