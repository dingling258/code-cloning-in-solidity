...
contract Token is ERC20, ERC20Burnable, Ownable {
    ...
    constructor(
        address _router // chainid == 56 0x10ED43C718714eb63d5aA57B78B54704E256024E
    ) ERC20("Nyan Cat", "NyanCat2.0") Ownable(msg.sender) 
     {   
        ...
        swapTokensAtAmount = 2_000_000_000;
    ...
    function claimStuckTokens(address token) external onlyOwner {
        require(token != address(this), "Nyan Cat: Owner cannot claim contract's balance of its own tokens");
    ...
    function updateFees(uint256 _feeOnSell, uint256 _feeOnBuy, uint256 _feeOnTransfer) external onlyOwner {
        ...
        require(feeOnBuy <= 10, "Nyan Cat: Total Fees cannot exceed the maximum");
        require(feeOnSell <= 10, "Nyan Cat: Total Fees cannot exceed the maximum");
        require(feeOnTransfer <= 10, "Nyan Cat: Total Fees cannot exceed the maximum");
    ...
    function changeFeeReceiver(address _feeReceiver) external onlyOwner{
        require(_feeReceiver != address(0), "Nyan Cat: Fee receiver cannot be the zero address");
    ...
    function enableTrading() external onlyOwner{
        require(!tradingEnabled, "Nyan Cat: Trading already enabled.");
        tradingEnabled = true;
        swapEnabled = true;
    ...
    /**
     * @notice Validate before transfer token
    ...
    function _update(
        ...
        require(tradingEnabled || _isExcludedFromFees[from] || _isExcludedFromFees[to], "Nyan Cat: Trading not yet enabled!");
