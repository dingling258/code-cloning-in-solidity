...
// Built with Token Generator ©
// Create and Deploy your ERC20 Token on SmartContracts Tools https://www.smartcontracts.tools
...
// File contracts/utils/Credits.sol
 ...
 * @dev Utility contract that adds a "generator" method in Smart Contract's ABIs returning credits information.
 */
abstract contract Credits {
    /**
     * @dev Returns the generator tool used to create this contract.
     * @notice The source code for this contract has been generated using Token Generator © on SmartContracts Tools.
     */
...
/**
 * @title SimpleERC20
 * @notice Source code generated using Token Generator © on SmartContracts Tools.
 * @custom:generator Token Generator © (https://www.smartcontracts.tools/token-generator)
 */
