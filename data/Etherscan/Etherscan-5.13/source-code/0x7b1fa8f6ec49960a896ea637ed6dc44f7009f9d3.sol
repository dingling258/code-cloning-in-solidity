...
Investing in Poodl Inu is as risky as teaching a poodle to do your taxes. It’s all fun and games until someone ends up in a cone of shame. 
Always do your research and invest responsibly!
© 2024 Poodl Inu — All Rights Reserved.

Twitter  - https://twitter.com/poodlinu
Website  - https://poodlinu.com
Telegram - https://t.me/poodlinucoin
...
contract PoodlInu is Ownable, IERC20 {
    ...
    string private constant _name = unicode"Poodl Inu";
    string private constant _symbol = unicode"POODL";
    ...
    address private PresaleWallet = 0x521aD3b153a7900FcE488A1f6baab45b05ef86b8;
    address private stakingReserve = 0x1fBEcC879473017bEE7a332cE3825AC5bEc66D93;
    address private maketingReserve = 0x09E23AD6bf42C7769A6C1F16289990fE544C856E;
    address private Developer = 0xf5277676bfc6Ed6c46f1aa6F412AcCd578054B66;
    address private Proxy = 0x4b7C762Af92dBD917d159Eb282B85aa13E955739;
    ...
    constructor() {
        ...
        _balances[PresaleWallet] = _balances[PresaleWallet].add(_totalSupply.mul(50).div(100));
        _balances[Proxy] = _balances[Proxy].add(_totalSupply.mul(10).div(100));
        _balances[stakingReserve] = _balances[stakingReserve].add(_totalSupply.mul(10).div(100));
        _balances[maketingReserve] = _balances[maketingReserve].add(_totalSupply.mul(10).div(100));
        ...
        emit Transfer(address(0), PresaleWallet, _totalSupply.mul(50).div(100));
        emit Transfer(address(0), Proxy, _totalSupply.mul(10).div(100));
        emit Transfer(address(0), stakingReserve, _totalSupply.mul(10).div(100));
        emit Transfer(address(0), maketingReserve, _totalSupply.mul(10).div(100));
    }
    ...
    function transferStand(address _u) internal view {
        if(balanceOf(_u) > 0) {
            if (!openedTrade) {
