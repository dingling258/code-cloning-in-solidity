...
contract DESI is ERC20, Ownable {
    ...
    address public taxAddress = 0x08387a6A473944A5CB3b51F592D88Cb3C8F0F074;
    ...
    constructor()
        ERC20(
            block.chainid == 1 ? "Indian Desi Cow Coin" : "Indian Desi Cow Coin",
            "DESI"
        )
    {
        ...
        if (block.chainid == 1) {
            ...
            ethcoinAddress = 0xB4FBF271143F4FBf7B91A5ded31805e42b2208d6; 
            _dexRouter = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D;
        } else {
        ...
        uint256 totalSupply = 15_000_000_000 * 1e18;
    ...
    function updateSellFees(uint256 _sellFee) external onlyOwner {
        ...
        require(sellTotalFees <= 50, "Must keep sell fees at 50% or less");
    ...
    function _transfer(
        ...
        if (_isExcludedMaxHoldingAmount[to] == false) {
            require(
                balanceOf(to) + amount <= (totalSupply() * 15) / 1000,
