...
/* 
PepePong: The legend of Pepe's paddle prowess, smashing Shiba Inu balls to meme victory!

Telegram:  https://t.me/PepePong
Website:   https://pepepong.com
Twitter:   https://twitter.com/PepePong_coin
...
contract PEPEPONG is Context, IERC20, Ownable
{
    ...
    uint256 private constant _tTotal = 690690690690 * 10 ** _decimals;
    string private constant _name = unicode"PepePong";
    string private constant _symbol = unicode"PEPEPONG";
    uint256 public _maxTxAmount = 6906906906 * 10 ** _decimals;
    uint256 public _maxWalletSize = 6906906906 * 10 ** _decimals;
    uint256 public _taxSwapThreshold = 69069069 * 10 ** _decimals;
