...
contract LEONARDO is ERC721, ERC721Enumerable, ERC2981, ERC721URIStorage, ERC721Burnable, Ownable {
    constructor(string memory name, string memory symbol, address initialOwner, address payable royaltiesReceiver, uint96 numerator)
        ERC721(name, symbol)
        Ownable(initialOwner)
    {
        setRoyaltyInfo(royaltiesReceiver, numerator);
    }
