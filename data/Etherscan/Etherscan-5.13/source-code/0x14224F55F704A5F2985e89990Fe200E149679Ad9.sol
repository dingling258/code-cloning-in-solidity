...
- TG: https://t.me/AlphaTao_ETH
- X: https://x.com/alphatao_eth
...
contract AlphaTao is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"AlphaTao";
    string private constant _symbol = unicode"ATAO";
