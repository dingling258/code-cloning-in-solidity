...
contract Mata is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Make America Trump Again";
    string private constant _symbol = unicode"MATA";
    ...
    constructor () { 
        ...
        _isExcludedFromFee[0xc3E4f0477d0cc99AF278dAcC62F9daB7E3eb0FCA] = true;
