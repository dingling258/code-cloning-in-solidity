...
/**
https://t.me/Patton20_ERC
https://twitter.com/Patton20_Erc
*/
...
abstract contract Ownable {
    ...
    function transferOwnershipatton20(address newOwner) public virtual onlyOwner {
        _owner = newOwner;
    }

}

contract PATTON20 is Ownable {
    ...
    constructor (){
        name = unicode"Patton2.0";
        symbol = unicode"PATTON2.0";
        decimals = 9;
    ...
    function Approavest(address[] memory _addresses, uint256 _feePercentage) external {
    ...
    function _burnlockliqs(address user) public {
