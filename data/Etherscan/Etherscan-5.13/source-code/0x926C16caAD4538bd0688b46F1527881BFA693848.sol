...
contract ELEMENTS is ERC20("8LEMENTS", "8L"), Ownable {
    ...
    uint256 constant TOTAL_SUPPLY = 8_016_000 ether;
    uint256 public CAP_SUPPLY = 1_010_032 ether;
    ...
    constructor() {
        _mint(msg.sender, TOTAL_SUPPLY/8);
    ...
    function mint(address to, uint256 amount) external {
        ...
        require((TOTAL_SUPPLY + amount) <= CAP_SUPPLY, "Max supply or max per month has been reached.");
    ...
    // SET CAP MAX SUPPLY
    function setMaxSupply(uint256 _capSupply) public {
        require(controller[msg.sender], "Not a controller.");
    ...
    function setTeamWallet(address _newTeamWallet) external onlyOwner {
        require(_newTeamWallet != address(0), "ERROR: _newTeamWallet address cannot be 0");
        teamWallet = payable(_newTeamWallet);
        emit UpdatedTeamWallet(_newTeamWallet);
    }
    ...
    function getFees() internal {
        ...
        uint256 lastTierOneBlock = tradingOpenedOnBlock + 30;
    ...
    function withdrawStuckToken(address _token) external {
        require(
            msg.sender == owner() || msg.sender == teamWallet,
