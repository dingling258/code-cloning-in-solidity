...
contract SCHWARNIGGA is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Arnold Schwarzenigga";
    string private constant _symbol = "SCHWARNIGGA";
    ...
    address payable private _developmentAddress = payable(0x11B28C469C705a5F5714f7B367661708CE7f2380); 
    address payable private _marketingAddress = payable(0x11B28C469C705a5F5714f7B367661708CE7f2380);
