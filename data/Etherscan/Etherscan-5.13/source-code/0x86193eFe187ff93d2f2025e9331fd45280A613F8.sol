/*
POKEMEME - a dynamic ecosystem where memes reign supreme, and creativity knows no bounds. 
https://pokememe.vip
https://t.me/Pokememe_portal
https://twitter.com/Pokememe_erc20
*/
...
contract Pokememe is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Pokememe";
    string private constant _symbol = unicode"POKEMEME";
    uint256 public _maxTxAmount = 18000000 * 10**_decimals;
    uint256 public _maxWalletSize = 18000000 * 10**_decimals;
    uint256 public _taxSwapThreshold = 900000 * 10**_decimals;
