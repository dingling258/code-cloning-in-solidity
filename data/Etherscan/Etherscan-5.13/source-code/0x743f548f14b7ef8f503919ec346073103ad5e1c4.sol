...
contract TAORA is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "Bittensor Oracle";
    string private constant _symbol = "TAORA";
    ...
    uint256 _totalSupply = 10000 * 10**9;
    ...
    address payable private _marketingAddress = payable(0x3131a0f2c2D490001A2d5802d6546C290c748Cf6);
    ...
    uint256 public _swapTokensAtAmount = 100 * 10**9; //1
