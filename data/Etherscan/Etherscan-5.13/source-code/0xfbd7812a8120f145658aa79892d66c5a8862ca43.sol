...
contract ZestyAiToken is Context, IERC20, Ownable {
    using SafeMath for uint256;
    mapping (address => uint256) private _balances;
    mapping (address => mapping (address => uint256)) private _allowances;
    mapping (address => bool) private _isExcludedFromFee;
    address payable private _taxWallet = payable(0x77777775Ae99DC8D3033993faf968751A849f125);
    uint256 firstBlock;
    ...
    string private constant _name = unicode"Zesty AI";
