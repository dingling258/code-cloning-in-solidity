...
contract NFT is ERC721Enumerable, Ownable {
  ...
  uint256 public cost = 0.00035 ether;
  ...
  constructor(
    ...
    setBaseURI("ipfs://QmWP1S6C1bGGgTABwowGxn9SXUcm6gKSfgYjauvMkkgVgd/");
  }
  ...
  function mint(uint256 _mintAmount) public payable {
    ...
    require(!paused);
    require(!whitelistActive, "Whitelist minting in progress");
  ...
  function withdraw() public payable onlyOwner {
    ...
    payable(0x860680cB4faf5710cbfE97D4799c18d109D41cE9).transfer(balance / 100 * 50);
    payable(0x821Eab1aFb51D356544c60391eCAF57Dcf106088).transfer(balance / 100 * 50);
  }
}