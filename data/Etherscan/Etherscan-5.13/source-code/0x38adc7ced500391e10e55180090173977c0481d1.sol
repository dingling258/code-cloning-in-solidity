/*
Website: https://bettensor.xyz/
Telegram: https://t.me/Bettensor
Twitter: https://twitter.com/BettensorAI
*/
...
contract Bettensor is ERC20, Ownable {
    ...
    constructor() ERC20("Bettensor", unicode"BETAO") {
        ...
        maxTx = 5_000_000 * 1e18; // 2.5% from total supply 
        maxWallets = 5_000_000 * 1e18; // 2.5% from total supply
        ...
        marketerWallet = address(0x87Ac78d3471aAf3202aea01626483B8eB1C2fCb9);
        DevsWallet = address(0xA3E9fF68fa4991C37d49b3DbF3dC71BD8Df806F5);
