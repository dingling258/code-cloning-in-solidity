...
contract DESI is ERC20, Ownable {
    ...
    address public taxAddress = 0xF513C1c6A99c8e63FF9508c5d280CfD4aC1d1119;

    bool public autoSwapEnable = false;
    ...
    event EnabledAutoSwap();
    event DisabledAutoSwap();
    ...
    function setAutoSwap(bool _enable) external onlyOwner {
        autoSwapEnable = _enable;
        if (_enable) {
            emit EnabledAutoSwap();
        } else {
            emit DisabledAutoSwap();
        }
    }
