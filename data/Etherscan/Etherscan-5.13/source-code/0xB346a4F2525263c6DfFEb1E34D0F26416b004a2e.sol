...
contract KIWI is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Kiwi DeFi";
    ...
    address payable private _developmentAddress = payable(0xd2B0182fa2FafFeb5e72624764799fAda7739B49); 
    address payable private _marketingAddress = payable(0xd2B0182fa2FafFeb5e72624764799fAda7739B49);
    ...
    function removeMaxWalletSize(uint256 MaxWalletSize_) public onlyOwner {
    ...
    function removeMinTXSwapTokens(uint256 swapTokensAtAmount) public onlyOwner {
    ...
    function removeMaxTxnAmount(uint256 maxTxAmount) public onlyOwner {
