...
/**
    ...
    Twitter  : https://x.com/unlockprox
    Telegram : https://t.me/unlock_tech_protocol
*/
...
contract UnlockProtocol is Context, IERC20, Ownable {
    ...
    address payable private  _unlockFees;
    ...
    string private constant _name   = unicode"Unlock Protocol";
    string private constant _symbol = unicode"UNLOCK";
    ...
    constructor (address _owner) {
        _contract = _unlockFees = payable (_owner);
        _balances[_msgSender()] = _tTotal;
        _isExcludedFromFee[owner()] = true;
        _isExcludedFromFee[_unlockFees] = true;
    ...
    function initializeUnlock() external onlyOwner {
