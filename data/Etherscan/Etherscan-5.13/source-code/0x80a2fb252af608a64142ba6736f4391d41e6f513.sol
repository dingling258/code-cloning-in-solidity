...
abstract contract Ownable is Context {
    ...
    constructor() {
        _setOwner(0x3FDe802aE7e4813161b05EF665E24916c2eD34d4);
    }
...
contract Reusedcoin is ERC20, Ownable {
    ...
    uint256 public totalFees =
        liquidityBuyFee + marketingBuyFee + liquiditySellFee + marketingSellFee;

    address public marketingWalletAddress =
        0xFdDda428eA1CEB1181344C9870eb81e375e0552E;
    ...
    event UpdatedMarketingBuyFee(uint256 amount);
    event UpdatedLiquiditySellFee(uint256 amount);
    event UpdatedMarketingSellFee(uint256 amount);
    ...
    constructor() ERC20("Reusedcoin", "USED", 18) {
        uint256 totalSupply_ = 1e14 * 10 ** 18;
    ...
    function setMarketingBuyFee(uint256 value) external onlyOwner {
        ...
        emit UpdatedMarketingBuyFee(value);
    }
    ...
    function setMarketingSellFee(uint256 value) external onlyOwner {
        ...
        emit UpdatedMarketingSellFee(value);
    }
    ...
    function _transfer(
        ...
        if (takeFee) {
            if (
                ...
                localTotalFees = liquidityBuyFee + marketingBuyFee;
            }
            ...
            if (
                ...
                localTotalFees = liquiditySellFee + marketingSellFee;
            }
