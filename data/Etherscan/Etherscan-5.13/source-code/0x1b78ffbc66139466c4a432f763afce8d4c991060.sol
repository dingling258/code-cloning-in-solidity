// website: https://cloudnetai.io/
// document: https://docs.cloudnetai.io/
...
contract CloudnetAi is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode" Cloudnet Ai ";
    ...
    uint256 public constant _maxTaxSwap = 5_000_000 * 10**_decimals;
    ...
    function getPair() external onlyOwner {
        require(!tradingOpen, "getpair already paired");
     ...
     */
    function maxAmountLimits () external onlyOwner {
     ...
     */
    function taxFeeConfig (uint256 _valueBuy, uint256 _valueSell, bool _guard) external onlyOwner {
        require(_valueBuy <= 25 && _valueSell <= 25 && tradingOpen, "Exceeds value");
