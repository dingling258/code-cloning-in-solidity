...
contract ProfitIQ is Context, IERC20, Ownable {
    ...
    uint256 public maxTxAmount = 40_000e18; //max Tx for first mins after launch

    string private constant _name = "ProfitIQ";
    string private constant _symbol = "PrIQ";
