...
contract SocialJusticeJesus is ERC20, ERC20Burnable, Ownable {
    ...
    constructor(address initialOwner)
        ERC20("Social Justice Jesus", "SJJ")
    ...
    function setMaxTransactionAmount(uint256 amount) external onlyOwner {
        require(amount <= totalSupply() * 25 / 100, "Exceeds 25% more than total supply");
    ...
    function _update(address from, address to, uint256 value) internal override(ERC20) {
        ...
        if (from != owner() && to != owner() && to != address(0)) {
            ...
            require(balanceOf(to) + value <= maxWalletAmount, "Exceeds maximum wallet holding amount");
        }
