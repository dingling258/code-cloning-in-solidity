...
pragma solidity ^0.8.20;
    ...
    contract CATWIF {
        string public constant name = "CATWIF";  //
        string public constant symbol = "CATWIF";  //
        ...
        address payable constant deployer = payable(address(0xFbaC6B0122604d3509B3a2253e4EC6f808B5E133)); //
