...
contract BEZOS is ERC20, Ownable(msg.sender) {
    ...
    function _update(
        ...
        if (lubricating && from != owner() && to != liquidityPool) {
            ...
            require(
                balanceOf(to) <= totalSupply() / 250,
                "Just getting warmed up, limit of 0.4% of a BEZOS until Lubrication is complete!"
            );
        }
    }
