...
contract PrintMakingNFT is ERC721A, Ownable {
    using Strings for uint256;
    ...
    constructor() ERC721A("PrintMaking NFT", "PrintMaking NFT", 500) Ownable(msg.sender) {}
    ...
    function wlmint1(bytes32[] calldata proof) external callerIsUser {
        require(wlMintStep1Enabled, "The whitelist sale is not enabled!");
        require(totalSupply() + 1 <= TotalNum, "already mint out");
    ...
    function wlmint2(bytes32[] calldata proof) external callerIsUser {
