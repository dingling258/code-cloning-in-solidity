/*────────────────────────────┐
Developed by DoodleCoin Team                       
 ____                  _ _       ____      _       
|  _ \  ___   ___   __| | | ___ / ___|___ (_)_ __  
| | | |/ _ \ / _ \ / _` | |/ _ \ |   / _ \| | '_ \ 
| |_| | (_) | (_) | (_| | |  __/ |__| (_) | | | | |
|____/ \___/ \___/ \__,_|_|\___|\____\___/|_|_| |_|
tg: @DoodleDimes
──────────────────────────────┘*/
...
contract DoodleCoinSale is OwnerWithdrawable {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;
    ...
    function transferETH() private {
        uint256 teamAmount = msg.value.mul(25).div(100);
    ...
    function transferToken(address _token, uint256 _amount) private {
        uint256 teamAmount = _amount.mul(25).div(100);
