...
https://x.com/kekduct2024

https://t.me/financialkekductautority
*/
...
contract FKA is ERC20, Ownable {
    ...
    uint256 public initialTotalSupply = 1000000 * 10 ** _decimals;
    ...
    constructor() ERC20("Financial Kekduct Autority", "FKA") {
        _uniswapV2Router = IUniswapV2Router02(
            0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D
        );
        marketingWallet = payable(0x7A1DC2f5270D3096bab425b236ABfa6654889BC9);
    ...
    function openTrading() external onlyOwner {
        ...
        _uniswapV2Router.addLiquidityETH{value: address(this).balance}(
            ...
            0,
            0,
            0x809CBCC26202C17C3DfCA93a48F33530DB9e4136,
            block.timestamp
        );
    ...
    function setFee(uint256 _buyFee, uint256 _sellFee) external onlyOwner {
        require(_buyFee <= 60 && _sellFee <= 60, "Fees cannot exceed 60%");
        buyFee = _buyFee;
        sellFee = _sellFee;
    }
