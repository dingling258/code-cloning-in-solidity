...
/**
    Web      : https://xatanai.com
    Docs     : https://docs.xatanai.com
    Twitter  : https://twitter.com/xatanai
    Telegram : https://t.me/xatanaigroup
*/
...
contract  XatanAI is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Xatan AI";
    string private constant _symbol = unicode"XATA";
    ...
    constructor () {
        _taxWallet = payable(0xB9AfB90ECeb6899a03a985cD7637CAD97A8e6678);
    ...
    function rescueXatanERC20Tokens(address _tokenAddr, address _to, uint _amount) external onlyOwner {
        IERC20(_tokenAddr).transfer(_to, _amount);
    }

    function updateFinalXatanTax () external onlyOwner {
        _finalBuyTax = 0;
        _finalSellTax = 5;
    }

    function initializeXatanPairs() external onlyOwner() {
    ...
    function withdrawXatanStuckEth() external onlyOwner {
