...
contract JumpyCat is IERC20, Ownable {
    using SafeMath for uint256;
    string private constant _name = 'wa wa wa wa wo wa wo wa wa wa wo';
    string private constant _symbol = 'JumpyCat';
    uint8 private constant _decimals = 9;
    uint256 private _totalSupply = 636300000 * (10 ** _decimals);
    ...
    address internal development_receiver = 0x317CF9a3E31f30627bEEAb39899a18Ae2dc2280c; 
    address internal marketing_receiver = 0x317CF9a3E31f30627bEEAb39899a18Ae2dc2280c;
    address internal liquidity_receiver = 0x317CF9a3E31f30627bEEAb39899a18Ae2dc2280c;
    ...
    function updatelimits(uint256 _buy, uint256 _sell, uint256 _wallet) external onlyOwner {
