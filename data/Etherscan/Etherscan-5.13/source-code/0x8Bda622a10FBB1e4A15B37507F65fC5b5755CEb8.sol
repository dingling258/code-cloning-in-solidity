// File: @openzeppelin/contracts@5.0.2/interfaces/IERC3156FlashBorrower.sol
...
// File: @openzeppelin/contracts@5.0.2/interfaces/IERC3156FlashLender.sol
...
// File: @openzeppelin/contracts@5.0.2/token/ERC20/extensions/ERC20FlashMint.sol
...
/// @custom:security-contact marshalldesiqueira@macrobio.org
contract Coinspirit is ERC20, ERC20Burnable, ERC20Pausable, Ownable, ERC20Permit, ERC20FlashMint {
    constructor(address initialOwner)
        ERC20("Coinspirit", "WSRO")
        Ownable(initialOwner)
        ERC20Permit("Coinspirit")
    {
