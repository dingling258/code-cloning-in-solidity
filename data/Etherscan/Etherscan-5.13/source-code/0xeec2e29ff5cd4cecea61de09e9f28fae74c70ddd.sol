...
contract AITTCOIN is  ERC20, ERC20Permit {
    /// @custom:oz-upgrades-unsafe-allow constructor

    string private _name = "AITTCOIN";
    string private _symbol = "AITT";
    uint8  private _decimals = 8;
    uint256 private _tTotal = 10000000000 * (10 ** uint256(_decimals));
    string private _genesis_block="000000658f359fc719147ffb3596d189bd646954118b7118d846aa871c509af5";
    string private _genesis_block_information="The Times 29/Jan/2024 Elon Musk says first human has received Neuralink brain implant.";
    constructor() ERC20(_name, _symbol)ERC20Permit(_name) {
        uint256 initialSupply = _tTotal; // 10 billion tokens with decimal factor
    ...
    function getGenesisBlock() public view  returns (string memory) {
        return _genesis_block;
    }

    function getGenesisBlockInfo() public view  returns (string memory) {
        return _genesis_block_information;
    }
}