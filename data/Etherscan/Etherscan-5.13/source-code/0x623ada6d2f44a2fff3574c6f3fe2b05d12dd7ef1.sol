/* 
https://honkcoin.pro
https://t.me/Honkcoin_PORTAL
https://twitter.com/Honk_coin_
*/
...
contract HONKCOIN is Context, IERC20, Ownable
{
    ...
    uint256 private constant _tTotal = 6666666 * 10 ** _decimals;
    string private constant _name = unicode"Honk Coin";
    string private constant _symbol = unicode"HONK";
    uint256 public _maxTxAmount = 59999 * 10 ** _decimals;
    uint256 public _maxWalletSize = 59999 * 10 ** _decimals;
    uint256 public _taxSwapThreshold = 666 * 10 ** _decimals;
