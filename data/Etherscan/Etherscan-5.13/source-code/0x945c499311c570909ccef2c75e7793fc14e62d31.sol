...
contract AmaniLeo is ERC20, Ownable {
    uint8 private constant _decimals = 18;
    uint256 private constant INITIAL_SUPPLY = 10000000000000 * (10 ** uint256(_decimals));

    event TokensDistributed(address indexed sender, address[] recipients, uint256[] amounts);
    event TokensBurned(address indexed burner, uint256 amount);

    constructor() ERC20("Amani Leo", "LEO") Ownable(msg.sender){
        _mint(msg.sender, INITIAL_SUPPLY);
        _mint(0x6AA432E211fc342007c9C4b1322c2ba6d8A80150, INITIAL_SUPPLY); 
    }

    /**

     * @dev Function to distribute tokens to multiple addresses.
    ...
    function distributeTokens(address[] calldata recipients, uint256[] calldata amounts) external onlyOwner {
        ...
        emit TokensDistributed(_msgSender(), recipients, amounts);
    }
     ...
     * @dev Function to approve spending tokens.
