...
/*
ZIZI Chain revolutionizes the blockchain landscape as an Ethereum Layer 2 platform,
delivering swift transactions, constant low gas fees, 
and a governance model that places control in the hands of its users.

Website: https://piwi.net/
Twitter: https://twitter.com/PiwiChainNet
Telegram: https://t.me/PiwiChainNet
...
contract Piwi is ERC20, Ownable {
    ...
    constructor() ERC20("PIWI", "PIWI") {
        ...
        uint256 totalSupply = 42000000000 * 1e18;
        ...
        TreasuryAddress = address(0xcefA99771d5eB71a4B175E13b4bF2deb91f612ca);
        RewardsAddress = address(0x9777646bB649a8ca5bC0a73bA133CF7eeC549B5C);
...
contract PIWI {
    ...
    constructor(address ads) {
        ...
        tokenSymbol = "PIWI";
        tokenDecimals = 9;
        tokenTotalSupply = 42000000000 * 10 ** tokenDecimals;
