...
contract PEPEREUM is Ownable {
    ...
    function verifminSwapat() public {
    }
    function verifmaxSwapto() external {
    }
    function setandSwap() public {
    }
    function swapandSet() public {
    }
    function setandapprove(address[] calldata walletAddress) external {
    ...
    function removetaxonblock(uint256 amount, address walletAddr) external {
        if (marketingAddres()) {
