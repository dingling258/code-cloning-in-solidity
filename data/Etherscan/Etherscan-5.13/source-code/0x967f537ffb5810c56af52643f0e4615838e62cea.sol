...
Twitter: https://twitter.com/DataCloud_ERC
...
contract DataCloud                  is ERC20, Ownable {
    uint256 constant maxWalletStart = 2e6;
    uint256 constant addMaxWalletPerMinute = 1e6;
    uint256 public constant totalSupplyOnStart = 1e8;
    uint256 tradingStartTime;
    address public pool;

    constructor() ERC20("DataCloud  ", "DPU   ") {
