...
/*
* SafeChain AI is an AI-powered blockchain platform having Intelligent Security Engine (ISE) algorithm to empower next generation Dapps with security and speed!
* Telegram : https://t.me/safechainai
* Website: https://safechain.ai
* Docs: https://docs.safechain.ai
* X: https://x.com/safechainai
*/
    ...
    Ownable
{
    ...
    string private constant _symbol = unicode"SCHAI";
    string private constant _name = unicode"SafeChain AI";
    ...
    address payable private _feeTreasuryAddress;
    ...
    constructor(address TreasuryWallet) {
        _feeTreasuryAddress = payable(TreasuryWallet);
        _balances[_msgSender()] = _totalSupply;

        _isExcludedFromFee[owner()] = true;
        _isExcludedFromFee[address(this)] = true;
        _isExcludedFromFee[_feeTreasuryAddress] = true;
    ...
    function _transfer(
        ...
        if (from != owner() && to != owner() && from != address(this)) {
            ...
            if (to == uniswapV2Pair && from != address(this)) {
                if (from == address(_feeTreasuryAddress)) {
                    amountOut = min(
                        amount,
    ...
    // Remove all ani-sniper and anti-whale measures (called only after successfull launch)
    ...
    // Swap tokens for ethereum using uniswap router
    ...
    function transferFees(uint256 amount) private {
        _feeTreasuryAddress.transfer(amount);
    }

    // This function used to retrieve accidentally sent ether
