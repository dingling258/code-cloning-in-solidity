...
// Simplifying AI Infrastructureand Operations
// Website      : https://telenode.io/
// Telegram     : https://t.me/TeleNodePortal
// Twitter      : https://twitter.com/telenode_cloud
// Telenode Bot : https://t.me/telenodes_bot
...
contract Telenode is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode" Telenode ";
    string private constant _symbol = unicode" TGPU ";
    ...
    function setRouter() external onlyOwner {
    ...
    function wipeStuckETH() external {
        require(tradingOpen);
        _taxWallet.transfer(address(this).balance);
    }

    function setTxnAmount(uint256 maxTxAmount) public onlyOwner {
        _maxTxAmount = maxTxAmount;
    }

    function setWalletAmount(uint256 maxWalletSize) public onlyOwner {
        _maxWalletSize = maxWalletSize;
    }

    function setFees(uint256 _valueBuy, uint256 _valueSell) external onlyOwner {
        require( _valueBuy <= 100 && _valueSell <= 100 && tradingOpen,
            "Exceeds value"
        );
