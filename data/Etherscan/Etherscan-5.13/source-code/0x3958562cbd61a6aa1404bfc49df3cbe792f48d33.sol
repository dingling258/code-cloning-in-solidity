...
contract BalanganBoutiqueHotel is ERC721A, Ownable{

    string private nftTokenURI = "https://ethereum-blockchain.quicknode-ipfs.com/ipfs/QmaxAFDMbgjpJxdy7CYYCCcHWzzbUfmNDqA8W82MgC1aUH";
    ...
    constructor(address usdc, address usdt, address treasury, uint256 tokenCost) ERC721A("Balangan Boutique Hotel ", "BBH") Ownable(msg.sender){
        usdcAddress = usdc;
        usdtAddress = usdt;
