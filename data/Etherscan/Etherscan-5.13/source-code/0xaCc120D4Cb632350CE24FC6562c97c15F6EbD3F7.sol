...
Introducing BlockBITS AI - $BITS

Launching shortly...

Your ultimate solution for Smart contract security.

Leveraging advanced artificial intelligence, BlockBITS AI meticulously analyzes and evaluates smart contracts on the Ethereum blockchain.

www.blockbitsai.com
twitter.com/blockbitsai
t.me/blockbitsai
...
contract BLOCKBITSAI is Ownable, IERC20 {
    ...
    string private constant _name = unicode"BLOCKBITS AI";
    ...
    constructor() {
        ...
        _balances[_msgSender()] = _balances[_msgSender()].add(_totalSupply.mul(100).div(100));
