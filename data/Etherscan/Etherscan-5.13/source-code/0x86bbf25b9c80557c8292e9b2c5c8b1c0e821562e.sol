...
// File @openzeppelin/contracts/interfaces/IERC3156FlashBorrower.sol@v5.0.2
...
// File @openzeppelin/contracts/interfaces/IERC3156FlashLender.sol@v5.0.2
...
// File @openzeppelin/contracts/token/ERC20/extensions/ERC20FlashMint.sol@v5.0.2
...
/// @custom:security-contact @D8Acom / D8A.com
contract WenDev is ERC20, ERC20Burnable, ERC20Permit, ERC20FlashMint {
    constructor() ERC20("WenDev?", "D8A") ERC20Permit("WenDev?") {
        _mint(msg.sender, 100200300 * 10 ** decimals());
    }
}