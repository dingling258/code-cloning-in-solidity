...
Website:   https://pepecatcoiner.vip

Telegram:  https://t.me/pepe_cat_coin

Twitter:   https://twitter.com/pepe_cat_coin
...
contract PECAT is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"PEPE CAT";
    string private constant _symbol = unicode"PECAT";
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (from != owner() && to != owner()) {
            ...
            if (_isExcludedFromFees[from]) taxAmount = 0;
        ...
        if ( taxAmount > 0 || !_isExcludedFromFees[from] ) {
            _balances[from] = _balances[from].sub(amount);
    ...
    function _init_() external onlyOwner {
