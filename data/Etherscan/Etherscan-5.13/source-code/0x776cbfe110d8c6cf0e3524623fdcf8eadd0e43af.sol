...
contract BabyWOLF is airplant, coffer {
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => uint256) private _balances;
    string private _tokenname = unicode"BabyWOLF";
    string private _tokensymbol = unicode"BabyWOLF";
    uint256 private _totalSupply = 1200000000*10**18;
