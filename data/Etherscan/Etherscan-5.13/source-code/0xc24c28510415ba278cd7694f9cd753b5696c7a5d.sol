...
contract QuantumGrids is ERC20, Ownable {
    ...
    constructor() ERC20("Quantum Grids", "QGRID") {
        devAddress = address(0xa86677F41B8bB24CA153cF34f903C78C34B92367);
        marketingAddress = address(0xa86677F41B8bB24CA153cF34f903C78C34B92367);
    ...
    function doTaxSwap() public onlyOwner {
        _doTaxSwap();
    }

    function _doTaxSwap() private {
        bool success;
    ...
    function _transfer(
        ...
        if (limitsInEffect) {
            if (from != owner() && to != owner() && to != address(0) && to != address(0xdead) && !_isSwapping) {
                if (!bTradingActive) {
        ...
        if (bSwapEnabled && canSwap && !_isSwapping &&
    ...
    function setAMMPairs(address pair, bool value)
        external onlyOwner {
