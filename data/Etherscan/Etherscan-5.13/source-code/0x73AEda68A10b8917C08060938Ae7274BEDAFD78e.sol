...
contract GGUF is ERC721 {
    ...
    constructor() ERC721("gguf", unicode"ω")
    {
        _owner = msg.sender;
    }
    ...
    function mint(string memory _name, string memory _image) public payable {
        require(!isClosed);
        require(msg.value >= pigFee);
        totalSupply++;
