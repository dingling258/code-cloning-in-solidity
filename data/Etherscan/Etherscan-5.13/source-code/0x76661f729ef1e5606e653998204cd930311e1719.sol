    ...
    function _update(
        ...
        if (lubricating && from != owner() && to != liquidityPool) {
            ...
            require(
                ...
                "Just getting warmed up, limit of 1% of a RWA until Lubrication is complete!"
            );
        }
    }
