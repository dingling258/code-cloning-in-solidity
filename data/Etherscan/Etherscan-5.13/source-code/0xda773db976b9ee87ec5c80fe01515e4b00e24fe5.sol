...
/*
web: https://www.smug.meme/
x: https://twitter.com/smug_erc
tg: https://t.me/smug_Erc
*/
...
contract SMUG is Context, IERC20, Ownable {
    using SafeMath for uint256;
    mapping (address => uint256) private _balances;
    mapping (address => mapping (address => uint256)) private _allowances;
    mapping (address => bool) private _isExcludedFromFee;
    address payable private _taxWallet;
    string private constant _name = unicode"Smug Pepe";
    string private constant _symbol = unicode"SMUG";
