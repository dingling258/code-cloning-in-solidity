...
contract Pirateflix is Context, IERC20, Ownable {
    ...
    MarketingWallet = payable(0xb1441af205a0869EB3C9C267ed7d831c1696e889);
    deployerwallet = 0x0D253A827642A551177FAC626426969C9bB9CC8f; 
   ...
   function updateMaxTxLimit(uint256 amount) external onlyOwner {require(amount >= 100000, "amount must be greater than or equal to 0.1% of the supply");
    ...
    function enable_trade() external onlyOwner() {
    ...
    function recoverERC20(address _tokenAddy, uint256 _amount) external onlyOwner {
