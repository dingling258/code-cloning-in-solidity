...
contract BirdBrett is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"BIRD BRETT";
    string private constant _symbol = unicode"BIRDBRETT";
