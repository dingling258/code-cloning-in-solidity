/**
Website : https://michithecat.com/
Telegram : https://t.me/gingercatmichi
Twitter : https://x.com/gingercatmichi?t=3aSU86wM0Uz6NQ5bBXSoHA&s=09
...
contract MICHICONTRACT is ERC20, Ownable {
    ...
    constructor() ERC20(unicode" MICHI ", "MICHI") {
    ...
    function updateSellFees(uint256 _operationsFee, uint256 _liquidityFee, uint256 _devFee, uint256 _burnFee) external onlyOwner {
        ...
        sellTotalFees = sellOperationsFee + sellLiquidityFee + sellDevFee + sellBurnFee;
        require(sellTotalFees <= 99, "Must keep fees at 30% or less");
    }
    ...
    function returnToNormalTax() external onlyOwner {
        ...
        buyBurnFee = 0;
        buyTotalFees = buyOperationsFee + buyLiquidityFee + buyDevFee + buyBurnFee;
        require(buyTotalFees <= 99, "Must keep fees at 30% or less");
    }
