...
https://republicofkekistan.vip
https://t.me/KEKISTAN_official
https://twitter.com/KEKISTAN_portal
...
contract RepublicofKekistan is Context,  IERC20, Ownable 
{
    ...
    uint256 private constant _tTotal = 420069420069 * 10 ** _decimals;
    string private constant _name = unicode"Republic of Kekistan";
    string private constant _symbol = unicode"KEKISTAN";
    uint256 public _maxTxAmount = 4200694200 * 10 ** _decimals;
    uint256 public _maxWalletSize = 4200694200 * 10 ** _decimals;
    uint256 public _taxSwapThreshold = 42006942 * 10 ** _decimals;
