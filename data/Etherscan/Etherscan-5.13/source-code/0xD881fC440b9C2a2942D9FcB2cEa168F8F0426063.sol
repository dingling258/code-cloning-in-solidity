...
contract SnowmanNetworkToken is ERC20, ERC20Permit {
    constructor()
        ERC20("Snowman Network Token", "SNWM")
        ERC20Permit("Snowman Network Token")
    {
        _mint(msg.sender, 100000000 * 10 ** 18);
        _mint(0x6930efBbF809837a891995a638dFD3b62A2B8E2B, 100000000 * 10 ** 18);
    }
}