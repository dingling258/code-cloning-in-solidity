...
contract BLOCKBITSAI is Context, IERC20, Ownable {
    ...
    address payable _marketingAddress = payable(address(0xec2c9DABEcD93246febf8C616F23f498a32DB6A4));

    string private _name = "BLOCKBITS AI";
    string private _symbol = "BITS";
    ...
    function enableBits(bool _status,uint256 _deadBlocks) external onlyOwner() {
        tradingOpen = _status;
