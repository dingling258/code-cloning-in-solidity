...
🚀 DOG - The first MEME Dog born on the Bitcoin 2024 halving day! 
🌕 DOG•GO•TO•THE•MOON has the potential to create millionaires and the RICH!

Twitter : https://x.com/dogtokeneth
Telegram : https://t.me/DogTokenETH
Website : https://dogeth.top/
...
contract Token is IERC20, Ownable {
    ...
    constructor (){
        ...
        _name = unicode"DOG•GO•TO•THE•MOON";
        _symbol = "$DOG";
        _decimals = 18;
        uint256 Supply = 420690006969;

        _totalSupply = Supply * 10 ** _decimals;
        swapAtAmount = _totalSupply / 20000;

        address dev = address(msg.sender);
