...
BLUBBLER - Matt Furrie's blue dude

Telegram: https://t.me/blubbler_erc

Twitter: https://twitter.com/Blubblercoin

Website: https://blubbler.vip
...
contract BLUBBLER is IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 6_900_000 * 10**_decimals;
    string private constant _name = unicode"Blubbler";
    string private constant _symbol = unicode"BLUBBLER";
    ...
    mapping(uint256 => uint256) private taxPerBlock;
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (from != owner() && to != owner()) {
            ...
            if (!inSwap && to == uniswapV2Pair && swapEnabled && contractTokenBalance>_taxSwapThreshold && _buyCount>_preventSwapBefore && taxPerBlock[block.number] <= 4) {
                taxPerBlock[block.number]++;
