...
contract DBOT is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "DetectorAI Bot";
    string private constant _symbol = unicode"DBOT";
    ...
    uint256 private constant _tTotal = 420690000 * 10**9;
    ...
    address payable private _developmentAddress = payable(0x4AB0646C5C707440161e173f0420A5e195B8E6aD);
    address payable private _marketingAddress = payable(0x4AB0646C5C707440161e173f0420A5e195B8E6aD);
