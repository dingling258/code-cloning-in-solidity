...
contract Bet {
    string public constant name = "BetcoinAi";  //
    ...
    TradingFees tradingFees = TradingFees(0,0);
    ...
    address payable constant owner = payable(address(0x34c1b0514ECb50b0C2FCe44770148de8d86CC88B)); //
