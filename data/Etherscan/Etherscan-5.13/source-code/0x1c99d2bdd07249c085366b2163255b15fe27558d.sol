...
Website : https://www.ethergram.io/

Twitter : https://twitter.com/EthergramERC

Telegram : https://t.me/EthergramIO
...
contract Ethergram is ERC20, Ownable {
    ...
    constructor() ERC20(unicode"Ethergram", unicode"ETG") {
    ...
    function disableTDelay() external onlyOwner {
        transferDelayEnabled = false;
    }
