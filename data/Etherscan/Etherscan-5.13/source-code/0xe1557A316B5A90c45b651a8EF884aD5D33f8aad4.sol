...
/**
    web     : https://ripndipcoin.wtf
    Tg      : https://t.me/ripndipclub
    twtiter : https://twitter.com/xripndip
*/
...
contract RipNDip is Context, IERC20, Ownable {
    ...
    string private constant _name = "Rip & Dip";
    string private constant _symbol = "RND";
    ...
    function createRNDPairs() external onlyOwner() {
