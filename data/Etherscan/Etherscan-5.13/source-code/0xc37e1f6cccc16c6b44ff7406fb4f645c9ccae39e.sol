/**
    Incognito AI: Your One-Stop Shop for Anonymous Browsing, Communication & Identity.
    https://useincognito.org/
    https://t.me/UseIncognitoAI
*/
...
contract Incognito is ERC20, Ownable {
    ...
    constructor() ERC20("IncognitoAI", "INC") {
        //Mainnet
        ...
        marketingWallet = address(0xe18e5B0B1f4Af5e5c5552273bb83FcA2e08502B0);
        ...
        _mint(devWallet, totalSupply * 3 / 100);
        _mint(marketingWallet, totalSupply * 3 / 100);
    ...
    function openAI() external onlyOwner payable {
