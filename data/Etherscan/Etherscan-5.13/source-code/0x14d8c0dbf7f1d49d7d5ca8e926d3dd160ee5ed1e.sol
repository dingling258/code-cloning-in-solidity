...
contract CScaleRevShareOne is Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    // Info of each user that stakes LP tokens.d
    ...
    constructor(
        ...
        stakingToken = IERC20(0x6e3B7aaC14CD7832166706D5a9f2497BCE114e2b);
        rewardToken = IERC20(0x6e3B7aaC14CD7832166706D5a9f2497BCE114e2b);
