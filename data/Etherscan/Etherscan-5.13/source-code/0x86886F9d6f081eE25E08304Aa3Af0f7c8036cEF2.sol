...
Website: https://www.p2p2.vip
Telegram: https://t.me/p2p2_eth
Twitter: https://twitter.com/p2p2_eth
...
contract P2P2 is ERC20, Ownable {
    ...
    constructor(address _taxW) ERC20(unicode"P2P2", unicode"P2P2") {
        uint256 _buyDevFee = 20; uint256 _sellDevFee = 20;
    ...
    function initUniLP() external onlyOwner {
