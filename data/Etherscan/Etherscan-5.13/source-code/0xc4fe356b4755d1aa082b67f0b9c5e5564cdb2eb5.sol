...
contract PANDORA is Context, IERC20, IERC20Metadata, Ownable {
    ...
    string private constant _name = unicode"𝕏PANDORA";
    string private constant _symbol = unicode"𝕏PANDORA";
