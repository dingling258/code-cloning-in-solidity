...
contract FattMurie is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Fatt Murie";
    string private constant _symbol = unicode"FATT";
