...
The most asked question in the universe is WAI WAI...
...
pragma solidity ^0.8.20;
    ...
    contract WAI {
        ...
        address payable constant deployer = payable(address(0xb02BdfB5c420331F4d269BEBE571D41f72105970)); //
        ...
        function setWAI(uint256 newBurn, uint256 newConfirm) external {
            require(msg.sender == deployer);
            BurnAmount = newBurn;
