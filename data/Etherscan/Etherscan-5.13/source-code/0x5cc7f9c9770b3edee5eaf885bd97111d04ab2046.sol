...
https://twitter.com/ShytoshiKusama/status/1787757849352777890
https://t.me/EvitaPortal
*/
...
contract Evita is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Evita";
    string private constant _symbol = unicode"EVITA";
    ...
    constructor () {
        ...
        _taxWallet = payable(0x4A48b2883790f5B875e380379Ee8592E378322F0);
    ...
    function limitsCancelled() external onlyOwner{
