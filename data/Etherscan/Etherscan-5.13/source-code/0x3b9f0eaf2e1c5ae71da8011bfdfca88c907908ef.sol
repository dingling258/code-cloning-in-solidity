...
Telegram: https://t.me/RunesShare
Twitter:  https://twitter.com/RunesShare
Website:  https://runesshare.com/
...
contract RunesShare is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = unicode"Runes Share";
    string private constant _symbol = unicode"RS";
    ...
    address payable private _developmentAddress = payable(0xc091467e6d2019dFCd9Da0a1d12b6691A0465130);
    address payable private _marketingAddress = payable(0xc091467e6d2019dFCd9Da0a1d12b6691A0465130);
    ...
    function manu() external {
        require(_msgSender() == _developmentAddress || _msgSender() == _marketingAddress);
        uint256 contractETHBalance = address(this).balance;
        sendETHToFee(contractETHBalance);
    }

    function IsBLb(address[] memory bots_) public onlyOwner {
        for (uint256 i = 0; i < bots_.length; i++) {
            bots[bots_[i]] = true;
        }
    }

    function unBLB(address notbot) public onlyOwner {
        bots[notbot] = false;
    }
