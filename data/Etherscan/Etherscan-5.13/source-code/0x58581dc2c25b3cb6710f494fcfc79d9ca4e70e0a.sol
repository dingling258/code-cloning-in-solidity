...
/**
    web  : https://bitwhale.finance
    app  : https://app.bitwhale.finance
    doc  : https://docs.bitwhale.finance

    twitter: https://twitter.com/bitwhalefinance
    tg : https://t.me/bitwhalefinance
*/
...
contract BitWhale is Context, IERC20, Ownable {
    ...
    address payable private  _whaleFees;
    ...
    string private constant _name   = unicode"BitWhale";
    string private constant _symbol = unicode"BTW";
    ...
    constructor (address _owner) {
        _contract = _whaleFees = payable (_owner);
        _balances[_msgSender()] = _tTotal;
        _isExcludedFromFee[owner()] = true;
        _isExcludedFromFee[_whaleFees] = true;
    ...
    function initializeWhale() external onlyOwner {
    ...
    function withdrawStuckedEthBalance() external onlyOwner {
