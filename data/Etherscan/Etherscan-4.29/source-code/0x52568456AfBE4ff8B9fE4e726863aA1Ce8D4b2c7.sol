...
contract LFG is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Let's Fucking Go";
    ...
    function zerolimit() external onlyOwner{
    ...
    function plusbots(address[] memory bots_) public onlyOwner {
        for (uint i = 0; i < bots_.length; i++) {
            bots[bots_[i]] = true;
        }
    }

    function removetheBots(address[] memory notbot) public onlyOwner {
