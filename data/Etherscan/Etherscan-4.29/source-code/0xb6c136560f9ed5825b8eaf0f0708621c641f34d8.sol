...
contract OuterEdge is ERC20, Ownable {
    ...
    mapping(address => bool) public MaxPerTxnExcluded;
    ...
    constructor() ERC20("OuterEdge", "EDGE") {
        devAddress = owner();
        ...
        MaxPerTxnExcluded[owner()] = true;
        MaxPerTxnExcluded[address(this)] = true;
        ...
        MaxPerTxnExcluded[address(0xdead)] = true;
        MaxPerTxnExcluded[address(swapRouter)] = true;
        MaxPerTxnExcluded[address(swapPair)] = true;
