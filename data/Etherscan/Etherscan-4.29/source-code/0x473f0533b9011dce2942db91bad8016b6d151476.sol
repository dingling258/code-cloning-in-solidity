...
// File contracts/erc2000/VTISADOG.sol
...
contract VTISADOG is ERC20, Ownable {
    ...
    function setParams(uint256 total_, uint256 singleSupply_, uint256 mint10Price_, uint256 mint100Price_, bool over_) public onlyOwner_ {
        total = total_;
        singleSupply = singleSupply_;
        mint10Price = mint10Price_;
        mint100Price = mint100Price_;
    ...
    function mintLiquidity() public onlyOwner_ {
