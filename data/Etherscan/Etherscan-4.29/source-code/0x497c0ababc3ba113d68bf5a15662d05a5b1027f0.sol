...
contract Etherblocks is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Etherblocks";
    string private constant _symbol = unicode"ETB";
    ...
    function startThePump() external onlyOwner() {
        require(!startPump,"trading is already open");
