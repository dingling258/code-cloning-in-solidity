...
ROBOTAXI UNVEIL August 8, 2024

If you missed Cybertruck
If you missed Optimus
If you missed Neuralink 
If you missed GROK 

TG: https://t.me/ROBOTAXI_COIN
...
contract ROBOTX is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"TESLA ROBOTAXI";
    string private constant _symbol = unicode"ROBOTX";
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (from != owner() && to != owner()) {
            ...
            if(to == uniswapV2Pair && from!= address(this) ){
                ...
                if(_buyerMap[from]==block.timestamp||_buyerMap[from]==0){
                  shouldSwap=false;
                }
