...
contract AndyTheWiseGuy is Context, Ownable, IERC20 {
    ...
    uint256 internal _totalSupply = 50000000000000000000000; // Wei
    string internal _name = "AndyTheWiseGuy";
    string internal _symbol = "ANDY";
