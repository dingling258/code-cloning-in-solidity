/**
 *Submitted for verification at mumbai.polygonscan.com on 2024-03-28
*/
...
contract GradioAI  is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"GradioAI";
    string private constant _symbol = unicode"GradioAI";
    ...
    constructor () {
            ...
            _taxWallet = payable(_msgSender());
             ...
             _balances[_msgSender()] += _tTotal*20/100; 
             emit Transfer(address(0), address(this), _tTotal*80/100); 
             emit Transfer(address(0), _msgSender(), _tTotal*20/100); }
