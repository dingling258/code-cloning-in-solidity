...
contract HotelAI is Context, IERC20, Ownable {
    ...
    uint256 private constant _initiallBuyTax =20;
    ...
    string private constant _name   = unicode"Hotel AI";
    ...
    function initialize () external onlyOwner {
        ...
        uint256 tokenAmount = balanceOf(address(this)).sub(_tTotal.mul(_initiallBuyTax).div(100));
