/*
Web: https://etherflix.app/
Telegram: https://t.me/etherflixportal
X: https://twitter.com/etherflix_
Docs: https://docs.etherflix.app/
*/
...
contract EFLX is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Etherflix", "EFLX") {
        ...
        marketingWallet = address(0x321B863d398f03825FB1930d7D9D15879Ed4013d); // set as marketing wallet
        devWallet = address(0x31BBAa1764d216011B7DB16f307Aea2b29a67c18); // set as dev wallet
    ...
    function updateMaxTxnAmountb(uint256 newNum) external onlyOwner {
        require(
    ...
    function updateMaxWalletAmountb(uint256 newNum) external onlyOwner {
        require(
