...
contract StakingContract is Ownable, ReentrancyGuard {
    ...
    uint256 public constant MIN_STAKE_AMOUNT = 50000 * 10**16; // Minimum deposit = 50k EXNT
    uint256 public constant MAX_STAKE_AMOUNT = 1e8 * 10**16; // Maximum = 100m EXNT
    uint256 public constant MIN_STAKE_DURATION = 1814400;
