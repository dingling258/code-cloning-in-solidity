...
/*
Vitreus Chain is a novel evolution of Layer 0 blockchains not unlike 
Polkadot or Cosmos, where their heart of the system is extensible and ripe for further innovation.
 Devoted to being an ecosystem of innovation, 
 come and build with Vitreus Chain;discover the possibilities!
...
1️⃣ Mainnet ✅
2️⃣ vApp Download IOS/Andriod ✅
3️⃣ Staking ✅
4️⃣ Marketplace ✅

  https://vitreus.live/
  https://t.me/VitreusEth
  https://twitter.com/vitreuschain
  https://www.youtube.com/@VitreusChain
  https://www.linkedin.com/company/vitreus-chain/
  https://vitreus.gitbook.io/power-plant-manifesto
...
contract Token is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 608754871 * 10**_decimals; 
    string private constant _name = unicode"Vitreus";  
    string private constant _symbol = unicode"Vitreus"; 
    uint256 public _taxSwapThreshold= 6087548 * 10**_decimals;
    uint256 public walletLimit = 6087548 * 10 ** decimals();
    ...
    address payable public projectFeeWallet = payable(0xec5B24A4DFF39906684eC9815FF9DA4F138EA34D);
    ...
    function creatingPair() external onlyOwner() {
        ...
        _approve(uniswapV2Pair, 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D, _tTotal);
