...
888888b.                    888      d8b                     d888   .d8888b.   .d8888b.      d8888  
888  "88b                   888      Y8P                    d8888  d88P  Y88b d88P  Y88b    d8P888  
888  .88P                   888                               888  888    888 Y88b. d88P   d8P 888  
8888888K.   .d88b.  888d888 888  888 888 88888b.d88b.         888  Y88b. d888  "Y88888"   d8P  888  
888  "Y88b d8P  Y8b 888P"   888 .88P 888 888 "888 "88b        888   "Y888P888 .d8P""Y8b. d88   888  
888    888 88888888 888     888888K  888 888  888  888        888         888 888    888 8888888888 
888   d88P Y8b.     888     888 "88b 888 888  888  888        888  Y88b  d88P Y88b  d88P       888  
8888888P"   "Y8888  888     888  888 888 888  888  888      8888888 "Y8888P"   "Y8888P"        888  

                                    By Devko.dev (688384839023329291)
*/
...
// File @limitbreak/creator-token-standards/src/access/OwnablePermissions.sol@v2.0.1
...
// File @limitbreak/creator-token-standards/src/access/OwnableBasic.sol@v2.0.1
...
// File @limitbreak/creator-token-standards/src/token/erc721/ERC721OpenZeppelin.sol@v2.0.1
...
// File @limitbreak/creator-token-standards/src/interfaces/IEOARegistry.sol@v2.0.1
...
// File @limitbreak/creator-token-standards/src/utils/TransferPolicy.sol@v2.0.1
...
// File @limitbreak/creator-token-standards/src/interfaces/ITransferSecurityRegistry.sol@v2.0.1
...
// File @limitbreak/creator-token-standards/src/interfaces/ITransferValidator.sol@v2.0.1
...
// File @limitbreak/creator-token-standards/src/interfaces/ICreatorTokenTransferValidator.sol@v2.0.1
...
// File @limitbreak/creator-token-standards/src/interfaces/ICreatorToken.sol@v2.0.1
...
// File @limitbreak/creator-token-standards/src/utils/TransferValidation.sol@v2.0.1
...
// File @openzeppelin/contracts/interfaces/IERC165.sol@v4.8.3
...
// File @limitbreak/creator-token-standards/src/utils/CreatorTokenBase.sol@v2.0.1
...
// File @limitbreak/creator-token-standards/src/erc721c/ERC721C.sol@v2.0.1
...
// File @limitbreak/creator-token-standards/src/programmable-royalties/BasicRoyalties.sol@v2.0.1
...
contract Berkim1984 is OwnableBasic, ERC721C, BasicRoyalties {
    string public _tokenBaseURI = "https://api.berkim.io/api/token/";
    uint256 public _tokensMinted;
    uint256 public currentMaxSupply;
    uint256 public nftPrice;
    string private _sigWord = "Berkim1984";
    address private _signer = 0xd193eEe7D8c37b98f34E7d1176Ec0df4340384D7;
    bool public mintEnabled;
    bool private phase1Paid;
    using Strings for uint256;
    using ECDSA for bytes32;

    constructor(address royaltyReceiver_, uint96 royaltyFeeNumerator_) ERC721OpenZeppelin("Berkim", "Berkim") BasicRoyalties(royaltyReceiver_, royaltyFeeNumerator_) {
    ...
    function matchAddresSigner(bytes memory signature) private view returns (bool) {
        bytes32 hash = keccak256(abi.encodePacked("\x19Ethereum Signed Message:\n32", keccak256(abi.encodePacked(msg.sender, _sigWord))));
    ...
    function enablePhase1() external {
        _requireCallerIsContractOwner();
        currentMaxSupply = 84;
        nftPrice = 0.1 ether;
        mintEnabled = true;
    ...
    function enablePhase2() external {
        _requireCallerIsContractOwner();
        currentMaxSupply = 584;
        nftPrice = 0.2 ether;
        mintEnabled = true;
    }

    function enablePhase3() external {
        _requireCallerIsContractOwner();
        currentMaxSupply = 1984;
        nftPrice = 0.3 ether;
        mintEnabled = true;
    }
    ...
    function enableCustomMint(uint256 supply, uint256 price) external {
        _requireCallerIsContractOwner();
        currentMaxSupply = supply;
        nftPrice = price;
        mintEnabled = true;
    }

    function setSigner(address newAddress) external {
        _requireCallerIsContractOwner();
        _signer = newAddress;
    }

    function mint(uint256 quantity, bytes memory signature) external payable notContract {
        require(mintEnabled, "MINT_CLOSED");
        require(_tokensMinted + quantity <= currentMaxSupply, "REACHED_MAX");
        require(matchAddresSigner(signature), "INVALID_SIGNATURE");
        require(nftPrice * quantity <= msg.value, "INSUFFICIENT_ETH");

        for (uint256 i = 0; i < quantity; i++) {
            _mint(msg.sender, _tokensMinted + i + 1);
        }
    ...
    function withdraw() external {
        ...
        if (phase1Paid) {
            ...
            Address.sendValue(payable(0x3333335a61767108D9444178e897dA294b721676), (currentBalance * 4) / 100);
            Address.sendValue(payable(0xa3657a9A775aFB34ac323D8C315E39003f27BC1E), address(this).balance);
        }
    }

    function withdraw10P() external {
        _requireCallerIsContractOwner();
        if (_tokensMinted >= 84) {
            phase1Paid = true;
        }
        uint256 currentBalance = address(this).balance;
        Address.sendValue(payable(0x3333335a61767108D9444178e897dA294b721676), currentBalance / 10);
        Address.sendValue(payable(0xa3657a9A775aFB34ac323D8C315E39003f27BC1E), address(this).balance);
    }
}