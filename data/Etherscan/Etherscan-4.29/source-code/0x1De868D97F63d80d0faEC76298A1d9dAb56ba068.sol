...
contract NolandArbaugh is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Noland Arbaugh";
    string private constant _symbol = unicode"NOLAND";
