...
contract Multitensor is Ownable, IERC20Metadata, IERC20Errors, ICommonError {
    ...
    address public projectOwner = 0xB9c25fFd97ae5785205097cF97f1A03939ae4F51;
    address public marketingReceiver = 0xCb1B86Eec66970Ce6a96B313a812c243bBD89262;
    ...
    function manualRedeem(uint256 amountToRedeem) external swapping onlyOwner {
        if (amountToRedeem > circulatingSupply() * 1000 / FEEDENOMINATOR) {
