...
/*
Website: https://layertao.io/
X: https://twitter.com/LayerTAO
Telegram : https://t.me/LayerTao
*/
...
contract LayerTAO is ERC20, Ownable {
    ...
    constructor () ERC20("LayerTAO", "LAO") 
    {   
        address router;
        address pinkLock;
        ...
        feeReceiver = 0xe9612ad9CD0E0ec15DD1DBE9056CBe21b1C2553b;
    ...
    function updateFees(uint256 _feeOnSell, uint256 _feeOnBuy) external onlyOwner {
        ...
        require(feeOnBuy <= 30, "CSLT: Total Fees cannot exceed the maximum");
