...
"""
@title Cove depositor
@license MIT
@notice Deposits YFI into the Cove liquid locker and stakes the tokens to receive sCoveYFI
...
def __init__(_locking_token: address, _liquid_locker: address, _staking: address, _owner: address):
    ...
    @param _liquid_locker CoveYFI address
    @param _staking sCoveYFI address
