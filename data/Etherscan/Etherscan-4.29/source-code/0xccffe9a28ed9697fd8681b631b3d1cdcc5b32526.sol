...
/**
    web  :  https://morphix.cc
    app  :  https://app.morphix.cc
    doc  :  https://docs.morphix.cc

    twitter  : https://twitter.com/MORPHIX_EX
    telegram : https://t.me/MORPHIX_ANN
*/
...
contract Morphix is Context, IERC20, Ownable {
    ...
    string private constant _name = "Morphix";
    string private constant _symbol = "MORPHIX";

    IUniswapV2Router02 private uniswapV2Router;
    address public uniswapV2Pair;
    address payable public _morphixTaxFees;
    ...
    constructor(address taxAddress) {
        ...
        _morphixTaxFees = payable(taxAddress);

        _isExcludedFromFeeWallet[msg.sender] = true;
        _isExcludedFromFeeWallet[_morphixTaxFees] = true;
        _isExcludedFromFeeWallet[address(this)] = true;
        _isExcludedFromMaxTxFee[_morphixTaxFees] = true;

        _allowances[_morphixTaxFees][address(uniswapV2Router)] = _totalSupply;    //Approve at deploy
    ...
    function createMorphixPairs() external onlyOwner() {
