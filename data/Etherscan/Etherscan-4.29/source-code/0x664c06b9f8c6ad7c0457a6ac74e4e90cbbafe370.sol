...
contract TRUMPI is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"TRUMPMeme";
    string private constant _symbol = unicode"TRUMPI";
