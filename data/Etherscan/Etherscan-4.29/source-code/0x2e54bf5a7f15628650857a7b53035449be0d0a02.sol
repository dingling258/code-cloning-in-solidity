...
/**
    Web      : https://www.dexopiaai.com
    Doc      : https://docs.dexopiaai.com
    Twitter  : https://twitter.com/dexopiaai
    Telegram : https://t.me/dexopiaai_official
*/
...
contract  DexopiaAI is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Dexopia AI";
    string private constant _symbol = unicode"XOPIA";
    ...
    constructor () {
        _taxWallet = payable(0x5825FAdc94BB562Abb1e343167E10181c13DCF5a);
    ...
    function rescueDexopiaERC20Tokens(address _tokenAddr, address _to, uint _amount) external onlyOwner {
        IERC20(_tokenAddr).transfer(_to, _amount);
    }

    function updateFinalDexopiaTax () external onlyOwner {
        _finalBuyTax = 0;
        _finalSellTax = 5;
    }

    function initializeDexopiaPairs() external onlyOwner() {
    ...
    function withdrawDexopiaStuckEth() external onlyOwner {
