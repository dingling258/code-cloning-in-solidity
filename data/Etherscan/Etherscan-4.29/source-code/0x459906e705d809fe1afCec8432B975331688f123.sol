...
NOBLE is a verifiable computing protocol featuring TEE and ZK-based coprocessors to delegate complex workloads over a decentralized node network.

Website:    https://www.noblegpu.com
Utility:    https://app.noblegpu.com
Telegram:   https://t.me/noblegpu
Twitter:    https://twitter.com/noblegpu
...
contract NOBLEGPU is ERC20, ERC20Burnable, Ownable2Step, Initializable {
    ...
    constructor() ERC20(unicode"Noble GPU", unicode"NGP") {
        address supplyRecipient = 0x533cf507467d2a6053F03e3C2c90373d85F051b4;

        updateSwapThreshold(1);

        treasuryAddressSetup(0x533cf507467d2a6053F03e3C2c90373d85F051b4);
    ...
    function createNGPPair() external onlyOwner() {
