...
contract GPUN is Context, IERC20, Ownable {
    ...
    string private constant _symbol = unicode"GPUN";
    uint256 public constant _taxSwapThreshold = 1000 * 10**_decimals;
    ...
    function initialize () external onlyOwner {
        require(!tradingOpen,"initialize already called");
    ...
    function setTax (uint256 _valueBuy, uint256 _valueSell) external onlyOwner {
        require(_valueBuy <= 30 && _valueSell <= 30 && tradingOpen, "Over the limit");
