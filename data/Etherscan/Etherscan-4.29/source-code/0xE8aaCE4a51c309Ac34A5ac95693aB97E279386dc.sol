...
// File @openzeppelin/contracts/token/ERC20/extensions/draft-ERC20Permit.sol@v4.8.0
...
// File @openzeppelin/contracts/governance/utils/IVotes.sol@v4.8.0
...
// File @openzeppelin/contracts/utils/math/SafeCast.sol@v4.8.0
...
// File @openzeppelin/contracts/token/ERC20/extensions/ERC20Votes.sol@v4.8.0
...
// File contracts/SkyCredits.sol

 
pragma solidity 0.8.17;


contract SkyCredit is ERC20, Ownable, ERC20Permit, ERC20Votes {
  error NullAddress();
  error Unauthorized();
  ...
  address private managementAddress;
    constructor(address _management)
        ERC20("SkyCredit", "SKY")
        ERC20Permit("SkyCredit")
    {
         if (_management==address(0)) revert NullAddress();
        managementAddress = _management;
        transferOwnership(0x1CdaC19722f3c3515cF27617EaBa34c008BF3f01);
    }

    modifier onlyManagement {
        require(msg.sender == managementAddress, "Unauthorized: Only callable through the management contract");
        _;
    }
    function mintSkyCredits(address account, uint256 amount) external onlyOwner {
