    ...
    Ownable
{
	...
	string private constant _name = unicode"POWER SUPPLY";
	string private constant _symbol = unicode"POWRS";
 ...
 function OpenTrad() external onlyOwner {
    ...
    function OpenPairs() external onlyOwner {
    ...
    function RemovLimites() external onlyOwner {
