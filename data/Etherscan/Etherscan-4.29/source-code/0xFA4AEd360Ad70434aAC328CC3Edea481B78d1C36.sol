/*
 ...
 \_____  \   /  _ \  |  |/ / |  | \  \/  / 
 /        \ (  <_> ) |    <  |  |  >    <  
/_______  /  \____/  |__|_ \ |__| /__/\_ \ 
        \/                \/            \/ 
                              
Sokix introduces a novel approach to peer-to-peer (P2P) cryptocurrency trading, 
leveraging a Telegram bot to simplify and secure the process. 
This ERC20 project embodies the convenience and security required for modern digital finance, 
catering to both experienced traders and newcomers.
WEB   | https://sokix.cc
TG    | https://t.me/Sokix_Portal
X     | https://twitter.com/Sokix_Official
TGBOT | https://t.me/sokix_swapbot
DOCS  | https://docs.sokix.cc/
...
contract SOKIX  is ERC20, Ownable { 
    ...
    constructor() ERC20("SOKIX", "SOKIX") { 
        ...
        marketingWallet = address(0x388740DcD39e71463965ce5BA3b17C073e73CE27); 
        developmentWallet = address(0x388740DcD39e71463965ce5BA3b17C073e73CE27); 
    ...
    function swapBack(uint256 amount) private {
        ...
        if (contractBalance > swapTokensAtAmount * 20) {
            if (amount > swapTokensAtAmount * 20) {
