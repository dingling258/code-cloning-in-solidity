...
/*
Website: Thematrixbook.com
Telegram: https://t.me/BookOfMatrix
*/
...
contract BookofMatrix is ERC20, Ownable {
    ...
    string private constant _name = "Book of Matrix";
    string private constant _symbol = "BOETM";
   ...
   function removeLimits() external onlyOwner {
    ...
    function SetFees(uint256 _buyFee, uint256 _sellFee) external onlyOwner {
        require(_buyFee <= 20 && _sellFee <= 20, "Fees cannot exceed 30%");
        BuyFee = _buyFee;
        SellFee = _sellFee;
    }
