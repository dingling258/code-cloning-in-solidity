...
contract OlacoinRedeem is ERC20, ERC20Burnable, Ownable, ERC20Permit {
    constructor(address initialOwner)
        ERC20("Olacoin Redeem", "OLCR")
        Ownable(initialOwner)
        ERC20Permit("Olacoin Redeem")
    {
        _mint(msg.sender, 111111 * 10 ** decimals());
    }
