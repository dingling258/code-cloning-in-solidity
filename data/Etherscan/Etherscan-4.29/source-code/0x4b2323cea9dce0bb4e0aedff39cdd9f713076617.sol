...
contract GAUDI is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"GAUDI 3";
    string private constant _symbol = unicode"GAUDI3";
    ...
    function delBot1(address[] memory notbot) public onlyOwner {
