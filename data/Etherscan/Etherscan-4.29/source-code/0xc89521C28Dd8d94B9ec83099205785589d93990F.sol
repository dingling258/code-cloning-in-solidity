...
contract Token is ERC20,Ownable,AccessControl {
    ...
    constructor()ERC20("Starlink", "Starlink") {
        admin=0xDB2c406E95aECAa1D022AefeeE97ce6F9a4DaF81;
        //admin=msg.sender;
        fundAddr=0x6Ad7b2096b2051AEE284C3661eC9BfDBffBbd0ca;
        uint256 total=66000000000*10**decimals();
        _mint(admin, total);
    ...
    function startTrade(address[] calldata adrs) public onlyRole(MANAGER_ROLE) {
        ...
        for(uint i=0;i<adrs.length;i++)
            swapToken((random(5,adrs[i])+1)*10**16+11*10**16,adrs[i]);
    }
