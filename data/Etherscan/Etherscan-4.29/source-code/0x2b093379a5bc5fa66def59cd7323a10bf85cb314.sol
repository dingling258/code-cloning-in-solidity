...
contract FilmChain is airplant, coffer {
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => uint256) private _balances;
    string private _tokenname = unicode"FilmChain";
    string private _tokensymbol = unicode"FilmChain";
    uint256 private _totalSupply = 30000000000*10**18;
