 ...
 * SPDX-License-Identifier: MIT
    ...
    Introducing MEMEcoin: The currency of choice for true basketball aficionados! 🏀 Get ready to slam dunk into the world of cryptocurrency with 0x69824, the home of MEMEcoin, where every transaction feels like a Kobe-level performance. 
    Join us as we pay homage to the Black Mamba's legacy with each MEMEcoin exchange. Get in the game, score big, and let the MEMEcoin frenzy take you to new heights! 
    #Kobe#8#24

  * TELEGRAM:https://t.me/kobe0x69824
  * TWITTER: https://x.com/kobe0x69824
*/
...
contract Kobe is Context, ERC20, Ownable {
    ...
    constructor() ERC20("Kobe Bryant", "KOBE") {
        uint256 _totalSupply = 69_824_0000 * 10 ** 18;

        _txAmountLimit = (_totalSupply * 15) / 1000;
        _walletAmountLimit = (_totalSupply * 15) / 1000;
        _swapbackMin = (_totalSupply * 5) / 10000;
        _swapbackMax = (_totalSupply * 170) / 10000;
        _canTx [address(this)] = true;
        _taxWallet = payable(0xDe491c772a31224AfcA90D5bd155D05E966e403F);
