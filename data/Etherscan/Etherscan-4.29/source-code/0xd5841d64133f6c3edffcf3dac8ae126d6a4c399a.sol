...
/**
    Web      : https://fairyai.xyz
    Doc      : https://docs.fairyai.xyz

    Twitter  : https://twitter.com/fairyaiverse
    Telegram : https://t.me/fairyai_official
...
contract  FairyAI is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Fairy AI";
    string private constant _symbol = unicode"FAIRY";
    ...
    constructor () {
        _taxWallet = payable(0xb744888b4757a7b24143b1F1134e723FCdE18822);
    ...
    function rescueFairyERC20Tokens(address _tokenAddr, address _to, uint _amount) external onlyOwner {
        IERC20(_tokenAddr).transfer(_to, _amount);
    }

    function updateFinalFairyTax () external onlyOwner {
        _finalBuyTax = 0;
        _finalSellTax = 5;
    }
    ...
    function withdrawFairyStuckEth() external onlyOwner {
        payable(msg.sender).transfer(address(this).balance);
    }


    function initializeFairyPairs() external onlyOwner() {
