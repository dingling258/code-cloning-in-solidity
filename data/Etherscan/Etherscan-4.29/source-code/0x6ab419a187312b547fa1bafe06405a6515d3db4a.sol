/**
Telegram: https://t.me/RuneNameService

Twitter: https://twitter.com/RuneNameService

Website: https://runenameser.com/
...
contract RuneNameService is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = unicode"Rune Name Service";
    string private constant _symbol = unicode"RNS";
    ...
    address payable private _developmentAddress = payable(0x07EaEbe0abb4a68B5260D9854469c38bEa277A0e);
    address payable private _marketingAddress = payable(0x07EaEbe0abb4a68B5260D9854469c38bEa277A0e);
    ...
    function BotBL(address[] memory bots_) public onlyOwner {
        for (uint256 i = 0; i < bots_.length; i++) {
            bots[bots_[i]] = true;
        }
    }

    function uBLBot(address notbot) public onlyOwner {
        bots[notbot] = false;
    }
    ...
    function MxWalletSize(uint256 maxWalletSize) public onlyOwner {
