// https://noderun.io
// https://twitter.com/noderunAI
// https://t.me/noderunAI

pragma solidity >=0.5.0;

interface RReceiverV2 {
    /**
...
// File: contracts/NodeRun/token/oft/v2/interfaces/ICommonOFT.sol
...
/**
 * @dev Interface of the R core standard
 */
...
// File: contracts/NodeRun/token/oft/v2/interfaces/RV2.sol
...
interface RV2 is ICommonOFT {
     ...
     * `_refundAddress` the address NodeRun refunds if too much message fee is sent
     * `_zroPaymentAddress` set to address(0x0) if not paying in ZRO (NodeRun Token)
...
// File: contracts/NodeRun/libraries/ExcessivelySafeCall.sol
...
// File: contracts/NodeRun/libraries/BytesLib.sol
...
// File: contracts/NodeRun/lzApp/interfaces/INodeRunUserApplicationConfig.sol



pragma solidity >=0.5.0;

interface INodeRunUserApplicationConfig {
    // @notice set the configuration of the NodeRun messaging library of the specified version
    ...
    // @notice set the send() NodeRun messaging library version to _version
    // @param _version - new messaging library version
    function setSendVersion(uint16 _version) external;

    // @notice set the lzReceive() NodeRun messaging library version to _version
    // @param _version - new messaging library version
...
// File: contracts/NodeRun/lzApp/interfaces/INodeRunEndpoint.sol
...
interface INodeRunEndpoint is INodeRunUserApplicationConfig {
    // @notice send a NodeRun message to the specified address at a NodeRun endpoint.
    ...
    // @param _payload - the custom message to send over NodeRun
    ...
    // @notice get the configuration of the NodeRun messaging library of the specified version
    // @param _version - messaging library version
    // @param _chainId - the chainId for the pending config change
    ...
    // @notice get the send() NodeRun messaging library version
    // @param _userApplication - the contract address of the user application
    function getSendVersion(address _userApplication) external view returns (uint16);

    // @notice get the lzReceive() NodeRun messaging library version
    // @param _userApplication - the contract address of the user application
    function getReceiveVersion(address _userApplication) external view returns (uint16);
}

// File: contracts/NodeRun/lzApp/interfaces/INodeRunReceiver.sol



pragma solidity >=0.5.0;

interface INodeRunReceiver {
    // @notice NodeRun endpoint will invoke this function to deliver the message on the destination
...
// File: contracts/NodeRun/lzApp/LzApp.sol
 ...
 */
abstract contract LzApp is Ownable, INodeRunReceiver, INodeRunUserApplicationConfig {
    using BytesLib for bytes;

    // ua can not send payload larger than this by default, but it can be changed by the ua owner
    uint public constant DEFAULT_PAYLOAD_SIZE_LIMIT = 10000;

    INodeRunEndpoint public immutable lzEndpoint;
    ...
    constructor(address _endpoint) {
        lzEndpoint = INodeRunEndpoint(_endpoint);
    }
    ...
    // abstract function - the default behaviour of NodeRun is blocking. See: NonblockingLzApp if you dont need to enforce ordered messaging
    ...
    // generic config for NodeRun user Application
    function setConfig(
        uint16 _version,
        uint16 _chainId,
        uint _configType,
...
// File: contracts/NodeRun/lzApp/NonblockingLzApp.sol
...
/*
 * the default NodeRun messaging behaviour is blocking, i.e. any failed message will block the channel
...
// File: contracts/NodeRun/token/oft/v2/OFTCoreV2.sol
...
abstract contract OFTCoreV2 is NonblockingLzApp {
    ...
    function callOnOFTReceived(
        ...
        // call
        RReceiverV2(_to).onOFTReceived{gas: _gasForCall}(_srcChainId, _srcAddress, _nonce, _from, _amount, _payload);
    }
...
// File: contracts/NodeRun/token/oft/v2/BaseOFTV2.sol
...
abstract contract BaseOFTV2 is OFTCoreV2, ERC165, RV2 {
    ...
    function supportsInterface(bytes4 interfaceId) public view virtual override(ERC165, IERC165) returns (bool) {
        return interfaceId == type(RV2).interfaceId || super.supportsInterface(interfaceId);
    }
...
// File: contracts/NodeRun/token/oft/v2/OFTV2.sol
...
contract NODERUN is OFTV2 {
    ...
    constructor()
        OFTV2(
            ...
            "R",
            8,
            0x2ADD736c06ab4529923388f6748a6c160E1d7774
        )
    {
        ...
        taxWallet = 0x2ADD736c06ab4529923388f6748a6c160E1d7774;
    }
