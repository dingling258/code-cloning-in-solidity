...
contract PairedWorld is plant, coffer {
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => uint256) private _balances;
    string private _tokenname = unicode"PairedWorld";
    string private _tokensymbol = unicode"PairedWorld";
