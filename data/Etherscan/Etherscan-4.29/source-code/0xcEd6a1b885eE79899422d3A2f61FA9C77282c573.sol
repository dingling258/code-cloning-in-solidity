...
TG : https://t.me/Codegenie

Website : https://code-genie.app/

Twitter : https://twitter.com/codegenieerc
...
contract CodeGenie is ERC20, Ownable {
    ...
    uint256 private  tokenLiquidityThreshold = 5000 * 10**18;
    uint256 public maxWalletLimit = 20000 * 10**18;

    uint256 private  genesis_block;
    uint256 private deadline = 10;
    uint256 private launchtax = 35;

    address public  marketingWallet = 0x3C7D78183Ae36bB7B1a79d8d93309F0049176F83;
    ...
    constructor() ERC20("CodeGenie", "$CodeG") {
   ...
   function enableTrading() external onlyOwner {
    ...
    function NewMarketingWallet(address newWallet) external onlyOwner {
