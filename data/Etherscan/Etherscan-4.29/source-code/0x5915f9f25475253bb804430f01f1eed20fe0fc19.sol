...
https://t.me/elsaprint

https://twitter.com/elsaprinteth
...
contract Elsaprint is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Elsa Print";
    string private constant _symbol = unicode"ELSAP";
    ...
    function tradeELSAP() external onlyOwner() {
