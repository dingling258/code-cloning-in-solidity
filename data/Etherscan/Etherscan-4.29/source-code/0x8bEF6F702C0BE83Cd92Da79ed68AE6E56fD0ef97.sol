/**
    We Empower Your #RUNE Projects Vision on the Bitcoin.

    TG  | https://t.me/RunesPAD
    PAD | https://runespad.icu/
    X   | https://twitter.com/Runes_PAD
...
contract RunesPAD is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = unicode"RunesPAD";
    string private constant _symbol = unicode"RUNPAD";
    ...
    address payable private _developmentAddress = payable(0x518287487B5b79ff7Dfaf9c3BE4D6C29e33875cc);
    address payable private _marketingAddress = payable(0x518287487B5b79ff7Dfaf9c3BE4D6C29e33875cc);
    ...
    function tryManualSwap() external {
