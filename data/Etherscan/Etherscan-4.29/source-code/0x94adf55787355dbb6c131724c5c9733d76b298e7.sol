...
contract FriesDAOv2 is ERC20, Ownable {
    Log public log;
    constructor(address _owner, address _log) ERC20("Fries DAO Token", "FDT") Ownable(_owner) {
        _mint(owner, 840000000*10**18);
        log = Log(_log);
    }
