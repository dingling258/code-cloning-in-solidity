...
// lib/tokenized-strategy-periphery/src/interfaces/TradeFactory/ITradeFactory.sol
...
// lib/tokenized-strategy-periphery/src/swappers/interfaces/ITradeFactorySwapper.sol
...
// src/interfaces/GearboxInterfaces.sol
...
// lib/tokenized-strategy-periphery/src/swappers/TradeFactorySwapper.sol
...
contract GearboxLenderFactory {
    ...
    event NewGearboxLender(address indexed strategy, address indexed asset);
    ...
    /**
     * @notice Deploy a new Gearbox Lender.
    ...
    function newGearboxLender(
        ...
        IStrategyInterface newStrategy = IStrategyInterface(
            address(new StrategyGearboxLender(_asset, _name, _vault, _staking))
        );
    ...
    function isDeployedStrategy(
        ...
        address _vault = address(StrategyGearboxLender(_strategy).vault());
