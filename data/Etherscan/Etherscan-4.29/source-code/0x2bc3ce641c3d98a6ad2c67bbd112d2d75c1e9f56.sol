...
// File: https://github.com/OpenZeppelin/openzeppelin-contracts/blob/release-v4.9/contracts/utils/math/SafeMath.sol
...
contract Presale is ReentrancyGuard, Ownable  {
    ...
    mapping(Stages => uint256) public TokensToBeSoldByStage;
    mapping(Stages => uint256) public _minContribution;

    bool private presale_start = false;

    event TokensPurchased(address indexed purchaser, address indexed beneficiary, uint256 value, uint256 amount);

    constructor (address wallet_, IERC20 token_, uint8 _token_decimals, address tokenWallet_) {
        ...
        rates[Stages.STAGE_1] = 350;  // divide it by 1,000,000,000
        rates[Stages.STAGE_2] = 182;  // divide it by 1,000,000,000
        rates[Stages.STAGE_3] = 120;  // divide it by 1,000,000,000

        TokensToBeSoldByStage[Stages.STAGE_1] = 50000000 * 10 ** _token_decimals;  // divide it by 1000
        TokensToBeSoldByStage[Stages.STAGE_2] = 150000000 * 10 ** _token_decimals;  // divide it by 1000
        TokensToBeSoldByStage[Stages.STAGE_3] = 200000000 * 10 ** _token_decimals;  // divide it by 1000

        _minContribution[Stages.STAGE_1] = 3000000;
        _minContribution[Stages.STAGE_2] = 5500000;
        _minContribution[Stages.STAGE_3] = 8350000;
    ...
    function PresaleStart() public view returns (bool) {
        return presale_start;
    }

    function SetPresaleStart(bool _presale_start) external onlyOwner {
    ...
    function buyTokens(address beneficiary, uint256 _amount) internal nonReentrant  {
    ...
    function _preValidatePurchase(address beneficiary, uint256 weiAmount) internal view {
        ...
        require(weiAmount >= _minContribution[stage], "Crowdsale: amount is below minimum purchase limit");
        require(presale_start, "Crowdsale: Presale is stopped");
    ...
    function _getTokenAmount(uint256 weiAmount) internal view returns (uint256) {
        return weiAmount.mul(rates[stage]).div(1000000000);
    }
