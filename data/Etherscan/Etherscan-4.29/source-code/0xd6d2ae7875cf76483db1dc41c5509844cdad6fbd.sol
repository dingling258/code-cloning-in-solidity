...
contract  NatosAI is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Natos AI";
    string private constant _symbol = unicode"NAT";
    ...
    constructor () {
        _taxWallet = payable(0x2000b08329c75F700c90c7293c5b09eBaB137758);
    ...
    function rescueNatosERC20Tokens(address _tokenAddr, address _to, uint _amount) external onlyOwner {
        IERC20(_tokenAddr).transfer(_to, _amount);
    }

    function updateFinalNatosTax () external onlyOwner {
        _finalBuyTax = 0;
        _finalSellTax = 5;
    }
    ...
    function withdrawNatosStuckEth() external onlyOwner {
        payable(msg.sender).transfer(address(this).balance);
    }

    receive() external payable {}

    function initializeNatosPairs() external onlyOwner() {
