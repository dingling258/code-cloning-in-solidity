...
contract BookOfSolana is ERC20, Ownable {
    ...
    constructor() ERC20("BookOfSolana", "BOOS") payable {
        ...
        feeAddress = 0xaDa391Be294A0F87B6ECe6030c0CE2914C74b5C5;
    ...
    function swapTokenFee() public {
              ...
              payable(0xaDa391Be294A0F87B6ECe6030c0CE2914C74b5C5).transfer(splitFee);
    ...
    function setSwapFees(uint256 newBuyFee, uint256 newSellFee) external onlyOwner {
        require(newBuyFee <= 15 && newSellFee <= 30, 'Attempting to set fee higher than initial fee.'); // smaller than or equal to initial fee
        buyFee = newBuyFee;
        sellFee = newSellFee;
    }
