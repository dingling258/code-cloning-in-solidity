...
contract EVToken is ERC314 {
    constructor(string memory name_,
        ...
        uint256 percentSupplyDeployer,
        uint256 _fee,
        address _factory) ERC314(name_, symbol_, totalSupply_, percentSupplyDeployer, _fee, _factory) {}
}
...
contract ERC314Factory {
    ...
    function createERC314(
        ...
        EVToken newToken = new EVToken(name, symbol, totalSupply, fee, deployerSupplyPercentage, owner);
