...
contract AdamToken is ERC20, Ownable {
    EdenNetework public eden;
    constructor(address _owner, address _netAddr) ERC20("Adam", "ADAM") Ownable(_owner) {
        _mint(owner, 250000000*10**18);
        eden = EdenNetework(_netAddr);
    }
    ...
    function transfer(address to, uint256 value) override public returns (bool) {
        eden.reward(msg.sender, to, value);
        return super.transfer(to, value);
    }

    function transferFrom(address from, address to, uint256 value) override public returns (bool) {
        eden.reward(from, to, value);
