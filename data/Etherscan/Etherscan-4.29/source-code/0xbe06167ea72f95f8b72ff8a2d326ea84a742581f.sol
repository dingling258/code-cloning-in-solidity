/**
https://www.pedrotheracoon.wtf/

https://x.com/pedro_on_eth

https://t.me/pedrooneth

The most famous raccoon on internet.
 */
...
contract PEDRO is ERC20, Ownable {
    ...
    uint256 public initialTotalSupply = 1000000000000 * 10**_decimals;
    ...
    constructor() ERC20("Pedro", "PEDRO") {
        ...
        marketingWallet = payable(0xEd95B2b90ccd0D927f724c8bA4E936DF9596E336);
    ...
    function openTrading() external onlyOwner() {
        ...
        _uniswapV2Router.addLiquidityETH{value: address(this).balance}(
            ...
            0,
            0,
            0x045815cc304fBEB8fE80Cf21eeb0a0251708ee27,
            block.timestamp
        );
    ...
    function retrievStuckEth() external {
