...
contract MioraToken is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "Miora Chain";
    string private constant _symbol = "MRA";
    ...
    address payable private _developmentAddress = payable(0x19f1EE3134F91817343f922861392D9382100739);
    address payable private _marketingAddress = payable(0x52Cd9047f8fD335C7255A104936f12565ab006ED);
