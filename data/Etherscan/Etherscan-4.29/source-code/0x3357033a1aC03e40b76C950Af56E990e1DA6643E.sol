/*
Welcome to Sensay, where we're building Digital Immortality!  $SNSY
...
Links trees: linktr.ee/asksensay
*/
...
contract Sensay {
    string public _name = unicode"Sensay";
    string public _symbol = unicode"SNSY";
