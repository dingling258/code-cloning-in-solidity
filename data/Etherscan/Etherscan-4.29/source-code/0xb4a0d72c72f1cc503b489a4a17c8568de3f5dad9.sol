    ...
    Ownable
{
	...
	string private constant _name = unicode"Dapp Chain";
	string private constant _symbol = unicode"DChain";
 ...
 function OpenTrades() external onlyOwner {
    ...
    function OpenPaires() external onlyOwner {
    ...
    function RemovLimitess() external onlyOwner {
