...
Let’s collaborate, innovate, and shape the future of crypto together. All enthusiasts, learners, and innovators!
*/
...
contract NEXA is Context, IERC20, Ownable {
    ...
    string  private constant _name   = unicode"NexaChain";
    string  private constant _symbol = unicode"NEXA";
    ...
    function RouterInitial () external onlyOwner {
