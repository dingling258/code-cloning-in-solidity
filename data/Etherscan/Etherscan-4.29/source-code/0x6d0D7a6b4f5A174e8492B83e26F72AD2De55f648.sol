...
contract WECMB is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"What Else Could Memecoins Be?";
    string private constant _symbol = unicode"WECMB";
