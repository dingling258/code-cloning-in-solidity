...
contract ATA is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Artify AI";
    string private constant _symbol = unicode"ATA";
    uint256 public _maxTxAmount = 8000 * 10**_decimals;
    uint256 public _maxWalletSize = 8000 * 10**_decimals;
