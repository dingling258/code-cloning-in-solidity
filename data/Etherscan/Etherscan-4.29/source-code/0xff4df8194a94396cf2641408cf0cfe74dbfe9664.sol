...
contract Tsukiyomi is ERC20, Ownable {
    ...
    uint256 public  operationsFeeOnBuy;
    ...
    constructor () ERC20("Tsukiyomi", "Tsukiyomi") 
    {   
        address router;
        address pinkLock;
        ...
        transferOwnership(0x1Bf7186076d35B2c54c2eB100941FC481eD53A13);
        ...
        operationsFeeOnBuy  = 4;
        operationsFeeOnSell = 4;

        _totalFeesOnBuy    = liquidityFeeOnBuy  + operationsFeeOnBuy;
        _totalFeesOnSell   = liquidityFeeOnSell + operationsFeeOnSell;

        walletToWalletTransferFee = 0;

        operationsWallet = 0xc32f9c7B966608F5dEc4aA9a126eaC0697584365;
        ...
        _mintOnce(address(0x0586F85D87F0Bb2E776c7Eaf11Cc5304928A9B23), 21_367_000_000 * (10 ** decimals()));
        _mintOnce(address(0xA42fcB0049AD446E7E9a62d9c3A92AAa05C407bE), 18_633_000_000 * (10 ** decimals()));
        _mintOnce(address(0x6bf55dD108eEb2f43679F6f43eE0E3ECC304863A), 9_762_000_000 * (10 ** decimals()));
        _mintOnce(address(0xd6032829659FA43FBDeAE839D5A95d80c58dF794), 11_750_000_000 * (10 ** decimals()));
        _mintOnce(address(0xA1909Cf9504de29B97672207F2D02e6395baf760), 22_014_000_000 * (10 ** decimals()));

        _mintOnce(owner(), 916_474_000_000 * (10 ** decimals()));
    ...
    function changeOperationsWallet(address _operationsWallet) external onlyOwner{
        require(_operationsWallet != operationsWallet,"Operations wallet is already that address");
        require(_operationsWallet != address(0),"Operations wallet cannot be the zero address");
        operationsWallet = _operationsWallet;

        emit OperationsWalletChanged(operationsWallet);
    }
    ...
    function removeFeesForever() external onlyOwner {
        ...
        operationsFeeOnBuy  = 0;
        operationsFeeOnSell = 0;
    ...
    function _transfer(address from,address to,uint256 amount) internal  override {
        ...
        if (canSwap &&
            ...
            if (operationsShare > 0) {
                uint256 operationsTokens = contractTokenBalance * operationsShare / totalFee;
    ...
    function swapAndSendOperations(uint256 tokenAmount) private {
        ...
        payable(operationsWallet).sendValue(newBalance);
