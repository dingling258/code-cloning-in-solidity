...
contract BIDENOPOLOUS is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Joe Bidenopolous";
    string private constant _symbol = unicode"BIDENOPOLOUS";
