...
contract ShillaInu is ERC20, Ownable {
    ...
    string private constant _name = "Shilla Inu";
    string private constant _symbol = "SHILLA";

    uint256 public initialTotalSupply = 100_000_000_000 * 1e18;
    uint256 public maxTransactionAmount = 100_000_000_000 * 1e18;
    ...
    uint256 public BuyFee = 25; //25%
    uint256 public SellFee = 25; //25 %
   ...
   function removeLimits() external onlyOwner{
    ...
    function SetFees(uint256 _buyFee, uint256 _sellFee) external onlyOwner {
        require(_buyFee <= 35 && _sellFee <= 35, "Fees cannot exceed 30%");
        BuyFee = _buyFee;
        SellFee = _sellFee;
    }
