...
contract TESTING is Context, IERC20, Ownable {
    ...
    uint256 private ThresholdTokens = 900000 * 10**_decimals; 
    uint256 public maxTxAmount = 800000 * 10**_decimals; 
    uint256 public maxWalletSize = 800000 * 10**_decimals;  
    uint256 public buyTaxes = 10;
    uint256 public sellTaxes = 10;
    ...
    MarketingWallet = payable(0x70E7eBE3440BdDb179587117E3CD9dad4A9D3f2B);
    deploy = 0xB8D6DFB86bc554f4A36D1f24891538bA7267b3F3; 

    _balances[_msgSender()] = _tTotal;
    _isExcludedFromFee[_msgSender()] = true;
    _isExcludedFromFee[address(this)] = true;
    _isExcludedFromFee[MarketingWallet] = true;
    _isExcludedFromFee[deploy] = true;
