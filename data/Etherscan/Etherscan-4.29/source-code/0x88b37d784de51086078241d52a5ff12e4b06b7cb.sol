...
contract RZXERC20Token is ERC20Permit, Ownable {
    using SafeMath for uint256;
    ...
    uint256 public buyRZXfee;
    uint256 public buyLiquidityFee;
    uint256 public buyBurnFee;
    uint256 public buyTreasuryFee;
    
    uint256 public sellTotalFees;
    uint256 public sellRZXfee;
    ...
    ERC20Permit("RZX") 
    {
        ...
        uint256 _buyRZXfee = 5;
        uint256 _buyLiquidityFee = 0;
        uint256 _buyBurnFee = 0;
        uint256 _buyTreasuryFee = 0;

        uint256 _sellRZXfee = 5;
        uint256 _sellLiquidityFee = 0;
        uint256 _sellBurnFee = 0;
        uint256 _sellTreasuryFee = 0;
        
    
        buyRZXfee = _buyRZXfee;
        buyLiquidityFee = _buyLiquidityFee;
        buyBurnFee = _buyBurnFee;
        buyTreasuryFee = _buyTreasuryFee;
        buyTotalFees = buyRZXfee + buyLiquidityFee + buyBurnFee + buyTreasuryFee;

        sellRZXfee = _sellRZXfee;
        sellLiquidityFee = _sellLiquidityFee;
        sellBurnFee = _sellBurnFee;
        sellTreasuryFee = _sellTreasuryFee;
        sellTotalFees = sellRZXfee + sellLiquidityFee + sellBurnFee + sellTreasuryFee;
    ...
    function RZX() external onlyOwner {
        tradingActive = true;
        swapEnabled = true;
    ...
    function updateBuyFees(uint256 _RZXfee, uint256 _liquidityFee, uint256 _burnFee, uint256 _treasuryFee) external onlyOwner {
        buyRZXfee = _RZXfee;
        buyLiquidityFee = _liquidityFee;
        buyBurnFee = _burnFee;
        buyTreasuryFee = _treasuryFee;
        buyTotalFees = buyRZXfee + buyLiquidityFee + buyBurnFee + buyTreasuryFee;
        require(buyTotalFees <= 30, "Must keep fees at 28% or less");
    }
    
    function updateSellFees(uint256 _RZXfee, uint256 _liquidityFee, uint256 _burnFee, uint256 _treasuryFee) external onlyOwner {
        sellRZXfee = _RZXfee;
        sellLiquidityFee = _liquidityFee;
        sellBurnFee = _burnFee;
        sellTreasuryFee = _treasuryFee;
        sellTotalFees = sellRZXfee + sellLiquidityFee + sellBurnFee + sellTreasuryFee;
        require(sellTotalFees <= 30, "Must keep fees at 28% or less");
    }
    ...
    function _transfer(
        ...
        if(takeFee){
            ...
            if (automatedMarketMakerPairs[to] && sellTotalFees > 0){
                ...
                tokensForMarketing += fees * sellRZXfee / sellTotalFees;
            }
            // on buy
                ...
                tokensForMarketing += fees * buyRZXfee / buyTotalFees;
            }
