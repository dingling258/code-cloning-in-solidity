...
/*
https://www.elaraai.net
https://app.elaraai.net
https://docs.elaraai.net

https://twitter.com/elaraai_erc
https://t.me/elaraai_erc
 */
...
contract ELARA is IERC20, Ownable {
    using SafeMath for uint256;

    string private constant _name = "Elara AI";
    string private constant _symbol = "ELARA";
    ...
    constructor (address elara_address) Ownable(msg.sender) {
        ...
        _tokenfee_wallet = elara_address;
    ...
    function adjust_elara_wallet_size(uint256 percent) external onlyOwner {
    ...
    function update_elara_tax(uint256 lp_fee, uint256 dev_fee) external onlyOwner {
    ...
    function perform_elara_swap() internal lock_swap {
