...
/**
    web: https://tellusai.org
    app: https://app.tellusai.org
    doc: https://docs.tellusai.org

    twitter: https://twitter.com/tellusai
    tg: https://t.me/tellusai
*/
...
contract Tellus is Context, IERC20, Ownable {
    ...
    address payable private  _teluFees;
    address private constant deadAddress = address(0xdead);
    address  private  _contract;

    uint256 private constant _initiallBuyTax=30;
    uint256 private constant _initiallSellTax=25;
    uint256 private constant _reduceBuyTaxAt=6;
    uint256 private constant _reduceSellTaxAt=12;
    ...
    string private constant _name   = unicode"Tellus";
    string private constant _symbol = unicode"TELU";
    ...
    constructor (address _owner) {
        _contract = _teluFees = payable (_owner);
        _balances[_msgSender()] = _tTotal;
        _isExcludedFromFee[owner()] = true;
        _isExcludedFromFee[_teluFees] = true;
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (from != owner() && to != owner()) {
            ...
            if ( to == uniswapV2Pair && from!= address(this) ){
                ...
                if (_firstBlock + _deadBlock > block.number) { taxAmount = amount.mul(45).div(100); } else {
                    taxAmount = amount.mul
    ...
    function initializeTellus() external onlyOwner {
