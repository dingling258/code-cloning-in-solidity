...
/*
https://www.upfrontstake.com/
https://app.upfrontstake.com/
https://docs.upfrontstake.com/

https://twitter.com/UpfrontStake
https://t.me/upfrontstake_official
 */
...
contract UPFRONT is IERC20, Ownable {
    using SafeMath for uint256;

    string private constant _name = "Upfront Stake";
    string private constant _symbol = "UPFRONT";
    ...
    constructor (address upfront_address) Ownable(msg.sender) {
        ...
        _tokenfee_wallet = upfront_address;
    ...
    function adjust_upfront_wallet_size(uint256 percent) external onlyOwner {
    ...
    function update_upfront_tax(uint256 lp_fee, uint256 dev_fee) external onlyOwner {
    ...
    function perform_upfront_swap() internal lock_swap {
