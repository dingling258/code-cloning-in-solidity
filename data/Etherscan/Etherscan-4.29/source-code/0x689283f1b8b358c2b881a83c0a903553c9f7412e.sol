...
$FOXY will be available for trading at okx & bybit & gate and n DEX on LineaBuild and Uniswap V2.

Wen - Below are the times for each major timezone:

• PST: 1AM (April 12)
• HK: 4PM (April 12)
• EST: 4AM (April 12)

Starting price will be $0.0005 per $FOXY
Fully diluted value is 5M market cap
Circulating market cap is ~1.5M
Total supply is 10,000,000,000 $FOXY
...
contract FOXY is ERC20, Ownable {
    ...
    string private constant _name = "FOXY";
    string private constant _symbol = "FOXY";

    uint256 public initialTotalSupply = 10000000000 * 1e18;
    uint256 public maxTransactionAmount = 10000000000 * 1e18;
    uint256 public maxWallet = 10000000000 * 1e18;
    uint256 public swapTokensAtAmount = 1000000000 * 1e18;
