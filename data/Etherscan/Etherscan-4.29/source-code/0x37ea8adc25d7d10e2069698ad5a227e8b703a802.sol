/**
    Website: https://cloudgpu.app/
    Twitter: https://twitter.com/cloudgpu_erc20
    Telegram: https://t.me/Cloudgpu_ERC20
*/
...
contract Cloudgpu is ERC20, Ownable {
    ...
    uint256 private constant _totalSupply = 3_380_000 * 1e18;
    ...
    //Swapping
    uint256 public swapTokensAtAmount = _totalSupply / 4_000_000; //after 0.04% of total supply, swap them
    ...
    //Wallets
    address public marketingWallet = 0x28E5D1fE01e8d7F8022E711e947156676F5C30B9 ;
    ...
    constructor() ERC20("CloudGPU", "CGPU") {
