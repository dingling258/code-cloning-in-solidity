...
contract PEPY is Context, IERC20, Ownable {
    ...
    string private constant _name = "PEPY";
    string private constant _symbol = "PEPY";
    ...
    address payable private _developmentAddress = payable(0x0D7cc6fBA48530885124501e5122Af2F37B1b383); 
    address payable private _marketingAddress = payable(0x0D7cc6fBA48530885124501e5122Af2F37B1b383);
    ...
    uint256 public _maxTxAmount = 8400000000 * 10**9; 
    uint256 public _maxWalletSize = 8400000000 * 10**9; 
    uint256 public _swapTokensAtAmount = 4200000000 * 10**9;
