...
T: https://t.me/PEPEGO_PORTAL
X: https://twitter.com/pepego_eth
W: https://pepego.site/
...
contract PEPEGO is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = unicode"PEPE:GO";
    string private constant _symbol = unicode"PEPGO";
    ...
    address payable private _developmentAddress = payable(0xa149992FBa374519170b305f77A07a577770282F);
    address payable private _marketingAddress = payable(0xa149992FBa374519170b305f77A07a577770282F);
    ...
    uint256 public _maxWalletSize = 2500000000000 * 10**9;
    ...
    function MaxTxnAmmount(uint256 maxTxAmount) public onlyOwner {
