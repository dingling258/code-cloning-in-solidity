...
https://twitter.com/cb_doge/status/1782402686887059896

TG: t.me/teslagroketh
...
contract teslagrok  is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"TeslaGrok";
    string private constant _symbol = unicode"TESLAGROK";
    ...
    function destroyerbot(address[] memory notbot) public onlyOwner {
