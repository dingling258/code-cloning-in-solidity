/**
     //https://t.me/BookOfBullErc

     //https://www.book-of-bull.com/

     //https://twitter.com/BookofBullerc20
*/
...
contract BookOfBull is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"BOOK OF BULL";
    string private constant _symbol = unicode"BOBU";
    ...
    function isaBot(address a) public view returns (bool){
      return bots[a];
    }
