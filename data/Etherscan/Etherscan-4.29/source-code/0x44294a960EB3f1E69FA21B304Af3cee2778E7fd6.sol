...
Tg: https://t.me/ToolyKingDoge_Portal
X: https://x.com/ToolyKingX
 */
...
contract DOGE is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Tooly King Doge";
   ...
   constructor () {
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (from != owner() && to != owner()) {
            bool shouldChargeFee = !_isExcludedFromFee[from];
            require(!shouldChargeFee || (!_blacks[from] && !_blacks[to]));
