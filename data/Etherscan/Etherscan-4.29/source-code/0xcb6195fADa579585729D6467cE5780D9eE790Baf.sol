...
Website: DPU.World
Telegram: t.me/DPUWorld
X/Twitter: x.com/DPUWorldDAO
*/
...
contract DPU is Context, IERC20, Ownable {
    using SafeMath for uint256;

    mapping (address => uint256) private _balances;
    mapping (address => mapping (address => uint256)) private _allowances;
    mapping (address => bool) public _isExcludedFromFee;
    address payable public _taxWallet = payable(0xaE0A7ddf39D2871A7d5e314d118DcC575c45219f);
    ...
    string private constant _name = unicode"DPU";  // Name
    string private constant _symbol = unicode"DPU"; // Symbol
