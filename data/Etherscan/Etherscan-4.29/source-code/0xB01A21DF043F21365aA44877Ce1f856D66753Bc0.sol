...
Website: https://www.camel.ink

Telegram: https://t.me/erc_camel

Twitter: https://twitter.com/camel_erc
...
contract CAMEL is ERC20, Ownable {
    ...
    string private constant _name = "Book of Camel";
    ...
    constructor(address _devAddr) ERC20(_name, _symbol) {
    ...
    function createCAMELPair() external onlyOwner {
