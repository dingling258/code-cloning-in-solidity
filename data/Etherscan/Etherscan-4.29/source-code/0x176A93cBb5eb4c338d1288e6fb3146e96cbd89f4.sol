...
contract TCAI is Context, IERC20, Ownable {
    ...
    uint256 private constant _preventSwapBefore=11;
    ...
    string private constant _name   = unicode"TectraAI";
    string private constant _symbol = unicode"TCAI";
