...
contract ZELDA2 is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    uint256 public sellMultiplier  = 300;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x71943A33a723cc74e7d3a5f04C771fCFB3ad913A;
        ecosystemfeeReceiver = 0xB2140b1952E52b6461a8c995E181B36C0BA38d50;
    ...
    function setMaxWalletPercent_base5000(uint256 maxWallPercent_base5000) external onlyOwner() {
        _maxWalletToken = (_totalSupply * maxWallPercent_base5000 ) / 10000;
    }
    function setMaxTxPercent_base5000(uint256 maxTXPercentage_base5000) external onlyOwner() {
        _maxTxAmount = (_totalSupply * maxTXPercentage_base5000 ) / 10000;
    }
