...
contract CHILLWAVE is ERC20, ReentrancyGuard, Ownable {
    uint256 public feePercent = 0;
    uint256 public MAX_HOLDING = 200000000 * (10 ** decimals());
    bool public limitEnabled = true;
    uint256 private initialSupply = 1500000000 * (10 ** decimals());
    address private feeDestination = 0x2d0351345699f10caE0250CAC72A9bbd378df337;
    ...
    constructor() ERC20("CHILL WAVE", "CHIWA") Ownable(msg.sender) {
