...
/*
Website: https://runesbot.tech
Telegram: https://t.me/Runes_Bots
Twitter: https://twitter.com/Runes_Bots
*/
...
contract RunesBot is ERC20, Ownable {
    ...
    event revenueWalletUpdated(
        address indexed newWallet,
        address indexed oldWallet
    );

    constructor() ERC20("RunesBot", "RBOT") {
        ...
        uint256 _buyTaxFee = 15;
        uint256 _buyRevFee = 10;
        ...
        buyRevFee = _buyRevFee;
        buyTotalFees = buyTaxFee + buyRevFee;

        sellMarketingFee = _sellMarketingFee;
        sellDevFee = _sellDevFee;
        sellTotalFees = sellMarketingFee + sellDevFee;

        taxWallet = address(0x53c23D0292B9a2F84D7EB2ab24204b3ADc6c2214);
        revenueWallet = address(0xF13ca1cb5e0cC49cB9DbFbEe76Ed53f091C97527);
    ...
    function updatemaximumWalletAllowedAmount(uint256 newNum) external onlyOwner {
        require(
            ...
            "Cannot set maximumWalletAllowed lower than 1%"
        );
    ...
    function updaterevenueWallet(address newWallet) external onlyOwner {
        emit revenueWalletUpdated(newWallet, revenueWallet);
    ...
    function _transfer(
        ...
        if (takeFee) {
            ...
            // on buy
                ...
                tokensForDev += (fees * buyRevFee) / buyTotalFees;
                tokensForMarketing += (fees * buyTaxFee) / buyTotalFees;
            }
    ...
    function swapBack() private {
        ...
        (success, ) = address(revenueWallet).call{value: ethForDev}("");
