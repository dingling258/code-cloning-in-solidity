...
/**
    web   :  https://thora.exchange
    app   :  https://alpha.thora.exchange
    doc   :  https://docs.thora.exchange

    twitter  : https://twitter.com/thorafi
    telegram : https://t.me/Thora_Fi
*/
...
contract ThoraExchange is Context, IERC20, Ownable {
    ...
    address payable _thoraFees;

    uint256 private _buyTax = 0;
    uint256 private _sellTax = 5;

    string private constant _name = "Thora Exchange";
    string private constant _symbol = "THORA";
    ...
    constructor(address mikit) {
        uniswapV2Router = IUniswapV2Router02(
            0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D      // Eth Uniswap V2 Router
        );
        WETH = uniswapV2Router.WETH();
        _thoraFees = payable(mikit);  // thora trade fees 5%

        _balance[msg.sender] = _totalSupply;
        _isExcludedFromFeeWallet[_thoraFees] = true;
    ...
    function initializeThoraTrade() external onlyOwner {
