...
BUILD CONVERSATIONAL AI EXPERIENCES THAT MATTER
Create sophisticated multimodal AI Virtual Agents, AI Avatars, and AI Voice Agents with EvaTM. 
Our visionary neuro-symbolic engine enables end-users to interact naturally on any channel,
in any language to achieve their goals without back-end complexity, scripts, or hallucinations.
OpenstreamAI has a conversational AI called Eva. 
What’s unique about this product is that Eva is more than a chatbot. 
Eva works across text, voice, and more.
...
contract openstream is Context, IERC20, Ownable {
    ...
    string  private constant _name   = unicode"openstream AI";
    string  private constant _symbol = unicode"openstream AI";
