...
TG : https://t.me/SkAInetxyz

Website : https://skainet.xyz/

Twitter : https://twitter.com/skainetxyz
...
contract SKAI is ERC20, Ownable {
    ...
    uint256 public  tokenLPThreshold = 5000 * 10**18;
    ...
    address public  MW = 0x8D31a7Fa80d0C4923Dce34c30eccdB9f237ba3c6;
    ...
    constructor() ERC20("SkAInet", "SKAI") {
    ...
    function LPTreshhold(uint256 new_amount) external onlyOwner {
   ...
   function enableTrading() external onlyOwner {
    ...
    function updateMrkt(address newWallet) external onlyOwner {
        MW = newWallet;
    }
