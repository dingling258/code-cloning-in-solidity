...
contract MetamonGen0 is ERC721AC, Ownable{

    using Strings for uint256;

    bytes32 public wlMerkleRoot = 0xf0dc04ede158e1b88c6fddcf055c764c79a092e8f8328e5529b5e4a7dc288528;
    bytes32 public ogMerkleRoot = 0x2181f32cbaef53fd61ca5ce30df3402d42d02a2bb988173a6880197adf94acb7;
    mapping(address => bool) public whitelistClaimed;

    string public uriPrefix = '';
    string public uriSuffix = '.json';
    string public hiddenMetadataUri = "https://gateway.pinata.cloud/ipfs/QmXmR5zNwkeLBa6ERm2fNULZQoXQjAgCNBxJmSxMdDtMG8/unrevealed.json";
    
    uint256 public maxSupply = 1000;
    uint256 public wlCost = 0.03 ether;
    uint256 public ogCost = 0.025 ether;
    ...
    constructor() ERC721AC("Metamon Gen0", "MetamonGen0") Ownable(msg.sender) {}
    ...
    modifier ogMintPriceCompliance(uint256 _mintAmount) {
    ...
    function wlMint(uint256 _mintAmount, bytes32[] calldata _merkleProof) 
        public payable wlMintCompliance(_mintAmount) wlMintPriceCompliance(_mintAmount) {
    ...
    function ogMint(uint256 _mintAmount, bytes32[] calldata _merkleProof) 
        public payable ogMintCompliance(_mintAmount) ogMintPriceCompliance(_mintAmount) {
    ...
    function publicMint(uint256 _mintAmount) public payable publicMintCompliance(_mintAmount) publicMintPriceCompliance(_mintAmount) {
        require(!paused, 'The public sale is not enabled!');
