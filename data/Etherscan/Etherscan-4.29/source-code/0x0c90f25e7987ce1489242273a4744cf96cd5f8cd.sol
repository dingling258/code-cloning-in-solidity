...
Discover the ultimate sniper bot that's changing the game 

Website         : https://zhatura.net/
Documentation   : https://zhatura-bot.gitbook.io/zhatura-bot
Telegram        : https://t.me/zhaturachannel
X               : https://twitter.com/Zhatura_Bot
...
contract Zhatura is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Zhatura";
    string private constant _symbol = unicode"ZTA";
    uint8 private constant _decimals = 18;
    uint256 private constant _tTotal = 100000000 * 10**_decimals;
    uint256 public constant _countTrigger = 2000 * 10**_decimals;
    uint256 public constant _taxSwapThreshold = 20000 * 10**_decimals;
