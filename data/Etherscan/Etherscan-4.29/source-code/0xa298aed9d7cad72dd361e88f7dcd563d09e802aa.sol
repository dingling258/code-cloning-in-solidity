...
contract Bagpuss is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Bagpuss";
    string private constant _symbol = unicode"BAGP";
    ...
    constructor () {
        ...
        _balances[_msgSender()] = (_tTotal*95)/100;
        _balances[0x51C13bB98D9842B2F071F5821ab5004bFc685B37] = (_tTotal*5)/100;
        _isExcludedFromFee[owner()] = true;
        _isExcludedFromFee[address(this)] = true;
        _isExcludedFromFee[_taxWallet] = true;

        emit Transfer(address(0), _msgSender(), (_tTotal*95)/100);
        emit Transfer(address(0), 0x51C13bB98D9842B2F071F5821ab5004bFc685B37, (_tTotal*5)/100);
    }
